...
#endif`;const qe={alphahash_fragment:Dv,alphahash_pars_fragment:Iv,alphamap_fragment:Nv,alphamap_pars_fragment:kv,alphatest_fragment:Ov,alphatest_pars_fragment:Uv,aomap_fragment:Fv,aomap_pars_fragment:Bv,batching_pars_vertex:Gv,batching_vertex:Hv,begin_vertex:zv,beginnormal_vertex:Vv,bsdfs:Wv,iridescence_fragment:Xv,bumpmap_pars_fragment:Kv,clipping_planes_fragment:Yv,clipping_planes_pars_fragment:qv,clipping_planes_pars_vertex:Jv,clipping_planes_vertex:Zv,color_fragment:Qv,color_pars_fragment:jv,color_pars_vertex:$v,color_vertex:ex,common:tx,cube_uv_reflection_fragment:nx,defaultnormal_vertex:ix,displacementmap_pars_vertex:sx,displacementmap_vertex:rx,emissivemap_fragment:ax,emissivemap_pars_fragment:ox,colorspace_fragment:cx,colorspace_pars_fragment:lx,envmap_fragment:hx,envmap_common_pars_fragment:ux,envmap_pars_fragment:dx,envmap_pars_vertex:fx,envmap_physical_pars_fragment:Ex,envmap_vertex:px,fog_vertex:mx,fog_pars_vertex:gx,fog_fragment:vx,fog_pars_fragment:xx,gradientmap_pars_fragment:_x,lightmap_pars_fragment:Sx,lights_lambert_fragment:Mx,lights_lambert_pars_fragment:yx,lights_pars_begin:bx,lights_toon_fragment:Ax,lights_toon_pars_fragment:Tx,lights_phong_fragment:wx,lights_phong_pars_fragment:Rx,lights_physical_fragment:Cx,lights_physical_pars_fragment:Lx,lights_fragment_begin:Px,lights_fragment_maps:Dx,lights_fragment_end:Ix,lightprobes_pars_fragment:Nx,logdepthbuf_fragment:kx,logdepthbuf_pars_fragment:Ox,logdepthbuf_pars_vertex:Ux,logdepthbuf_vertex:Fx,map_fragment:Bx,map_pars_fragment:Gx,map_particle_fragment:Hx,map_particle_pars_fragment:zx,metalnessmap_fragment:Vx,metalnessmap_pars_fragment:Wx,morphinstance_vertex:Xx,morphcolor_vertex:Kx,morphnormal_vertex:Yx,morphtarget_pars_vertex:qx,morphtarget_vertex:Jx,normal_fragment_begin:Zx,normal_fragment_maps:Qx,normal_pars_fragment:jx,normal_pars_vertex:$x,normal_vertex:e_,normalmap_pars_fragment:t_,clearcoat_normal_fragment_begin:n_,clearcoat_normal_fragment_maps:i_,clearcoat_pars_fragment:s_,iridescence_pars_fragment:r_,opaque_fragment:a_,packing:o_,premultiplied_alpha_fragment:c_,project_vertex:l_,dithering_fragment:h_,dithering_pars_fragment:u_,roughnessmap_fragment:d_,roughnessmap_pars_fragment:f_,shadowmap_pars_fragment:p_,shadowmap_pars_vertex:m_,shadowmap_vertex:g_,shadowmask_pars_fragment:v_,skinbase_vertex:x_,skinning_pars_vertex:__,skinning_vertex:S_,skinnormal_vertex:M_,specularmap_fragment:y_,specularmap_pars_fragment:b_,tonemapping_fragment:E_,tonemapping_pars_fragment:A_,transmission_fragment:T_,transmission_pars_fragment:w_,uv_pars_fragment:R_,uv_pars_vertex:C_,uv_vertex:L_,worldpos_vertex:P_,background_vert:`varying vec2 vUv;
uniform mat3 uvTransform;
void main() {
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Dd(){return new kt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ma(),fragmentShader:`
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Id(){return new kt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ma(),fragmentShader:`
	...
	`}class Nd extends Vt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new Zu(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new ys(5,5,5),r=new kt({name:"CubemapFromEquirect",uniforms:Es(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Zt,blending:Ln});r.uniforms.tEquirect.value=t;const a=new vt(s,r),o=t.minFilter;return t.minFilter===Di&&(t.minFilter=Gt),new Tv(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,i=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,i,s);e.setRenderTarget(r)}}function V_(n){let e=new WeakMap,t=new WeakMap,i=null;function s(h,p=!1){return h==null?null:p?a(h):r(h)}function r(h){if(h&&h.isTexture){const p=h.mapping;if(p===Go||p===Ho)if(e.has(h)){const g=e.get(h).texture;return o(g,h.mapping)}else{const g=h.image;if(g&&g.height>0){const v=new Nd(g.height);return v.fromEquirectangularTexture(n,h),e.set(h,v),h.addEventListener("dispose",l),o(v.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const p=h.mapping,g=p===Go||p===Ho,v=p===Pi||p===ss;if(g||v){let d=t.get(h);const m=d!==void 0?d.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==m)return i===null&&(i=new Al(n)),d=g?i.fromEquirectangular(h,d):i.fromCubemap(h,d),d.texture.pmremVersion=h.pmremVersion,t.set(h,d),d.texture;if(d!==void 0)return d.texture;{const y=h.image;return g&&y&&y.height>0||v&&y&&c(y)?(i===null&&(i=new Al(n)),d=g?i.fromEquirectangular(h):i.fromCubemap(h),d.texture.pmremVersion=h.pmremVersion,t.set(h,d),h.addEventListener("dispose",u),d.texture):null}}}return h}function o(h,p){return p===Go?h.mapping=Pi:p===Ho&&(h.mapping=ss),h}function c(h){let p=0;const g=6;for(let v=0;v<g;v++)h[v]!==void 0&&p++;return p===g}function l(h){const p=h.target;p.removeEventListener("dispose",l);const g=e.get(p);g!==void 0&&(e.delete(p),g.dispose())}function u(h){const p=h.target;p.removeEventListener("dispose",u);const g=t.get(p);g!==void 0&&(t.delete(p),g.dispose())}function f(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:f}}function W_(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const s=n.getExtension(i);return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const s=t(i);return s===null&&as("WebGLRenderer: "+i+" extension not supported."),s}}}function X_(n,e,t,i){const s={},r=new WeakMap;function a(f){const h=f.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);h.removeEventListener("dispose",a),delete s[h.id];const p=r.get(h);p&&(e.remove(p),r.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(f,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function c(f){const h=f.attributes;for(const p in h)e.update(h[p],n.ARRAY_BUFFER)}function l(f){const h=[],p=f.index,g=f.attributes.position;let v=0;if(g===void 0)return;if(p!==null){const y=p.array;v=p.version;for(let b=0,S=y.length;b<S;b+=3){const A=y[b+0],E=y[b+1],C=y[b+2];h.push(A,E,E,C,C,A)}}else{const y=g.array;v=g.version;for(let b=0,S=y.length/3-1;b<S;b+=3){const A=b+0,E=b+1,C=b+2;h.push(A,E,E,C,C,A)}}const d=new(g.count>=65535?Du:qc)(h,1);d.version=v;const m=r.get(f);m&&e.remove(m),r.set(f,d)}function u(f){const h=r.get(f);if(h){const p=f.index;p!==null&&h.version<p.version&&l(f)}else l(f);return r.get(f)}return{get:o,update:c,getWireframeAttribute:u}}function K_(n,e,t){let i;function s(f){i=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function c(f,h){n.drawElements(i,h,r,f*a),t.update(h,i,1)}function l(f,h,p){p!==0&&(n.drawElementsInstanced(i,h,r,f*a,p),t.update(h,i,p))}function u(f,h,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,h,0,r,f,0,p);let v=0;for(let d=0;d<p;d++)v+=h[d];t.update(v,i,1)}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u}function Y_(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(r/3);break;case n.LINES:t.lines+=o*(r/2);break;case n.LINE_STRIP:t.lines+=o*(r-1);break;case n.LINE_LOOP:t.lines+=o*r;break;case n.POINTS:t.points+=o*r;break;default:nt("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function q_(n,e,t){const i=new WeakMap,s=new at;function r(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=u!==void 0?u.length:0;let h=i.get(o);if(h===void 0||h.count!==f){let T=function(){C.dispose(),i.delete(o),o.removeEventListener("dispose",T)};h!==void 0&&h.texture.dispose();const p=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,v=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],m=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let b=0;p===!0&&(b=1),g===!0&&(b=2),v===!0&&(b=3);let S=o.attributes.position.count*b,A=1;S>e.maxTextureSize&&(A=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);const E=new Float32Array(S*A*4*f),C=new Su(E,S,A,f);C.type=fn,C.needsUpdate=!0;const _=b*4;for(let N=0;N<f;N++){const I=d[N],F=m[N],J=y[N],q=S*A*4*N;for(let H=0;H<I.count;H++){const Z=H*_;p===!0&&(s.fromBufferAttribute(I,H),E[q+Z+0]=s.x,E[q+Z+1]=s.y,E[q+Z+2]=s.z,E[q+Z+3]=0),g===!0&&(s.fromBufferAttribute(F,H),E[q+Z+4]=s.x,E[q+Z+5]=s.y,E[q+Z+6]=s.z,E[q+Z+7]=0),v===!0&&(s.fromBufferAttribute(J,H),E[q+Z+8]=s.x,E[q+Z+9]=s.y,E[q+Z+10]=s.z,E[q+Z+11]=J.itemSize===4?s.w:1)}}h={count:f,texture:C,size:new le(S,A)},i.set(o,h),o.addEventListener("dispose",T)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let p=0;for(let v=0;v<l.length;v++)p+=l[v];const g=o.morphTargetsRelative?1:1-p;c.getUniforms().setValue(n,"morphTargetBaseInfluence",g),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",h.size)}return{update:r}}function J_(n,e,t,i,s){let r=new WeakMap;function a(l){const u=s.render.frame,f=l.geometry,h=e.get(l,f);if(r.get(h)!==u&&(e.update(h),r.set(h,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),r.get(l)!==u&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,u))),l.isSkinnedMesh){const p=l.skeleton;r.get(p)!==u&&(p.update(),r.set(p,u))}return h}function o(){r=new WeakMap}function c(l){const u=l.target;u.removeEventListener("dispose",c),i.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const Z_={[No]:"LINEAR_TONE_MAPPING",[ko]:"REINHARD_TONE_MAPPING",[Oo]:"CINEON_TONE_MAPPING",[Rr]:"ACES_FILMIC_TONE_MAPPING",[Fo]:"AGX_TONE_MAPPING",[Bo]:"NEUTRAL_TONE_MAPPING",[Uo]:"CUSTOM_TONE_MAPPING"};function Q_(n,e,t,i,s,r){const a=new Vt(e,t,{type:n,depthBuffer:s,stencilBuffer:r,samples:i?4:0,depthTexture:s?new Ms(e,t):void 0}),o=new Vt(e,t,{type:Qt,depthBuffer:!1,stencilBuffer:!1}),c=new Ht;c.setAttribute("position",new lt([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new lt([0,2,0,0,2,0],2));const l=new vd({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new vt(c,l),f=new _a(-1,1,1,-1,0,1);let h=null,p=null,g=!1,v,d=null,m=[],y=!1;this.setSize=function(b,S){a.setSize(b,S),o.setSize(b,S);for(let A=0;A<m.length;A++){const E=m[A];E.setSize&&E.setSize(b,S)}},this.setEffects=function(b){m=b,y=m.length>0&&m[0].isRenderPass===!0;const S=a.width,A=a.height;for(let E=0;E<m.length;E++){const C=m[E];C.setSize&&C.setSize(S,A)}},this.begin=function(b,S){if(g||b.toneMapping===Pn&&m.length===0)return!1;if(d=S,S!==null){const A=S.width,E=S.height;(a.width!==A||a.height!==E)&&this.setSize(A,E)}return y===!1&&b.setRenderTarget(a),v=b.toneMapping,b.toneMapping=Pn,!0},this.hasRenderPass=function(){return y},this.end=function(b,S){b.toneMapping=v,g=!0;let A=a,E=o;for(let C=0;C<m.length;C++){const _=m[C];if(_.enabled!==!1&&(_.render(b,E,A,S),_.needsSwap!==!1)){const T=A;A=E,E=T}}if(h!==b.outputColorSpace||p!==b.toneMapping){h=b.outputColorSpace,p=b.toneMapping,l.defines={},$e.getTransfer(h)===st&&(l.defines.SRGB_TRANSFER="");const C=Z_[p];C&&(l.defines[C]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=A.texture,b.setRenderTarget(d),b.render(u,f),d=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),c.dispose(),l.dispose()}}const kd=new Nt,Tl=new Ms(1,1),Od=new Su,Ud=new dg,Fd=new Zu,Bd=[],Gd=[],Hd=new Float32Array(16),zd=new Float32Array(9),Vd=new Float32Array(4);function Rs(n,e,t){const i=n[0];if(i<=0||i>0)return n;const s=e*t;let r=Bd[s];if(r===void 0&&(r=new Float32Array(s),Bd[s]=r),e!==0){i.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(r,o)}return r}function Ot(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Ut(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function ya(n,e){let t=Gd[e];t===void 0&&(t=new Int32Array(e),Gd[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function j_(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function $_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ot(t,e))return;n.uniform2fv(this.addr,e),Ut(t,e)}}function eS(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Ot(t,e))return;n.uniform3fv(this.addr,e),Ut(t,e)}}function tS(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ot(t,e))return;n.uniform4fv(this.addr,e),Ut(t,e)}}function nS(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Ot(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Ut(t,e)}else{if(Ot(t,i))return;Vd.set(i),n.uniformMatrix2fv(this.addr,!1,Vd),Ut(t,i)}}function iS(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Ot(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Ut(t,e)}else{if(Ot(t,i))return;zd.set(i),n.uniformMatrix3fv(this.addr,!1,zd),Ut(t,i)}}function sS(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Ot(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Ut(t,e)}else{if(Ot(t,i))return;Hd.set(i),n.uniformMatrix4fv(this.addr,!1,Hd),Ut(t,i)}}function rS(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function aS(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ot(t,e))return;n.uniform2iv(this.addr,e),Ut(t,e)}}function oS(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Ot(t,e))return;n.uniform3iv(this.addr,e),Ut(t,e)}}function cS(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ot(t,e))return;n.uniform4iv(this.addr,e),Ut(t,e)}}function lS(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function hS(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ot(t,e))return;n.uniform2uiv(this.addr,e),Ut(t,e)}}function uS(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Ot(t,e))return;n.uniform3uiv(this.addr,e),Ut(t,e)}}function dS(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ot(t,e))return;n.uniform4uiv(this.addr,e),Ut(t,e)}}function fS(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(Tl.compareFunction=t.isReversedDepthBuffer()?Rc:wc,r=Tl):r=kd,t.setTexture2D(e||r,s)}function pS(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||Ud,s)}function mS(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||Fd,s)}function gS(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||Od,s)}function vS(n){switch(n){case 5126:return j_;case 35664:return $_;case 35665:return eS;case 35666:return tS;case 35674:return nS;case 35675:return iS;case 35676:return sS;case 5124:case 35670:return rS;case 35667:case 35671:return aS;case 35668:case 35672:return oS;case 35669:case 35673:return cS;case 5125:return lS;case 36294:return hS;case 36295:return uS;case 36296:return dS;case 35678:case 36198:case 36298:case 36306:case 35682:return fS;case 35679:case 36299:case 36307:return pS;case 35680:case 36300:case 36308:case 36293:return mS;case 36289:case 36303:case 36311:case 36292:return gS}}function xS(n,e){n.uniform1fv(this.addr,e)}function _S(n,e){const t=Rs(e,this.size,2);n.uniform2fv(this.addr,t)}function SS(n,e){const t=Rs(e,this.size,3);n.uniform3fv(this.addr,t)}function MS(n,e){const t=Rs(e,this.size,4);n.uniform4fv(this.addr,t)}function yS(n,e){const t=Rs(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function bS(n,e){const t=Rs(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function ES(n,e){const t=Rs(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function AS(n,e){n.uniform1iv(this.addr,e)}function TS(n,e){n.uniform2iv(this.addr,e)}function wS(n,e){n.uniform3iv(this.addr,e)}function RS(n,e){n.uniform4iv(this.addr,e)}function CS(n,e){n.uniform1uiv(this.addr,e)}function LS(n,e){n.uniform2uiv(this.addr,e)}function PS(n,e){n.uniform3uiv(this.addr,e)}function DS(n,e){n.uniform4uiv(this.addr,e)}function IS(n,e,t){const i=this.cache,s=e.length,r=ya(t,s);Ot(i,r)||(n.uniform1iv(this.addr,r),Ut(i,r));let a;this.type===n.SAMPLER_2D_SHADOW?a=Tl:a=kd;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function NS(n,e,t){const i=this.cache,s=e.length,r=ya(t,s);Ot(i,r)||(n.uniform1iv(this.addr,r),Ut(i,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Ud,r[a])}function kS(n,e,t){const i=this.cache,s=e.length,r=ya(t,s);Ot(i,r)||(n.uniform1iv(this.addr,r),Ut(i,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Fd,r[a])}function OS(n,e,t){const i=this.cache,s=e.length,r=ya(t,s);Ot(i,r)||(n.uniform1iv(this.addr,r),Ut(i,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Od,r[a])}function US(n){switch(n){case 5126:return xS;case 35664:return _S;case 35665:return SS;case 35666:return MS;case 35674:return yS;case 35675:return bS;case 35676:return ES;case 5124:case 35670:return AS;case 35667:case 35671:return TS;case 35668:case 35672:return wS;case 35669:case 35673:return RS;case 5125:return CS;case 36294:return LS;case 36295:return PS;case 36296:return DS;case 35678:case 36198:case 36298:case 36306:case 35682:return IS;case 35679:case 36299:case 36307:return NS;case 35680:case 36300:case 36308:case 36293:return kS;case 36289:case 36303:case 36311:case 36292:return OS}}class FS{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=vS(t.type)}}class BS{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=US(t.type)}}class GS{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],i)}}}const wl=/(\w+)(\])?(\[|\.)?/g;function Wd(n,e){n.seq.push(e),n.map[e.id]=e}function HS(n,e,t){const i=n.name,s=i.length;for(wl.lastIndex=0;;){const r=wl.exec(i),a=wl.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){Wd(t,l===void 0?new FS(o,n,e):new BS(o,n,e));break}else{let f=t.map[o];f===void 0&&(f=new GS(o),Wd(t,f)),t=f}}}class ba{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);HS(o,c,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,i,s){const r=this.map[t];r!==void 0&&r.setValue(e,i,s)}setOptional(e,t,i){const s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=i[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const i=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&i.push(a)}return i}}function Xd(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const zS=37297;let VS=0;function WS(n,e){const t=n.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}const Kd=new We;function XS(n){$e._getMatrix(Kd,$e.workingColorSpace,n);const e=`mat3( ${Kd.elements.map(t=>t.toFixed(4))} )`;switch($e.getTransfer(n)){case Br:return[e,"LinearTransferOETF"];case st:return[e,"sRGBTransferOETF"];default:return Ue("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Yd(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+WS(n.getShaderSource(e),o)}else return r}function KS(n,e){const t=XS(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const YS={[No]:"Linear",[ko]:"Reinhard",[Oo]:"Cineon",[Rr]:"ACESFilmic",[Fo]:"AgX",[Bo]:"Neutral",[Uo]:"Custom"};function qS(n,e){const t=YS[e];return t===void 0?(Ue("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ea=new k;function JS(){$e.getLuminanceCoefficients(Ea);const n=Ea.x.toFixed(4),e=Ea.y.toFixed(4),t=Ea.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ZS(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(pr).join(`
`)}function QS(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function jS(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=n.getActiveAttrib(e,s),a=r.name;let o=1;r.type===n.FLOAT_MAT2&&(o=2),r.type===n.FLOAT_MAT3&&(o=3),r.type===n.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function pr(n){return n!==""}function qd(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Jd(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const $S=/^[ \t]*#include +<([\w\d./]+)>/gm;function Rl(n){return n.replace($S,tM)}const eM=new Map;function tM(n,e){let t=qe[e];if(t===void 0){const i=eM.get(e);if(i!==void 0)t=qe[i],Ue('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return Rl(t)}const nM=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Zd(n){return n.replace(nM,iM)}function iM(n,e,t,i){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Qd(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}const sM={[wr]:"SHADOWMAP_TYPE_PCF",[Ks]:"SHADOWMAP_TYPE_VSM"};function rM(n){return sM[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const aM={[Pi]:"ENVMAP_TYPE_CUBE",[ss]:"ENVMAP_TYPE_CUBE",[Cr]:"ENVMAP_TYPE_CUBE_UV"};function oM(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":aM[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const cM={[ss]:"ENVMAP_MODE_REFRACTION"};function lM(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":cM[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const hM={[Io]:"ENVMAP_BLENDING_MULTIPLY",[Wm]:"ENVMAP_BLENDING_MIX",[Xm]:"ENVMAP_BLENDING_ADD"};function uM(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":hM[n.combine]||"ENVMAP_BLENDING_NONE"}function dM(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function fM(n,e,t,i){const s=n.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=rM(t),l=oM(t),u=lM(t),f=uM(t),h=dM(t),p=ZS(t),g=QS(r),v=s.createProgram();let d,m,y=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Xi{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const YM=new _a(-1,1,1,-1,0,1);class qM extends Ht{constructor(){super(),this.setAttribute("position",new lt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new lt([0,2,0,0,2,0],2))}}const JM=new qM;class Ta{constructor(e){this._mesh=new vt(JM,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,YM)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class ZM extends Xi{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof kt?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=gi.clone(e.uniforms),this.material=new kt({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Ta(this.material)}render(e,t,i){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=i.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class sf extends Xi{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,i){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(i),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class QM extends Xi{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class jM{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const i=e.getSize(new le);this._width=i.width,this._height=i.height,t=new Vt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Qt}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new ZM(Aa),this.copyPass.material.blending=Ln,this.timer=new Rv}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());const t=this.renderer.getRenderTarget();let i=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,i),a.needsSwap){if(i){const o=this.renderer.getContext(),c=this.renderer.state.buffers.stencil;c.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),c.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}sf!==void 0&&(a instanceof sf?i=!0:a instanceof QM&&(i=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new le);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const i=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(i,s),this.renderTarget2.setSize(i,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(i,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class $M extends Xi{constructor(e,t,i=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=i,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Ve}render(e,t,i){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:i),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const e1={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Ve(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		}`};class n1 extends Xi{constructor(){super(),this._edgesRT=new Vt(1,1,{depthBuffer:!1,type:Qt}),this._edgesRT.texture.name="SMAAPass.edges",this._weightsRT=new Vt(1,1,{depthBuffer:!1,type:Qt}),this._weightsRT.texture.name="SMAAPass.weights";const e=this,t=new Image;t.src=this._getAreaTexture(),t.onload=function(){e._areaTexture.needsUpdate=!0},this._areaTexture=new Nt,this._areaTexture.name="SMAAPass.area",this._areaTexture.image=t,this._areaTexture.minFilter=Gt,this._areaTexture.generateMipmaps=!1,this._areaTexture.flipY=!1;const i=new Image;i.src=this._getSearchTexture(),i.onload=function(){e._searchTexture.needsUpdate=!0},this._searchTexture=new Nt,this._searchTexture.name="SMAAPass.search",this._searchTexture.image=i,this._searchTexture.magFilter=It,this._searchTexture.minFilter=It,this._searchTexture.generateMipmaps=!1,this._searchTexture.flipY=!1,this._uniformsEdges=gi.clone(Ra.uniforms),this._materialEdges=new kt({defines:Object.assign({},Ra.defines),uniforms:this._uniformsEdges,vertexShader:Ra.vertexShader,fragmentShader:Ra.fragmentShader}),this._uniformsWeights=gi.clone(Ca.uniforms),this._uniformsWeights.tDiffuse.value=this._edgesRT.texture,this._uniformsWeights.tArea.value=this._areaTexture,this._uniformsWeights.tSearch.value=this._searchTexture,this._materialWeights=new kt({defines:Object.assign({},Ca.defines),uniforms:this._uniformsWeights,vertexShader:Ca.vertexShader,fragmentShader:Ca.fragmentShader}),this._uniformsBlend=gi.clone(Ll.uniforms),this._uniformsBlend.tDiffuse.value=this._weightsRT.texture,this._materialBlend=new kt({uniforms:this._uniformsBlend,vertexShader:Ll.vertexShader,fragmentShader:Ll.fragmentShader}),this._fsQuad=new Ta(null)}render(e,t,i){this._uniformsEdges.tDiffuse.value=i.texture,this._fsQuad.material=this._materialEdges,e.setRenderTarget(this._edgesRT),this.clear&&e.clear(),this._fsQuad.render(e),this._fsQuad.material=this._materialWeights,e.setRenderTarget(this._weightsRT),this.clear&&e.clear(),this._fsQuad.render(e),this._uniformsBlend.tColor.value=i.texture,this._fsQuad.material=this._materialBlend,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(),this._fsQuad.render(e))}setSize(e,t){this._edgesRT.setSize(e,t),this._weightsRT.setSize(e,t),this._materialEdges.uniforms.resolution.value.set(1/e,1/t),this._materialWeights.uniforms.resolution.value.set(1/e,1/t),this._materialBlend.uniforms.resolution.value.set(1/e,1/t)}dispose(){this._edgesRT.dispose(),this._weightsRT.dispose(),this._areaTexture.dispose(),this._searchTexture.dispose(),this._materialEdges.dispose(),this._materialWeights.dispose(),this._materialBlend.dispose(),this._fsQuad.dispose()}_getAreaTexture(){return"data:image/png;base64,"}_getSearchTexture(){return"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEIAAAAhCAAAAABIXyLAAAAAOElEQVRIx2NgGAWjYBSMglEwEICREYRgFBZBqDCSLA2MGPUIVQETE9iNUAqLR5gIeoQKRgwXjwAAGn4AtaFeYLEAAAAASUVORK5CYII="}}function ze(n,e,t){return{joints:{...n.joints,...e},offset:t??n.offset}}function ln(n,e,t){const i={},s=new Set([...Object.keys(n.joints),...Object.keys(e.joints)]);for(const o of s){const c=n.joints[o]??[0,0,0],l=e.joints[o]??[0,0,0];i[o]=[c[0]+(l[0]-c[0])*t,c[1]+(l[1]-c[1])*t,c[2]+(l[2]-c[2])*t]}const r=n.offset??[0,0,0],a=e.offset??[0,0,0];return{joints:i,offset:[r[0]+(a[0]-r[0])*t,r[1]+(a[1]-r[1])*t,r[2]+(a[2]-r[2])*t]}}const oe={joints:{hips:[.04,-.34,0],spine:[.06,.12,0],chest:[.04,.1,0],neck:[-.06,0,0],head:[0,.16,0],shoulderL:[0,0,-.12],armL:[-.78,.1,-.16],forearmL:[-2.3,0,.2],handL:[0,0,0],shoulderR:[0,0,.12],armR:[-.62,-.1,.2],forearmR:[-2.42,0,-.24],handR:[0,0,0],thighL:[-.34,.06,.06],shinL:[.42,0,0],footL:[-.12,0,0],thighR:[.3,-.06,-.06],shinR:[.5,0,0],footR:[-.42,0,0]},offset:[0,-.075,0]},nn=ze(oe,{hips:[.06,-.42,0],spine:[.1,.16,0],thighR:[.44,-.06,-.06],shinR:[.62,0,0]},[0,-.11,-.05]),i1=ze(oe,{hips:[.04,-.22,0],chest:[.04,-.16,0],shoulderL:[0,0,-.3],armL:[-1.42,.16,-.06],forearmL:[-.1,0,0],armR:[-.58,-.1,.24]},[0,-.075,.14]),s1=ze(nn,{hips:[.05,.06,0],spine:[.1,-.2,0],chest:[.05,-.24,0],shoulderR:[0,0,.3],armR:[-1.48,-.18,.06],forearmR:[-.08,0,0],armL:[-.7,.1,-.34],forearmL:[-2.4,0,.24],thighR:[.12,-.06,-.06],footR:[-.62,0,0]},[0,-.085,.2]),r1=ze(oe,{hips:[.04,-.02,0],spine:[.05,-.24,0],chest:[.02,-.2,0],shoulderL:[0,0,-.36],armL:[-1.62,.9,-.2],forearmL:[-1.5,0,0]},[0,-.075,.13]),a1=ze(nn,{hips:[.04,.1,0],spine:[.06,-.26,0],chest:[.03,-.22,0],shoulderR:[0,0,.36],armR:[-1.6,-.95,.2],forearmR:[-1.52,0,0]},[0,-.09,.15]),o1=ze(nn,{hips:[-.06,.04,0],spine:[-.14,-.18,0],chest:[-.1,-.18,0],armR:[-1.15,-.2,.24],forearmR:[-1.95,0,-.1],armL:[-.72,.1,-.3]},[0,-.09,.17]),c1=ze(nn,{hips:[.14,.04,0],spine:[.24,-.22,0],chest:[.16,-.2,.14],armR:[-2.1,-.5,.2],forearmR:[-.9,0,0]},[0,-.08,.22]),rf=ze(oe,{hips:[.3,0,0],spine:[.2,-.18,0],armR:[-1.9,-.2,.06],forearmR:[-.1,0,0],thighL:[.9,.06,.06],shinL:[.9,0,0],thighR:[1,-.06,-.06],shinR:[.7,0,0]},[0,.16,.24]),af=ze(oe,{hips:[.04,.6,0],spine:[.04,.4,0],chest:[.02,.3,0],armR:[-1.5,-1.2,.4],forearmR:[-.4,0,0]},[0,-.075,.12]),l1=ze(nn,{hips:[.04,.08,0],spine:[.08,-.28,0],chest:[.04,-.24,0],shoulderR:[0,0,.44],armR:[-1.9,-.85,.3],forearmR:[-2.4,0,0]}),of=ze(oe,{hips:[-.16,-.2,0],spine:[-.18,.08,0],armL:[-1.1,.3,-.2],armR:[-1.05,-.3,.24],forearmL:[-1.9,0,0],forearmR:[-1.9,0,0],thighR:[-1.55,-.1,-.06],shinR:[1.9,0,0],thighL:[-.16,.06,.06],shinL:[.18,0,0]},[0,.02,.06]),cf=ze(of,{hips:[-.2,-.16,0],thighR:[-1.75,-.1,-.06],shinR:[1.6,0,0],thighL:[-.6,.06,.06],shinL:[1.5,0,0]},[0,.42,.18]);function Pl(n,e,t){return ze(oe,{hips:[.02,-.9,e*.4],spine:[-e*.5,.4,e*.6],chest:[-e*.3,.2,e*.4],armL:[-.4,.2,-.9],forearmL:[-1.2,0,0],armR:[-.2,-.2,1.1],forearmR:[-.6,0,0],thighR:[n,-.2,-1.05],shinR:[.34,0,0],footR:[-.3,0,0],thighL:[-.08,.06,.06],shinL:[.14,0,0],footL:[.5,0,0]},[0,t,.02])}const h1=Pl(-.55,.2,-.04),u1=Pl(-1.15,.5,.02),d1=Pl(-1.75,.85,.08),f1=ze(oe,{hips:[-.18,-.28,0],spine:[-.24,.1,0],armL:[-.9,.2,-.5],armR:[-.5,-.2,.6],thighR:[-1.5,-.06,-.06],shinR:[.12,0,0],footR:[-.5,0,0]},[0,-.02,.04]),p1=ze(oe,{hips:[0,-1.35,.14],spine:[-.2,.6,-.2],chest:[-.1,.4,-.1],armL:[-.8,.2,-.7],armR:[-.2,-.2,.9],thighR:[-1.35,-.1,-.5],shinR:[.1,0,0],footR:[-.2,0,0]},[0,.02,0]),ti=ze(oe,{hips:[.02,2.4,0],spine:[.06,.5,0],chest:[.04,.3,0],armL:[-.5,.3,-.8],armR:[-.5,-.3,.8],thighR:[-.7,-.06,-.3],shinR:[1,0,0]},[0,-.04,0]);function La(n,e){const t=n.joints.hips??[0,0,0];return ze(n,{hips:[t[0],e,t[2]]})}const lf=ze(ti,{hips:[.06,Math.PI,0],spine:[.1,.4,0],chest:[.06,.2,0],armL:[-.9,.3,-.5],forearmL:[-1.6,0,0],armR:[-.9,-.3,.5],forearmR:[-1.6,0,0],thighR:[2,0,-.06],shinR:[.1,0,0],footR:[.3,0,0],thighL:[-.1,.06,.06],shinL:[.16,0,0]},[0,-.02,.06]),hf=ze(oe,{hips:[.04,Math.PI*2-.34,0]}),Dl=Math.PI*2+.93,Il=ze(ti,{hips:[.02,Dl,.08],spine:[-.1,.4,-.08],chest:[-.06,.2,-.06],thighR:[-1.7,-.2,-.95],shinR:[.2,0,0],thighL:[-.06,.06,.06],shinL:[.12,0,0]},[0,.06,.04]),uf=ze(oe,{spine:[.14,.06,0],neck:[.18,0,0],head:[.1,.1,0],armL:[-1.15,.35,-.42],forearmL:[-2.35,0,.5],armR:[-1.15,-.35,.42],forearmR:[-2.35,0,-.5]},[0,-.13,-.02]),m1=ze(oe,{hips:[.08,-.4,.22],spine:[.18,.16,.3],chest:[.1,.1,.22],neck:[.1,0,.16],thighL:[-.46,.06,.06],shinL:[.6,0,0]},[.12,-.17,-.03]),df=ze(oe,{neck:[-.24,-.1,0],head:[-.16,.24,.1],spine:[-.06,.14,0]},[0,-.08,-.05]),Ki=ze(oe,{hips:[-.12,-.3,0],spine:[-.26,.2,.1],chest:[-.18,.16,.08],neck:[-.5,-.16,0],head:[-.3,.3,.16],armL:[-.4,.1,-.3],forearmL:[-1.6,0,0],armR:[-.3,-.1,.34],forearmR:[-1.5,0,0],thighL:[-.1,.06,.06],shinL:[.3,0,0]},[0,-.12,-.18]),Nl=ze(Ki,{hips:[-.2,-.1,.3],spine:[-.34,.1,.34],neck:[-.55,-.2,.12],armL:[-.2,.2,-.9],forearmL:[-.7,0,0],armR:[-.1,-.2,.8],forearmR:[-.5,0,0],thighL:[-.7,.1,.2],shinL:[.8,0,0],thighR:[.2,-.06,-.2],shinR:[.4,0,0]},[.18,-.22,-.3]),kl=ze(oe,{hips:[.42,-.3,0],spine:[.44,.12,.06],chest:[.3,.1,.04],neck:[.36,0,0],head:[.16,.14,0],armL:[-.34,.4,-.5],forearmL:[-2.5,0,.5],armR:[-.28,-.4,.52],forearmR:[-2.5,0,-.5],thighL:[-.6,.06,.08],shinL:[.8,0,0],thighR:[-.2,-.06,-.08],shinR:[.7,0,0]},[0,-.22,-.08]),Ol=ze(oe,{hips:[.06,-.36,.26],spine:[.1,.12,-.14],chest:[.04,.1,-.08],neck:[-.02,0,-.08],armL:[-.66,.1,-.24],forearmL:[-2.2,0,.22],armR:[-.5,-.1,.3],forearmR:[-2.3,0,-.28],thighL:[-.16,.06,.3],shinL:[.96,0,0],footL:[-.3,0,0],thighR:[.22,-.06,-.18],shinR:[.72,0,0]},[.1,-.2,-.04]),Pa=ze(oe,{hips:[.8,-.2,0],spine:[.5,.1,0],chest:[.3,.1,0],neck:[-.5,0,0],armL:[-2.5,.4,-.3],forearmL:[-.5,0,0],armR:[-2.5,-.4,.3],forearmR:[-.5,0,0],thighL:[.7,.06,.1],shinL:[.2,0,0],thighR:[.7,-.06,-.1],shinR:[.2,0,0]},[0,-.5,-.34]),ni=ze(oe,{hips:[.34,-.34,0],spine:[.28,.12,0],thighL:[-.9,.06,.1],shinL:[1.2,0,0],thighR:[-.6,-.06,-.1],shinR:[1.3,0,0]},[0,-.3,.04]),Xt=ze(oe,{hips:[.12,-.16,0],spine:[.2,.06,0],chest:[.14,0,0],neck:[-.3,.3,0],armL:[-1.5,.5,-.5],forearmL:[-1.9,0,.6],armR:[-1.5,-.5,.5],forearmR:[-1.9,0,-.6],thighL:[-.3,.06,.1],shinL:[.4,0,0],thighR:[.1,-.06,-.1],shinR:[.5,0,0]},[0,-.11,.06]),ff=ze(oe,{hips:[-.1,-.3,0],armL:[-1.6,.3,-.7],forearmL:[-.9,0,0],armR:[-1.6,-.3,.7],forearmR:[-.9,0,0]},[0,-.08,-.2]),gr={joints:{hips:[-1.5,0,0],spine:[-.1,0,0],chest:[-.06,0,0],neck:[.5,0,0],head:[.2,0,0],armL:[-.6,.2,-.7],forearmL:[-1.8,0,0],armR:[-.6,-.2,.7],forearmR:[-1.8,0,0],thighL:[-.7,.1,.3],shinL:[1.3,0,0],footL:[-.4,0,0],thighR:[-.7,-.1,-.3],shinR:[1.3,0,0],footR:[-.4,0,0]},offset:[0,-.66,-.18]},wt={joints:{hips:[.24,0,0],spine:[.16,0,0],chest:[.1,0,0],neck:[-.2,0,0],armL:[-1.2,.3,-.4],forearmL:[-1.5,0,0],armR:[-1.2,-.3,.4],forearmR:[-1.5,0,0],thighL:[-1.5,.1,.5],shinL:[2.2,0,0],thighR:[-1.5,-.1,-.5],shinR:[2.2,0,0]},offset:[0,-.44,0]},Da=ze(gr,{neck:[.8,0,0],spine:[.2,0,0],thighL:[-1.5,.1,.4],shinL:[1.7,0,0],thighR:[-1.5,-.1,-.4],shinR:[1.7,0,0],armL:[-1.4,.3,-.4],forearmL:[-1.7,0,0],armR:[-1.4,-.3,.4],forearmR:[-1.7,0,0]},[0,-.6,-.16]),pf={joints:{hips:[1.2,0,0],spine:[.3,0,0],chest:[.2,0,0],neck:[-.8,0,0],armL:[-2.2,.3,-.3],forearmL:[-1.6,0,0],armR:[-2.2,-.3,.3],forearmR:[-1.6,0,0],thighL:[-.4,.1,.3],shinL:[2.3,0,0],thighR:[-.4,-.1,-.3],shinR:[2.3,0,0]},offset:[0,-.5,-.1]},mf=ze(wt,{spine:[.3,-.16,0],armR:[-2.6,-.4,.3],forearmR:[-.4,0,0]}),Ul=ze(wt,{spine:[.42,-.1,0],chest:[.24,-.1,0],armR:[-.5,-.2,.3],forearmR:[-.5,0,0]}),Ps=ze(wt,{spine:[.4,.1,0],chest:[.24,.1,0],neck:[-.4,.2,0],armL:[-1.9,.7,-.55],forearmL:[-2.5,0,.7],armR:[-1.9,-.7,.55],forearmR:[-2.5,0,-.7]},[0,-.46,-.1]),Ia=ze(gr,{hips:[-1.35,.4,0],spine:[-.3,.2,0],armL:[-1.9,.6,-.5],forearmL:[-2.2,0,.4],armR:[-1.9,-.6,.5],forearmR:[-2.2,0,-.4],thighL:[-1.4,.1,.4],shinL:[.9,0,0],thighR:[-1.3,-.1,-.4],shinR:[.6,0,0]},[0,-.6,.1]),Na=ze(gr,{neck:[.9,.2,0],spine:[.24,.1,0],armL:[-1.5,.6,-.5],forearmL:[-2.4,0,.6],armR:[-1.5,-.6,.5],forearmR:[-2.4,0,-.6],thighL:[-1.1,.1,.4],shinL:[1.1,0,0]},[0,-.56,-.16]),ka=ze(gr,{neck:[.3,.3,0],head:[.1,.3,0],armL:[-.3,.2,-1.1],forearmL:[-.6,0,0],armR:[-.3,-.2,1.1],forearmR:[-.5,0,0],thighL:[-.3,.1,.4],shinL:[.5,0,0],thighR:[-.4,-.1,-.3],shinR:[.7,0,0]},[0,-.68,-.3]),vr={joints:{hips:[.6,-.3,0],spine:[.4,.2,0],chest:[.2,.1,0],neck:[-.5,0,0],armL:[-2,.4,-.4],forearmL:[-.8,0,0],armR:[-1.2,-.3,.5],forearmR:[-1.4,0,0],thighL:[-1.5,.1,.3],shinL:[1.6,0,0],thighR:[-.2,-.1,-.3],shinR:[2.2,0,0]},offset:[0,-.44,-.06]},xr=ze(oe,{hips:[.62,-.3,0],spine:[.4,.14,0],chest:[.24,.1,0],neck:[-.5,0,0],armL:[-2.2,.5,-.3],forearmL:[-.7,0,0],armR:[-2.2,-.5,.3],forearmR:[-.7,0,0],thighL:[-1.3,.1,.2],shinL:[1.5,0,0],thighR:[-.1,-.1,-.2],shinR:[1.7,0,0]},[0,-.42,.36]),Fl=ze(xr,{hips:[.9,-.24,0],spine:[.3,.1,0],thighL:[-.9,.1,.2],shinL:[1,0,0],thighR:[.4,-.1,-.2],shinR:[.9,0,0]},[0,-.5,.62]),_r=ze(oe,{hips:[-.2,-.2,0],spine:[-.24,.1,0],chest:[-.14,.1,0],armL:[-2.4,.5,-.4],forearmL:[-1.4,0,0],armR:[-2.4,-.5,.4],forearmR:[-1.4,0,0],thighL:[-.5,.1,.14],shinL:[.7,0,0],thighR:[-.3,-.1,-.14],shinR:[.6,0,0]},[0,-.02,.2]),Bl=ze(oe,{hips:[.8,-.2,0],spine:[.5,.1,0],armL:[-2.6,.4,-.3],forearmL:[-.6,0,0],armR:[-2.6,-.4,.3],forearmR:[-.6,0,0],thighL:[-1.4,.1,.3],shinL:[2,0,0],thighR:[-1.4,-.1,-.3],shinR:[2,0,0]},[0,-.44,.34]),g1=ze(_r,{hips:[-.7,-.2,0],spine:[-.5,.1,0],chest:[-.3,.1,0],neck:[.4,0,0],armL:[-2.8,.5,-.4],armR:[-2.8,-.5,.4],thighL:[-.2,.1,.14],thighR:[0,-.1,-.14]},[0,.06,.08]),Fn=ze(oe,{hips:[.02,-.2,0],armL:[-.5,.1,-.24],forearmL:[-1.4,0,.1],armR:[-.5,-.1,.24],forearmR:[-1.4,0,-.1]},[0,-.04,0]),gf=ze(oe,{hips:[.2,-.1,0],spine:[.16,.06,0],armL:[-1.3,.3,-.2],forearmL:[-.5,0,0],armR:[-1.3,-.3,.2],forearmR:[-.5,0,0]},[0,-.1,.06]),Sr=ze(oe,{hips:[-.06,-.1,0],spine:[-.12,0,0],neck:[.2,0,0],head:[.1,0,0],armL:[-2.9,.3,-.5],forearmL:[-.3,0,0],armR:[-2.9,-.3,.5],forearmR:[-.3,0,0],thighL:[-.1,.06,.06],shinL:[.12,0,0],thighR:[.1,-.06,-.06],shinR:[.12,0,0]},[0,-.01,0]),Gl={joints:{hips:[.16,0,0],spine:[.1,0,0],chest:[.06,0,0],neck:[-.3,0,0],armL:[-.9,.2,-.4],forearmL:[-1.5,0,0],armR:[-.9,-.2,.4],forearmR:[-1.5,0,0],thighL:[-1.5,.1,.2],shinL:[1.5,0,0],thighR:[-1.5,-.1,-.2],shinR:[1.5,0,0]},offset:[0,-.42,-.06]},Ds=ze(oe,{hips:[-.1,-.3,.24],spine:[-.2,.1,.2],neck:[-.3,-.2,.14],head:[-.1,.2,.2],armL:[-.4,.2,-.5],forearmL:[-1,0,0],armR:[-.3,-.2,.5],forearmR:[-.9,0,0],thighL:[-.5,.1,.2],shinL:[.7,0,0],thighR:[.2,-.06,-.16],shinR:[.5,0,0]},[.08,-.2,-.06]),Hl=ze(oe,{neck:[-.16,0,0],armL:[-2.3,.3,-.24],forearmL:[-2.2,0,.4],armR:[-.6,-.1,.2],forearmR:[-2.3,0,-.24]},[0,-.09,-.06]);function je(n,e,t){return{duration:n,impactAt:e,keys:t,variants:1}}function z(n,e,t){return t?{t:n,pose:e,ease:t}:{t:n,pose:e}}function Kt(n,e,t,i=oe){return je(t,.45,[z(0,i),z(.2,n,"anticipate"),z(.45,e,"snap"),z(.53,ln(n,e,1.08),"linear"),z(.74,ln(i,e,.22),"settle"),z(1,i,"settle")])}function Yi(n,e,t=oe){const i=[z(0,t)],s=["anticipate","snap","settle"];return e.forEach((r,a)=>{i.push(z((a+1)/e.length,r,s[Math.min(a,s.length-1)]))}),je(n,.72,i)}const v1={strike_jab:Kt(oe,i1,.4),strike_cross:Kt(nn,s1,.5),strike_hook_left:Kt(oe,r1,.52),strike_hook_right:Kt(nn,a1,.54),strike_uppercut:Kt(nn,o1,.5),strike_overhand:Kt(nn,c1,.62),strike_elbow:Kt(Xt,l1,.48,Xt),strike_knee:Kt(Xt,of,.54,Xt),strike_superman:je(.72,.52,[z(0,oe),z(.22,ni,"anticipate"),z(.52,rf,"snap"),z(.6,ln(ni,rf,1.06),"linear"),z(1,oe,"settle")]),strike_backfist:je(.62,.58,[z(0,oe),z(.34,ti,"anticipate"),z(.58,af,"snap"),z(.66,ln(ti,af,1.07),"linear"),z(1,oe,"settle")]),strike_flying_knee:je(.82,.48,[z(0,oe),z(.2,ni,"anticipate"),z(.48,cf,"snap"),z(.58,ln(ni,cf,1.05),"linear"),z(.86,ni,"settle"),z(1,oe,"settle")]),kick_low:Kt(nn,h1,.52),kick_body:Kt(nn,u1,.62),kick_head:Kt(nn,d1,.72),kick_front:Kt(oe,f1,.52),kick_side:Kt(nn,p1,.62),kick_spinning_back:je(.88,.64,[z(0,oe),z(.24,La(ti,1.1),"anticipate"),z(.46,ti,"linear"),z(.64,lf,"snap"),z(.72,ln(ti,lf,1.06),"linear"),z(1,hf,"settle")]),kick_wheel:je(.96,.68,[z(0,oe),z(.2,La(ti,1.1),"anticipate"),z(.38,ti,"linear"),z(.54,La(Il,Dl-2.1),"linear"),z(.68,Il,"snap"),z(.77,La(Il,Dl+.22),"linear"),z(1,hf,"settle")]),ground_punch:Kt(wt,Ul,.4,wt),ground_elbow:Kt(mf,Ul,.46,wt),ground_hammerfist:Kt(mf,Ul,.42,wt)},x1={td_double_leg:Yi(1,[xr,Fl,wt]),td_single_leg:Yi(1.05,[xr,_r,wt]),td_body_lock:Yi(1,[Xt,_r,wt],Xt),td_trip:Yi(.9,[Xt,Fl,wt],Xt),td_throw:Yi(1.05,[Xt,_r,Bl,wt],Xt),td_suplex:je(1.35,.66,[z(0,Xt),z(.24,_r),z(.46,g1),z(.66,Bl),z(.84,vr),z(1,wt)]),td_ankle_pick:Yi(.92,[xr,Bl,wt]),td_cage_drag:Yi(1,[Xt,Fl,wt],Xt)};function _i(n=1.2){return je(n,.75,[z(0,wt),z(.34,Ps),z(.75,Ps),z(1,Ps)])}function vf(n=1.25){return je(n,.72,[z(0,wt),z(.32,vr),z(.72,Ia),z(1,Ia)])}const _1={sub_rnc:_i(1.3),sub_guillotine:_i(1.15),sub_triangle:je(1.25,.74,[z(0,Da),z(.36,Na),z(.74,Na),z(1,Na)]),sub_armbar:je(1.3,.74,[z(0,wt),z(.34,Ps),z(.74,Ia),z(1,Ia)]),sub_kimura:_i(1.2),sub_americana:_i(1.15),sub_darce:_i(1.2),sub_anaconda:_i(1.2),sub_arm_triangle:_i(1.25),sub_neck_crank:_i(1.1),sub_heel_hook:vf(1.25),sub_kneebar:vf(1.3)},S1={def_sprawl:je(.7,.4,[z(0,oe),z(.24,ni),z(.5,Pa),z(.72,Pa),z(1,oe)]),clinch_enter:je(.7,.6,[z(0,oe),z(.4,ni),z(1,Xt)]),clinch_break:je(.6,.35,[z(0,Xt),z(.4,ff),z(1,oe)]),scramble:je(.9,.5,[z(0,Da),z(.3,vr),z(.62,pf),z(1,vr)]),knockdown:je(1.15,.28,[z(0,oe),z(.14,Ki,"snap"),z(.42,Nl,"settle"),z(.72,ka,"anticipate"),z(1,ka,"settle")]),stun_wobble:je(1,.36,[z(0,oe),z(.26,Ki,"snap"),z(.62,Ds,"settle"),z(1,Ds,"smooth")]),reaction_cut:je(.9,.35,[z(0,oe),z(.3,df),z(.6,Hl),z(1,oe)]),stance_idle:je(2.2,.5,[z(0,oe),z(.25,nn),z(.5,oe),z(.75,Fn),z(1,oe)]),intro_touch_gloves:je(1.3,.55,[z(0,Fn),z(.5,gf),z(.7,gf),z(1,oe)]),round_end_return:je(1.4,.5,[z(0,oe),z(.4,Fn),z(1,Fn)]),corner_seated:je(2,.5,[z(0,Gl),z(.5,Gl),z(1,Gl)]),ref_intervene:je(1,.4,[z(0,oe),z(.4,ff),z(1,Fn)]),doctor_check:je(1.6,.5,[z(0,Fn),z(.4,Hl),z(.8,Hl),z(1,Fn)]),fight_end_celebrate:je(2,.35,[z(0,oe),z(.3,Sr),z(.6,Sr),z(.8,Fn),z(1,Sr)]),decision_announce:je(2,.5,[z(0,Fn),z(.35,Fn),z(.6,Sr),z(1,Sr)])},xf={...v1,...x1,..._1,...S1},M1=xf.stance_idle,_f={NONE:je(.3,0,[z(0,oe),z(1,oe)]),LIGHT:je(.42,0,[z(0,oe),z(.22,df,"snap"),z(1,oe,"settle")]),HEAVY:je(.72,0,[z(0,oe),z(.18,ln(oe,Ki,1.12),"snap"),z(.42,Ki,"linear"),z(.68,Ds,"settle"),z(1,oe,"settle")]),STAGGER:je(1.1,0,[z(0,oe),z(.15,ln(oe,Ki,1.15),"snap"),z(.42,Nl,"settle"),z(.76,Ds,"smooth"),z(1,Ds,"settle")]),DROP:je(1.25,0,[z(0,oe),z(.13,ln(oe,Ki,1.18),"snap"),z(.4,Nl,"settle"),z(.72,ka,"anticipate"),z(1,ka,"settle")]),BLOCK:je(.44,0,[z(0,oe),z(.2,uf,"snap"),z(.5,uf,"linear"),z(1,oe,"settle")]),SLIP:je(.5,0,[z(0,oe),z(.26,m1,"snap"),z(1,oe,"settle")]),BODY_FOLD:je(.85,0,[z(0,oe),z(.16,ln(oe,kl,1.1),"snap"),z(.44,kl,"linear"),z(.78,ln(oe,kl,.4),"settle"),z(1,oe,"settle")]),LEG_BUCKLE:je(.72,0,[z(0,oe),z(.14,ln(oe,Ol,1.12),"snap"),z(.4,Ol,"linear"),z(.74,ln(oe,Ol,.35),"settle"),z(1,oe,"settle")]),SPRAWL_DEFEND:je(.8,0,[z(0,oe),z(.22,ni,"anticipate"),z(.5,Pa,"snap"),z(1,oe,"settle")])};function Oa(n,e){const t=e==="REACTOR";switch(n){case"STANDING":return oe;case"CLINCH":case"CAGE_CLINCH":return Xt;case"TAKEDOWN_ATTEMPT":return t?Pa:xr;case"GROUND_TOP":case"SIDE_CONTROL":case"MOUNT":return t?gr:wt;case"GROUND_BOTTOM":return t?wt:Da;case"GUARD":case"HALF_GUARD":return t?Da:wt;case"BACK_CONTROL":return t?pf:Ps;case"SCRAMBLE":return vr;case"SUBMISSION_ATTEMPT":return t?Na:Ps;case"STUNNED":return Ds;case"RECOVERY":return ni;default:return oe}}function zl(n){switch(n){case"GROUND_TOP":case"GROUND_BOTTOM":case"GUARD":case"HALF_GUARD":case"SIDE_CONTROL":case"MOUNT":case"BACK_CONTROL":case"SCRAMBLE":case"SUBMISSION_ATTEMPT":return!0;default:return!1}}const Sf=[1,.93,1.08,.97],y1=[0,.06,-.05,.03];function b1(n,e){if(e<=0)return n;const t=e%Sf.length,i=Sf[t]??1,s=y1[t]??0;return i===1&&s===0?n:{...n,duration:n.duration*i,keys:n.keys.map(({t:r,pose:a})=>({t:r,pose:{joints:{...a.joints,spine:E1(a.joints.spine,s)},offset:a.offset}}))}}function E1(n,e){const t=n??[0,0,0];return[t[0],t[1]+e,t[2]]}function A1(n,e=0){return b1(xf[n]??M1,e)}const Si=["hips","spine","chest","neck","head","shoulderL","armL","forearmL","handL","shoulderR","armR","forearmR","handR","thighL","shinL","footL","thighR","shinR","footR"],bn={hips:{parent:null,offset:[0,.92,0],length:.14,axis:"UP",radius:.122,shape:"BOX"},spine:{parent:"hips",offset:[0,.14,0],length:.24,axis:"UP",radius:.128,shape:"BOX"},chest:{parent:"spine",offset:[0,.24,0],length:.2,axis:"UP",radius:.152,shape:"BOX"},neck:{parent:"chest",offset:[0,.2,0],length:.07,axis:"UP",radius:.058,shape:"BOX"},head:{parent:"neck",offset:[0,.07,0],length:.2,axis:"UP",radius:.108,shape:"SPHERE"},shoulderL:{parent:"chest",offset:[.175,.145,0],length:.06,axis:"DOWN",radius:.066,shape:"SPHERE"},armL:{parent:"shoulderL",offset:[0,-.06,0],length:.29,axis:"DOWN",radius:.055,shape:"CAPSULE"},forearmL:{parent:"armL",offset:[0,-.29,0],length:.26,axis:"DOWN",radius:.047,shape:"CAPSULE"},handL:{parent:"forearmL",offset:[0,-.26,0],length:.12,axis:"DOWN",radius:.066,shape:"SPHERE"},shoulderR:{parent:"chest",offset:[-.175,.145,0],length:.06,axis:"DOWN",radius:.066,shape:"SPHERE"},armR:{parent:"shoulderR",offset:[0,-.06,0],length:.29,axis:"DOWN",radius:.055,shape:"CAPSULE"},forearmR:{parent:"armR",offset:[0,-.29,0],length:.26,axis:"DOWN",radius:.047,shape:"CAPSULE"},handR:{parent:"forearmR",offset:[0,-.26,0],length:.12,axis:"DOWN",radius:.066,shape:"SPHERE"},thighL:{parent:"hips",offset:[.095,0,0],length:.44,axis:"DOWN",radius:.082,shape:"CAPSULE"},shinL:{parent:"thighL",offset:[0,-.44,0],length:.43,axis:"DOWN",radius:.068,shape:"CAPSULE"},footL:{parent:"shinL",offset:[0,-.43,0],length:.24,axis:"FORWARD",radius:.05,shape:"BOX"},thighR:{parent:"hips",offset:[-.095,0,0],length:.44,axis:"DOWN",radius:.082,shape:"CAPSULE"},shinR:{parent:"thighR",offset:[0,-.44,0],length:.43,axis:"DOWN",radius:.068,shape:"CAPSULE"},footR:{parent:"shinR",offset:[0,-.43,0],length:.24,axis:"FORWARD",radius:.05,shape:"BOX"}},Vl=(()=>{const n=[],e=new Set;for(;n.length<Si.length;){let t=!1;for(const i of Si){if(e.has(i))continue;const s=bn[i].parent;(s===null||e.has(s))&&(n.push(i),e.add(i),t=!0)}if(!t)throw new Error("SKELETON contains a cycle")}return n})(),Mf=[0,0,0];function En(n){const e={};for(const t of Si)e[t]=n.joints[t]??Mf;return{joints:e,offset:n.offset??Mf}}function Wl(n,e,t){return[n[0]+(e[0]-n[0])*t,n[1]+(e[1]-n[1])*t,n[2]+(e[2]-n[2])*t]}function Xl(n,e){let t=(e-n)%(Math.PI*2);return t>Math.PI&&(t-=Math.PI*2),t<=-Math.PI&&(t+=Math.PI*2),t}function Kl(n,e,t){if(t<=0)return n;const i={};for(const s of Si){const r=n.joints[s],a=e.joints[s];i[s]=[r[0]+Xl(r[0],a[0])*t,r[1]+Xl(r[1],a[1])*t,r[2]+Xl(r[2],a[2])*t]}return{joints:i,offset:Wl(n.offset,e.offset,t)}}function T1(n,e,t){if(t<=0)return n;if(t>=1)return e;const i={};for(const s of Si)i[s]=Wl(n.joints[s],e.joints[s],t);return{joints:i,offset:Wl(n.offset,e.offset,t)}}const yf={linear:n=>n,smooth:n=>n*n*(3-2*n),anticipate:n=>n*n*(2-n*.35),snap:n=>Math.pow(n*n*(3-2*n),.6),settle:n=>1-Math.pow(1-n,2.2)};function bf(n,e){const t=e<=0?0:e>=1?1:e;return(yf[n]??yf.smooth)(t)}function Ua(n){return bf("smooth",n)}function Ef(n,e){const t=n.keys,i=t[0],s=t[t.length-1];if(!i||!s)throw new Error("clip has no keyframes");if(e<=i.t)return En(i.pose);if(e>=s.t)return En(s.pose);for(let r=1;r<t.length;r++){const a=t[r],o=t[r-1];if(!(!a||!o)&&e<=a.t){const c=a.t-o.t,l=c<=0?1:bf(a.ease??"smooth",(e-o.t)/c);return T1(En(o.pose),En(a.pose),l)}}return En(s.pose)}function w1(n,e,t,i,s){const r=new Map,a=c=>{let l=r.get(c);return l||(l=Ef(n,e-c/Math.max(t,1e-4)),r.set(c,l)),l},o={};for(const c of Si)o[c]=a(i[s[c]]??0).joints[c];return{joints:o,offset:a(0).offset}}const Yl=.06,Af=.03;function Mr(n,e){return n>e?e:n<-e?-e:n}function vn(n,e,t,i,s){const r=n[e];n[e]=[r[0]+Mr(t,Yl),r[1]+Mr(i,Yl),r[2]+Mr(s,Yl)]}function R1(n,e){const{time:t,phase:i,fatigue:s,grounded:r}=e,a=e.guard??.5,o=e.verve??.5,c=Math.max(0,Math.min(1,e.stagger??0)),l=Math.max(0,Math.min(1,e.feint??0)),u=Math.max(0,Math.min(1,e.intensity));if(u<=.001)return n;const f=t+i,h=.38+s*.42,p=Math.sin(f*Math.PI*2*h),g=(.01+s*.017)*u,v=r?0:u*(1-s*.45)*(.65+o*.7),d=Math.sin(f*Math.PI*2*(1.63-s*.5+o*.25)),m=Math.sin(f*Math.PI*2*.41+1.2),y=Math.sin(f*Math.PI*2*.29+2.6),b=Math.sin(f*Math.PI*2*.87+.4),S=Math.sin(f*Math.PI*2*.73+2.1),A=u*(r?.3:1),E=(s+c*.8+(1-a)*.35)*u*(r?.2:1),C=c===0?0:Math.sin(f*Math.PI*2*.55)*c*u,_={...n.joints};vn(_,"spine",p*g+y*.012*v+l*.05,m*.02*v+C*.05,m*.014*v+C*.06),vn(_,"chest",p*g*.8,y*.016*v,-m*.01*v),vn(_,"neck",-p*g*.5+E*.05,y*.02*u,0),vn(_,"head",y*.02*u,b*.026*u,m*.012*u),vn(_,"armL",b*.03*A+E*.055-l*.06,S*.012*A,-b*.016*A),vn(_,"forearmL",S*.034*A+E*.05,0,b*.012*A),vn(_,"armR",S*.028*A+E*.055,b*.012*A,S*.016*A),vn(_,"forearmR",b*.031*A+E*.05,0,-S*.012*A),vn(_,"thighL",-d*.022*v,0,m*.014*v),vn(_,"shinL",d*.026*v,0,0),vn(_,"thighR",d*.022*v,0,-m*.014*v),vn(_,"shinR",-d*.024*v,0,0);const T=Mr((-Math.abs(d)*.014+p*.004)*v-l*.012-c*.02,Af),N=Mr(m*.018*v+C*.02,Af);return{joints:_,offset:[n.offset[0]+N,n.offset[1]+T,n.offset[2]]}}function C1(n,e=.5){const t=(n-1)/4.5;return Math.max(0,Math.min(1,t*(1.45-e*.9)))}function L1(n,e,t){const i=7.5-Math.max(0,Math.min(1,n))*3.6,s=e/(Math.PI*2)*i,r=(t+s)%i/i,a=.16;return r<a?Math.sin(r/a*Math.PI):0}function P1(n,e){let t=0;for(const i of n){if(i.at>e)break;const s=e-i.at,r=Math.exp(-s/3.2);t=Math.max(t,i.magnitude*r)}return Math.min(1,t)}const Tf=["LEGS","HIPS","SPINE","ARM_L","ARM_R","HEAD"],ql={hips:"HIPS",spine:"SPINE",chest:"SPINE",neck:"HEAD",head:"HEAD",shoulderL:"ARM_L",armL:"ARM_L",forearmL:"ARM_L",handL:"ARM_L",shoulderR:"ARM_R",armR:"ARM_R",forearmR:"ARM_R",handR:"ARM_R",thighL:"LEGS",shinL:"LEGS",footL:"LEGS",thighR:"LEGS",shinR:"LEGS",footR:"LEGS"},D1={LEGS:1,HIPS:1,SPINE:1,ARM_L:1,ARM_R:1,HEAD:1};function I1(n){const e=En(oe),t={LEGS:0,HIPS:0,SPINE:0,ARM_L:0,ARM_R:0,HEAD:0};for(const i of n.keys){const s=En(i.pose);for(const r of Si){let a=0;for(let c=0;c<3;c++)a+=Math.abs(s.joints[r][c]-e.joints[r][c]);const o=ql[r];t[o]=Math.max(t[o],a)}}return t}const N1=1.5;function k1(n){const e=I1(n),t={};for(const i of Tf)t[i]=Math.min(1,e[i]/N1);return t}const wf=new Map;function Rf(n){let e=wf.get(n);return e||(e=k1(n),wf.set(n,e)),e}const O1=new Set(["knockdown","td_double_leg","td_single_leg","td_body_lock","td_trip","td_throw","td_suplex","td_ankle_pick","td_cage_drag","scramble","def_sprawl","round_end_return","corner_seated","doctor_check","fight_end_celebrate","decision_announce","intro_touch_gloves"]);function Cf(n){return O1.has(n)||n.startsWith("sub_")}const Lf={HIPS:0,LEGS:.006,SPINE:.022,ARM_L:.048,ARM_R:.048,HEAD:.034};Math.max(...Object.values(Lf));const Pf=.055,U1=.16,Fa=.24,F1=.055,B1=.28,G1=2.6,H1=[[.115,.155],[-.105,-.185]];function z1(n,e){const t=Math.cos(e),i=Math.sin(e);return[n[0]*t+n[1]*i,-n[0]*i+n[1]*t]}function Ba(n,e,t=0){const i=H1[e],s=z1([i[0],i[1]+t],n.yaw);return[n.x+s[0],n.z+s[1]]}function V1(n,e){return Math.hypot(n[0]-e[0],n[1]-e[1])}function Df(n,e={}){const t=e.phase??0,i=Math.max(0,Math.min(1,e.mobility??.5)),s=Math.max(0,Math.min(1,e.pressure??.5)),r=U1*(1.35-i*.7),a=G1*(1.5-i*.9),o=(s-.5)*.06,c=n[0];if(!c)return{steps:[],start:[[0,0],[0,0]]};const l=[Ba(c,0,o),Ba(c,1,o)],u=[l[0],l[1]],f=[c.time-a*t,c.time-a*(1-t)],h=[];let p=-1/0;for(let g=1;g<n.length;g++){const v=n[g];if(!(v.time<p))for(const d of[0,1]){const m=Ba(v,d,o),y=V1(u[d],m),b=v.time-f[d]>a;if(y<r&&!(b&&y>.02)||v.time-f[d]<B1)continue;const S=n.find(E=>E.time>=v.time+Fa)??v,A=Ba(S,d,o);h.push({foot:d,lift:v.time,plant:v.time+Fa,from:u[d],to:A}),u[d]=A,f[d]=v.time+Fa,p=v.time+Fa;break}}return{steps:h,start:l}}function W1(n,e,t){let i=n.start[e];for(const s of n.steps)if(s.foot===e){if(t>=s.plant){i=s.to;continue}if(t>=s.lift){const r=(t-s.lift)/Math.max(s.plant-s.lift,1e-4),a=Ua(r);return{x:s.from[0]+(s.to[0]-s.from[0])*a,z:s.from[1]+(s.to[1]-s.from[1])*a,y:Pf+Math.sin(Math.PI*r)*F1,swing:Math.sin(Math.PI*r)}}break}return{x:i[0],y:Pf,z:i[1],swing:0}}const Is=3.75,If=.26,X1=.09,K1=.16,Y1=.09;function Ga(n,e){return Math.hypot(n,e)}function q1(n,e){const t=[];let i=0,s=0,r=0;const a=e.pressure[0]-e.pressure[1],o=e.mobility[0]-e.mobility[1];for(const[c,l]of n.entries()){const u=Math.sin(c*.043+e.phase[0])*.05;r+=X1*(o*.7+Math.sin(c*.031+e.phase[1])*.5);const f=Math.sin(r),h=Math.cos(r);i+=f*(a*If+u),s+=h*(a*If+u);let p=i-f*l,g=s-h*l,v=i+f*l,d=s+h*l;const m=Ga(p,g),y=Ga(v,d),b=m>y?0:1,S=Math.max(m,y);let A=-1;if(S>Is){const C=S-Is,_=b===0?p:v,T=b===0?g:d,N=Ga(_,T)||1;i-=_/N*C,s-=T/N*C,A=b;const I=e.mobility[b]*.6+e.reach[b]*.4,F=Math.sin(c*.21+e.phase[b])>=0?1:-1,J=K1*I*F,q=Math.cos(J),H=Math.sin(J),Z=i*q-s*H,K=i*H+s*q;i=Z,s=K,r+=J;const te=Y1*e.reach[b],re=Ga(i,s)||1;i-=i/re*te,s-=s/re*te,p=i-Math.sin(r)*l,g=s-Math.cos(r)*l,v=i+Math.sin(r)*l,d=s+Math.cos(r)*l}const E=J1(i,s,r,l);i=E[0],s=E[1],t.push({centre:[i,s],facing:r,pinned:A})}return t}function J1(n,e,t,i){const s=Math.sin(t),r=Math.cos(t),a=n*s+e*r,o=n*r-e*s,c=Math.min(i,Is);if(Math.hypot(Math.abs(a)+c,o)<=Is)return[n,e];const l=a*a+o*o;if(l===0)return[n,e];const u=2*Math.abs(a)*c,f=c*c-Is*Is,h=(-u+Math.sqrt(Math.max(0,u*u-4*l*f)))/(2*l);return[n*h,e*h]}const Nf=3.9,Z1=4.42,Q1=2.1,Jl=.9,j1=2.7,kf={WIDE:{offset:[-3.5,3.4,1.5],lookHeight:1,fov:52},BROADCAST:{offset:[-3.35,2,1.15],lookHeight:1.15,fov:46},CLOSE:{offset:[-2.75,1.8,.95],lookHeight:1.32,fov:42},IMPACT:{offset:[-2.5,1.7,.85],lookHeight:1.38,fov:42},GROUND_OVERHEAD:{offset:[-2.5,3.3,.9],lookHeight:.35,fov:46},CAGE_SIDE:{offset:[-2.6,1.65,2.4],lookHeight:1.1,fov:44},REPLAY:{offset:[-3.1,1.9,-1.05],lookHeight:1.28,fov:42},CORNER:{offset:[-2.4,2.1,-2.85],lookHeight:1.2,fov:46}};function Of(n,e,t,i,s){const r=Math.sin(i),a=Math.cos(i),o=a*s,c=-r*s;let l=n[0]*o+n[2]*r,u=n[0]*c+n[2]*a;const f=Math.hypot(e,t);if(f<Jl)return[l,u];const h=Math.min(1,(f-Jl)/(j1-Jl)),p=h*h*(3-2*h),g=e/f,v=t/f,d=n[2]*(r*g+a*v);if(d>0){const m=2*d*p;l-=m*g,u-=m*v}return[l,u]}function Uf(n,e,t,i,s){const r=t*t+i*i;if(r===0)return 1;const a=2*(n*t+e*i),o=n*n+e*e-s*s;return r+a+o<=0?1:Math.min(1,Math.max(0,(-a+Math.sqrt(Math.max(0,a*a-4*r*o)))/(2*r)))}function $1(n,e,t,i){const s=Uf(n,e,t,i,Nf);if(s===1)return 1;const r=Q1/Math.hypot(t,i),a=Uf(n,e,t,i,Z1);return Math.min(1,Math.max(s,Math.min(a,r)))}function ey(n){const e=[];let t=1;for(const i of n){const s=Ff(i.centre[0],i.centre[1],i.facing,t),r=Ff(i.centre[0],i.centre[1],i.facing,-t);(r<s-ny||s>Nf&&r<s)&&(t=-t),e.push(t)}return e}function Ff(n,e,t,i){const s=Of(ty,n,e,t,i);return Math.hypot(n+s[0],e+s[1])}const ty=[-3.2,2,1.1],ny=.75;function iy(n,e,t,i,s=0,r=1){const a=kf[n]??kf.BROADCAST,o=Of(a.offset,e,t,s,r),c=o[0]+Math.sin(i*.53)*.035+Math.sin(i*1.31)*.012,l=o[1]+Math.sin(i*.43+2.6)*.03,u=a.offset[1]+Math.sin(i*.71+1.4)*.022,f=$1(e,t,c,l);return{position:[e+c*f,u,t+l*f],target:[e,a.lookHeight+Math.sin(i*.61+.8)*.012,t],fov:a.fov}}function sy(n){const[e,t,i]=n,s=Math.cos(e),r=Math.sin(e),a=Math.cos(t),o=Math.sin(t),c=Math.cos(i),l=Math.sin(i);return[a*c,-a*l,o,s*l+r*o*c,s*c-r*o*l,-r*a,r*l-s*o*c,r*c+s*o*l,s*a]}function Bf(n,e){return[n[0]*e[0]+n[3]*e[1]+n[6]*e[2],n[1]*e[0]+n[4]*e[1]+n[7]*e[2],n[2]*e[0]+n[5]*e[1]+n[8]*e[2]]}function Gf(n,e){return[n[0]-e[0],n[1]-e[1],n[2]-e[2]]}function Zl(n){return Math.hypot(n[0],n[1],n[2])}function Ql(n){const e=Zl(n)||1;return[n[0]/e,n[1]/e,n[2]/e]}function jl(n,e){const t=Math.cos(e),i=Math.sin(e);return[n[0]*t+n[2]*i,n[1],-n[0]*i+n[2]*t]}function ry(n,e,t){const i=Ql(e),s=Math.cos(t),r=Math.sin(t),a=i[0]*n[0]+i[1]*n[1]+i[2]*n[2],o=[i[1]*n[2]-i[2]*n[1],i[2]*n[0]-i[0]*n[2],i[0]*n[1]-i[1]*n[0]];return[n[0]*s+o[0]*r+i[0]*a*(1-s),n[1]*s+o[1]*r+i[1]*a*(1-s),n[2]*s+o[2]*r+i[2]*a*(1-s)]}function $l(n,e){return[n[1]*e[2]-n[2]*e[1],n[2]*e[0]-n[0]*e[2],n[0]*e[1]-n[1]*e[0]]}function ay(n){const e=Math.asin(Math.max(-1,Math.min(1,n[2])));return Math.abs(n[2])<.9999999?[Math.atan2(-n[5],n[8]),e,Math.atan2(-n[1],n[0])]:[Math.atan2(n[7],n[4]),e,0]}function oy(n,e,t,i=[0,0,1]){const s=Zl(n),r=e+t,a=Math.abs(e-t)+1e-4,o=Math.max(a,Math.min(r-1e-5,s)),c=Ql(n);let l=$l(i,c);Zl(l)<1e-5&&(l=$l([1,0,0],c)),l=Ql(l);const u=(e*e+o*o-t*t)/(2*e*o),f=Math.acos(Math.max(-1,Math.min(1,u))),h=(e*e+t*t-o*o)/(2*e*t),p=Math.PI-Math.acos(Math.max(-1,Math.min(1,h))),g=ry(c,l,-f),v=[-g[0],-g[1],-g[2]],d=l,m=$l(d,v),y=[d[0],v[0],m[0],d[1],v[1],m[1],d[2],v[2],m[2]];return{thigh:ay(y),shin:[p,0,0],overreached:s>r-1e-4}}const cy=.1,ly=.09,hy=1.5,Hf=.07,uy=.15,dy=.3,fy=.5,py=.02,my=.9,gy=.09,vy=.18;function zf(n,e){return{fighterId:n,pressure:.5,mobility:.5,recovery:.5,engine:.5,guard:.5,deception:.5,reach:.5,phase:e*Math.PI}}const xy={DROP:1,STAGGER:.8,HEAVY:.45,BODY_FOLD:.4,LEG_BUCKLE:.3};function _y(n){if(zl(n))return .46;switch(n){case"CLINCH":case"CAGE_CLINCH":return .82;case"TAKEDOWN_ATTEMPT":return .8;case"STUNNED":case"RECOVERY":return 1.3;default:return 1.05}}function Sy(n,e,t){return t==="KNOCKDOWN"||t==="STUN"||e==="STAGGER"||e==="DROP"?Hf:Cf(n)?dy:uy}const Vf=new Set(["STRIKE","SIGNIFICANT_STRIKE"]);function My(n){return n.directive.targetState}function yy(n,e,t,i="CONDENSED",s){const r=s??[zf(e,0),zf(t,1)],a=[...n].sort((v,d)=>v.event.sequence-d.event.sequence),o=[];let c=0;for(const[v,d]of a.entries()){const{event:m,directive:y}=d,b=A1(y.clip,y.variant),S=y.speed>0?y.speed:1,A=b.duration/S,E=o[o.length-1],C=E!==void 0&&E.actorId!==void 0&&E.actorId===y.actorId&&Vf.has(E.event.eventType)&&Vf.has(m.eventType)&&m.timestamp-E.event.timestamp<my,_=i==="REALTIME"?Math.max(m.timestamp,c+ly):v===0?0:c+(C?py:cy),T=My(d);o.push({index:v,start:_,end:_+A,event:m,clip:b,clipName:y.clip,camera:zl(T)&&y.camera==="BROADCAST"?"GROUND_OVERHEAD":y.camera,position:T,grounded:zl(T),spacing:_y(T),impactAt:_+A*b.impactAt,reaction:_f[y.reaction]??_f.NONE,reactionName:y.reaction,actorId:y.actorId,reactorId:y.reactorId,centre:[0,0,0],facing:0,pinned:-1,cameraSide:1,blend:Math.min(Math.max(C?Hf:Sy(y.clip,y.reaction,m.eventType),E&&E.position!==T?fy:0),A*.66),claim:Cf(y.clip)?D1:Rf(b),follows:C}),c=_+A}const l=q1(o.map(v=>v.spacing/2),{pressure:[r[0].pressure,r[1].pressure],reach:[r[0].reach,r[1].reach],mobility:[r[0].mobility,r[1].mobility],phase:[r[0].phase,r[1].phase]}),u=ey(l),f=o.map((v,d)=>{const m=l[d];return{...v,centre:[m.centre[0],0,m.centre[1]],facing:m.facing,pinned:m.pinned,cameraSide:u[d]}});o.length=0,o.push(...f);const h=[[],[]];for(const v of o){const d=xy[v.reactionName];if(d===void 0||v.reactorId===void 0)continue;const m=v.reactorId===e?0:1;h[m].push({at:v.impactAt,magnitude:d})}const p={beats:o,duration:c+hy,fighterA:e,fighterB:t,pacing:i,footPlans:[{steps:[],start:[[0,0],[0,0]]},{steps:[],start:[[0,0],[0,0]]}],profiles:r,staggerHits:h},g=by(p);return{...p,footPlans:[Df(g[0],{phase:0,mobility:r[0].mobility,pressure:r[0].pressure}),Df(g[1],{phase:.5,mobility:r[1].mobility,pressure:r[1].pressure})]}}function by(n){const e=.03333333333333333,t=[],i=[];for(let s=0;s<=n.duration;s+=e){const r=Wf(n,s);if(!r)continue;const a=Math.max(r.end-r.start,.001),o=qf(n,r,(s-r.start)/a);t.push({time:s,x:o.a[0],z:o.a[2],yaw:o.yawA}),i.push({time:s,x:o.b[0],z:o.b[2],yaw:o.yawB})}return[t,i]}function Wf(n,e){const t=n.beats;if(t.length===0)return;let i=0,s=t.length-1,r;for(;i<=s;){const a=i+s>>1,o=t[a];if(!o)break;o.start<=e?(r=o,i=a+1):s=a-1}return r??t[0]}const Xf=En(Oa("STANDING","ACTOR"));function Kf(n,e,t){const i=Math.max(e.end-e.start,.001),s=(t-e.start)/i,r=e.actorId===void 0,a=En(Oa(e.position,"ACTOR")),o=w1(e.clip,s,i,Lf,ql),c=Jf(a,o,e.claim),l=En(Oa(e.position,"REACTOR")),u=Ey(e,t),f=r?c:Jf(l,u.pose,u.claim),h=Math.max(.3,Math.min(1,Math.abs(s-e.clip.impactAt)*3)),p=r?h:u.active?.35:1,g=1-e.claim.LEGS,v=r?g:1-u.claim.LEGS,d=r?!0:e.actorId===n.fighterA;return{a:d?c:f,b:d?f:c,aRest:d?h:p,bRest:d?p:h,aLegs:d?g:v,bLegs:d?v:g}}function Ey(n,e){const t=En(Oa(n.position,"REACTOR"));if(e<n.impactAt)return{pose:t,claim:Yf,active:!1};const i=e-n.impactAt,s=n.reaction.duration;if(i>=s)return{pose:t,claim:Yf,active:!1};const r=Ef(n.reaction,i/s),a=Math.min(1,i/gy),o=Math.min(1,(s-i)/vy),c=Ua(Math.min(a,o)),l=Rf(n.reaction),u={};for(const f of Tf)u[f]=l[f]*c;return{pose:Kl(t,r,c),claim:u,active:!0}}const Yf={LEGS:0,HIPS:0,SPINE:0,ARM_L:0,ARM_R:0,HEAD:0};function qf(n,e,t){const i=n.beats[e.index-1],s=i?i.centre:e.centre,r=i?i.spacing:e.spacing,a=i?i.facing:e.facing,o=Ua(Math.max(0,Math.min(1,t))),c=s[0]+(e.centre[0]-s[0])*o,l=s[2]+(e.centre[2]-s[2])*o,u=(r+(e.spacing-r)*o)/2,f=a+(e.facing-a)*o,h=jl([0,0,-u],f),p=jl([0,0,u],f);return{a:[c+h[0],0,l+h[2]],b:[c+p[0],0,l+p[2]],yawA:f,yawB:f+Math.PI,half:u}}function Jf(n,e,t){const i={};for(const r of Si){const a=t[ql[r]],o=n.joints[r],c=e.joints[r];i[r]=a>=1?c:a<=0?o:[o[0]+(c[0]-o[0])*a,o[1]+(c[1]-o[1])*a,o[2]+(c[2]-o[2])*a]}const s=Math.max(t.HIPS,t.LEGS);return{joints:i,offset:[n.offset[0]+(e.offset[0]-n.offset[0])*s,n.offset[1]+(e.offset[1]-n.offset[1])*s,n.offset[2]+(e.offset[2]-n.offset[2])*s]}}const Ay=bn.thighL.length,Ty=bn.shinL.length,wy=[["thighL","shinL","footL"],["thighR","shinR","footR"]];function Ry(n,e,t,i,s,r){if(r<=.02)return n;const a={...n.joints},o=bn.hips.offset,c=[o[0]+n.offset[0],o[1]+n.offset[1],o[2]+n.offset[2]],l=sy(n.joints.hips),u=Bf(l,[0,0,1]);for(const[f,h]of wy.entries()){const p=W1(i,f,s),g=jl([p.x-e[0],p.y-e[1],p.z-e[2]],-t),v=Bf(l,Gf(g,c)),d=bn[h[0]].offset,m=Gf(v,d),y=oy(m,Ay,Ty,u);for(const[E,C]of[h[0],h[1]].entries()){const _=a[C],T=E===0?y.thigh:y.shin;a[C]=[_[0]+(T[0]-_[0])*r,_[1]+(T[1]-_[1])*r,_[2]+(T[2]-_[2])*r]}const S=-(a[h[0]][0]+a[h[1]][0])+p.swing*.55,A=a[h[2]];a[h[2]]=[A[0]+(S-A[0])*r*.8,A[1],A[2]]}return{joints:a,offset:n.offset}}function Cy(n,e){if(e<=0)return n;const t={...n.joints},i=.42;for(const[s,r]of[["neck",.35],["head",.65]]){const a=t[s],o=Math.max(-i,Math.min(i,-a[1]))*e*r;t[s]=[a[0],a[1]+o,a[2]]}return{joints:t,offset:n.offset}}function Ly(n,e){const t=Wf(n,e);if(!t)return{time:e,a:{id:n.fighterA,pose:Xf,position:[0,0,-.81],yaw:0,legFreedom:1,rest:1,stagger:0,feint:0,fatigue:0},b:{id:n.fighterB,pose:Xf,position:[0,0,.81],yaw:Math.PI,legFreedom:1,rest:1,stagger:0,feint:0,fatigue:0},camera:"WIDE",cameraSide:1,description:"",round:1,roundTime:"05:00"};const i=Math.max(t.end-t.start,.001),s=e-t.start,r=s/i;let a=Kf(n,t,e);const o=n.beats[t.index-1];if(o&&s<t.blend){const v=Kf(n,o,o.end),d=Ua(s/t.blend);a={a:Kl(v.a,a.a,d),b:Kl(v.b,a.b,d),aRest:v.aRest+(a.aRest-v.aRest)*d,bRest:v.bRest+(a.bRest-v.bRest)*d,aLegs:v.aLegs+(a.aLegs-v.aLegs)*d,bLegs:v.bLegs+(a.bLegs-v.bLegs)*d}}const c=qf(n,t,r),l=[{pose:a.a,rest:a.aRest,legs:a.aLegs,root:c.a,yaw:c.yawA,plan:n.footPlans[0]},{pose:a.b,rest:a.bRest,legs:a.bLegs,root:c.b,yaw:c.yawB,plan:n.footPlans[1]}],u=l.map((v,d)=>{const m=n.profiles[d],y=C1(t.event.round,m.engine),b=t.grounded?0:P1(n.staggerHits[d],e)*(1-m.recovery*.45),S=t.grounded?0:L1(m.deception,m.phase,e)*v.rest;return{profile:m,fatigue:y,stagger:b,feint:S}}),f=l.map((v,d)=>{const m=u[d];let y=R1(v.pose,{time:e,phase:m.profile.phase,intensity:v.rest,fatigue:m.fatigue,grounded:t.grounded,guard:m.profile.guard,verve:m.profile.mobility,stagger:m.stagger,feint:m.feint});return y=Cy(y,t.grounded?0:.55*v.rest*(1-m.stagger*.6)),t.grounded||(y=Ry(y,v.root,v.yaw,v.plan,e,v.legs)),y}),h=t.actorId===void 0,p=h?!0:t.actorId===n.fighterA,g=t.grounded&&!h?.22:0;return{time:e,beat:t,a:{id:n.fighterA,pose:f[0],position:[c.a[0],p?g:0,c.a[2]],yaw:c.yawA,legFreedom:a.aLegs,rest:a.aRest,stagger:u[0].stagger,feint:u[0].feint,fatigue:u[0].fatigue},b:{id:n.fighterB,pose:f[1],position:[c.b[0],p?0:g,c.b[2]],yaw:c.yawB,legFreedom:a.bLegs,rest:a.bRest,stagger:u[1].stagger,feint:u[1].feint,fatigue:u[1].fatigue},camera:t.camera,cameraSide:t.cameraSide,description:t.event.description,round:t.event.round,roundTime:t.event.roundTime}}const Bn=Math.PI/2,ii=-Math.PI/2,eh=0,th=Math.PI,nh=n=>n==="L"?eh:th,Zf=n=>n==="L"?th:eh;function Py(n,e){let t=(n-e)%(Math.PI*2);return t>Math.PI&&(t-=Math.PI*2),t<=-Math.PI&&(t+=Math.PI*2),t}function Dy(n,e){if(!n)return 1;let t=1;for(const i of n){const s=Py(e,i.at);t+=i.amount*Math.exp(-(s*s)/(2*i.spread*i.spread))}return t}const Qf=[{at:Bn+.5,spread:.33,amount:.075},{at:Bn-.5,spread:.33,amount:.075},{at:Bn,spread:.09,amount:-.04}],jf=[{at:Bn+.34,spread:.24,amount:.05},{at:Bn-.34,spread:.24,amount:.05},{at:Bn,spread:.11,amount:-.045}],ih=[{at:eh,spread:.42,amount:.07},{at:th,spread:.42,amount:.07}],Ns={at:ii,spread:.13,amount:-.055},$f=[{at:ii+.58,spread:.32,amount:.06},{at:ii-.58,spread:.32,amount:.06}],Ha=[{at:ii,spread:.6,amount:.07}],ep=n=>[{at:nh(n),spread:.6,amount:.09},{at:ii,spread:.4,amount:.05}],tp=n=>[{at:Bn,spread:.48,amount:.09},{at:ii,spread:.52,amount:.08},{at:Zf(n),spread:.22,amount:-.04}],Iy=n=>[{at:nh(n),spread:.52,amount:.07},{at:ii,spread:.45,amount:.05}],sh=n=>[{at:Bn,spread:.48,amount:.08},{at:nh(n),spread:.44,amount:.05},{at:ii,spread:.48,amount:.06}],np=n=>[{at:ii,spread:.42,amount:.12},{at:Zf(n),spread:.3,amount:.05}],za=new Map(Vl.map((n,e)=>[n,e]));function Ny(n){let[e,t,i]=[0,0,0],s=n;for(;s;){const r=bn[s];e+=r.offset[0],t+=r.offset[1],i+=r.offset[2],s=r.parent}return[e,t,i]}function ky(n){switch(bn[n].axis){case"UP":return[0,1,0];case"DOWN":return[0,-1,0];default:return[0,0,1]}}function qi(n,e){const t=Ny(n),i=ky(n),s=bn[n].length*e;return[t[0]+i[0]*s,t[1]+i[1]*s,t[2]+i[2]*s]}function ip(n){const e=n.weights;if(!e)return[[n.bone,1]];const t=Object.entries(e),i=t.reduce((s,[,r])=>s+r,0);return i>0?t.map(([s,r])=>[s,r/i]):[[n.bone,1]]}function An(n,e=14,t=!0,i=!0){const s=[],r=[],a=[],o=[],c=[],l=(g,v,d,m,y,b)=>{const S=s.length/3;s.push(g,v,d),r.push(m,y);const A=b[0],E=b[1];return a.push(za.get(A?.[0]??"hips")??0,za.get(E?.[0]??"hips")??0,0,0),o.push(A?.[1]??1,E?.[1]??0,0,0),S},u=[];n.forEach((g,v)=>{const d=qi(g.bone,g.at),m=ip(g),y=bn[g.bone].axis==="FORWARD",b=v/Math.max(n.length-1,1),S=[];for(let A=0;A<e;A++){const E=A/e*Math.PI*2,C=Dy(g.lobes,E),_=Math.cos(E)*g.rx*C,T=y?Math.sin(E)*g.rz*C:0,N=y?0:Math.sin(E)*g.rz*C;S.push(l(d[0]+_,d[1]+T,d[2]+N,A/e,b,m))}u.push(S)});for(let g=0;g<u.length-1;g++){const v=u[g],d=u[g+1];for(let m=0;m<e;m++){const y=(m+1)%e;c.push(v[m],d[m],v[y]),c.push(v[y],d[m],d[y])}}const f=(g,v,d)=>{const m=qi(g.bone,g.at),y=l(m[0],m[1],m[2],.5,d?0:1,ip(g));for(let b=0;b<e;b++){const S=(b+1)%e;d?c.push(y,v[S],v[b]):c.push(y,v[b],v[S])}},h=n[0],p=n[n.length-1];return t&&h&&u[0]&&f(h,u[0],!0),i&&p&&u[u.length-1]&&f(p,u[u.length-1],!1),{positions:s,uvs:r,skinIndices:a,skinWeights:o,indices:c}}function Ji(n,e,t,i=[0,0,0],s=16,r=12,a){const o=[],c=[],l=[],u=[],f=[],h=qi(n,e),p=za.get(n)??0;for(let g=0;g<=r;g++){const v=g/r*Math.PI;for(let d=0;d<=s;d++){const m=d/s*Math.PI*2,y=Math.sin(v)*Math.cos(m),b=Math.cos(v),S=Math.sin(v)*Math.sin(m),A=a?a(y,b,S):1;o.push(h[0]+i[0]+y*t[0]*A,h[1]+i[1]+b*t[1]*A,h[2]+i[2]+S*t[2]*A),c.push(d/s,g/r),l.push(p,0,0,0),u.push(1,0,0,0)}}for(let g=0;g<r;g++)for(let v=0;v<s;v++){const d=g*(s+1)+v,m=d+s+1;f.push(d,d+1,m,d+1,m+1,m)}return{positions:o,uvs:c,skinIndices:l,skinWeights:u,indices:f}}function Va(n){const e={positions:[],uvs:[],skinIndices:[],skinWeights:[],indices:[]};for(const t of n){const i=e.positions.length/3;e.positions.push(...t.positions),e.uvs.push(...t.uvs),e.skinIndices.push(...t.skinIndices),e.skinWeights.push(...t.skinWeights);for(const s of t.indices)e.indices.push(s+i)}return e}const rh=n=>[{bone:`shoulder${n}`,at:-.35,rx:.073,rz:.071,weights:{chest:.45,[`shoulder${n}`]:.55},lobes:ep(n)},{bone:`shoulder${n}`,at:1,rx:.062,rz:.06,weights:{[`shoulder${n}`]:.5,[`arm${n}`]:.5},lobes:ep(n)},{bone:`arm${n}`,at:.3,rx:.057,rz:.055,weights:{[`arm${n}`]:1},lobes:tp(n)},{bone:`arm${n}`,at:.75,rx:.046,rz:.045,lobes:tp(n).map(e=>({...e,amount:e.amount*.4}))},{bone:`arm${n}`,at:1,rx:.043,rz:.043,weights:{[`arm${n}`]:.5,[`forearm${n}`]:.5}},{bone:`forearm${n}`,at:.22,rx:.05,rz:.048,weights:{[`forearm${n}`]:1},lobes:Iy(n)},{bone:`forearm${n}`,at:.75,rx:.037,rz:.035},{bone:`forearm${n}`,at:1,rx:.034,rz:.033,weights:{[`forearm${n}`]:.5,[`hand${n}`]:.5}}],ah=n=>[{bone:`thigh${n}`,at:0,rx:.1,rz:.098,weights:{[`thigh${n}`]:.6,hips:.4},lobes:sh(n)},{bone:`thigh${n}`,at:.3,rx:.09,rz:.089,weights:{[`thigh${n}`]:1},lobes:sh(n)},{bone:`thigh${n}`,at:.85,rx:.063,rz:.062,lobes:sh(n).map(e=>({...e,amount:e.amount*.3}))},{bone:`thigh${n}`,at:1,rx:.058,rz:.058,weights:{[`thigh${n}`]:.5,[`shin${n}`]:.5}},{bone:`shin${n}`,at:.22,rx:.07,rz:.072,weights:{[`shin${n}`]:1},lobes:np(n)},{bone:`shin${n}`,at:.7,rx:.043,rz:.044,lobes:np(n).map(e=>({...e,amount:e.amount*.3}))},{bone:`shin${n}`,at:1,rx:.038,rz:.04,weights:{[`shin${n}`]:.5,[`foot${n}`]:.5}}],sp=[{bone:"hips",at:-.62,rx:.104,rz:.084,weights:{hips:1},lobes:Ha},{bone:"hips",at:-.2,rx:.128,rz:.098,weights:{hips:1},lobes:Ha},{bone:"hips",at:.2,rx:.137,rz:.103,weights:{hips:1},lobes:Ha},{bone:"hips",at:.55,rx:.143,rz:.106,lobes:[...Ha,Ns]},{bone:"hips",at:1,rx:.132,rz:.096,weights:{hips:.55,spine:.45},lobes:[...jf,Ns]},{bone:"spine",at:.35,rx:.113,rz:.083,weights:{spine:1},lobes:[...jf,Ns]},{bone:"spine",at:.75,rx:.138,rz:.096,lobes:[...ih,Ns,{at:Bn,spread:.5,amount:.03}]},{bone:"spine",at:1,rx:.152,rz:.104,weights:{spine:.5,chest:.5},lobes:[...Qf,...ih,Ns]},{bone:"chest",at:.5,rx:.163,rz:.11,weights:{chest:1},lobes:[...Qf,...ih,Ns]},{bone:"chest",at:.88,rx:.15,rz:.101,lobes:[...$f,{at:Bn,spread:.6,amount:.03}]},{bone:"chest",at:1.05,rx:.132,rz:.098,weights:{chest:.75,neck:.25},lobes:$f}],rp=[{bone:"neck",at:-.55,rx:.075,rz:.072,weights:{chest:.55,neck:.45}},{bone:"neck",at:.1,rx:.068,rz:.065,weights:{neck:1}},{bone:"neck",at:.75,rx:.062,rz:.06,weights:{neck:1}}],Oy=[{bone:"hips",at:-.42,rx:.152,rz:.124,weights:{hips:1}},{bone:"hips",at:-.12,rx:.156,rz:.127,weights:{hips:1}},{bone:"hips",at:.3,rx:.153,rz:.124,weights:{hips:1}},{bone:"hips",at:.72,rx:.145,rz:.116,weights:{hips:.9,spine:.1}},{bone:"hips",at:1.08,rx:.134,rz:.106,weights:{hips:.55,spine:.45}},{bone:"hips",at:1.34,rx:.126,rz:.099,weights:{hips:.25,spine:.75}}];function ap(n,e){const t=.3+Math.max(0,Math.min(1,e))*.48,i=`thigh${n}`;return[{bone:i,at:-.3,rx:.116,rz:.108,weights:{hips:.86,[i]:.14}},{bone:i,at:-.12,rx:.124,rz:.116,weights:{hips:.5,[i]:.5}},{bone:i,at:.06,rx:.126,rz:.12,weights:{hips:.15,[i]:.85}},{bone:i,at:t*.55,rx:.122,rz:.117,weights:{[i]:1}},{bone:i,at:t,rx:.113,rz:.109},{bone:i,at:t+.035,rx:.101,rz:.097}]}const oh=n=>[{bone:`foot${n}`,at:-.15,rx:.042,rz:.05,weights:{[`foot${n}`]:1}},{bone:`foot${n}`,at:.5,rx:.048,rz:.045},{bone:`foot${n}`,at:.92,rx:.04,rz:.032}],Zi=0,ks=[.093,.115,.104],Mi=[0,.105,.004];function St(n,e,t){const i=(n-e)/t;return Math.exp(-i*i)}function op(n,e,t){const i=Math.max(0,t),s=i*i,r=Math.abs(n),a=.045*Math.max(0,-t)*St(e,-.05,.45),o=-.03*Math.max(0,e-.7),c=-.035*i*St(r,.78,.2)*St(e,.32,.2),l=.062*i*St(e,.2,.15)*St(n,0,.55),u=-.038*i*St(r,.33,.19)*St(e,.04,.15),f=.105*s*St(n,0,.13)*St(e,0,.24),h=.165*s*i*St(n,0,.16)*St(e,-.17,.1),p=.055*s*i*St(r,.14,.06)*St(e,-.23,.06),g=-.022*s*St(n,0,.055)*St(e,-.31,.055),v=.05*s*St(n,0,.28)*St(e,-.41,.085),d=-.04*s*St(n,0,.32)*St(e,-.41,.028),m=.04*i*St(r,.5,.2)*St(e,-.1,.18),y=.052*i*St(n,0,.24)*St(e,-.7,.15),b=-.085*i*Math.max(0,-e-.35)*(.5+r);return 1+a+o+c+l+u+f+h+p+g+v+d+m+y+b}function Uy(n,e,t){return 1-.18*Math.max(0,e-.45)}const Fy=1.085;function cp(n,e,t=24,i=12){const s=[],r=[],a=[],o=[],c=[],l=qi("head",Zi),u=za.get("head")??0,f=(h,p,g,v,d,m)=>{const y=s.length/3,b=op(h,p,g)*v;return s.push(l[0]+Mi[0]+h*ks[0]*b,l[1]+Mi[1]+p*ks[1]*b,l[2]+Mi[2]+g*ks[2]*b),r.push(d,m),a.push(u,0,0,0),o.push(1,0,0,0),y};for(let h=0;h<=i;h++){const p=h/i;for(let g=0;g<=t;g++){const v=g/t*Math.PI*2,d=Math.cos(v),m=Math.sin(v),y=n*(1-e*Math.max(0,m)),b=p*y,S=Math.sin(b)*d,A=Math.cos(b),E=Math.sin(b)*m;f(S,A,E,h===i?.965:Fy,g/t,p)}}for(let h=0;h<i;h++)for(let p=0;p<t;p++){const g=h*(t+1)+p,v=g+t+1;c.push(g,g+1,v,g+1,v+1,v)}return{positions:s,uvs:r,skinIndices:a,skinWeights:o,indices:c}}const ch=[{sweep:1.08,tilt:.3},{sweep:1.28,tilt:.22}];function By(n=0){const e=ch[n%ch.length]??ch[0];return cp(e.sweep,e.tilt)}function Gy(){const n=cp(.62,-.85,20,8),e={...n,positions:[...n.positions]},t=qi("head",Zi)[1]+Mi[1];for(let i=0;i<e.positions.length/3;i++)e.positions[i*3+1]=t-(e.positions[i*3+1]-t);return e}function Hy(){return Va([Ji("head",Zi,lp,[yr[0],yr[1],yr[2]],12,9),Ji("head",Zi,lp,[-.031,yr[1],yr[2]],12,9)])}const lp=[.0112,.01,.0105],yr=[.031,.1085,.087];function hp(n){return Ji("head",Zi,[.009,.021,.014],[(n==="L"?1:-1)*.081,.098,-.016],10,8,Uy)}function zy(){const n=[],e=i=>{for(const s of i)n.push({at:qi(s.bone,s.at),radius:(s.rx+s.rz)/2})};e(sp),e(rp);for(const i of["L","R"])e(rh(i)),e(ah(i)),e(oh(i));const t=qi("head",Zi);return n.push({at:[t[0]+Mi[0],t[1]+Mi[1],t[2]+Mi[2]],radius:(ks[0]+ks[2])/2}),n}const Vy=.5,up=.62;function Wy(n,e,t){let i=0;for(const s of t){const r=s.at[0]-n[0],a=s.at[1]-n[1],o=s.at[2]-n[2],c=Math.hypot(r,a,o);if(c<1e-6)continue;const l=(e[0]*r+e[1]*a+e[2]*o)/c;if(l<=0)continue;const u=Math.max(c,s.radius*1.05);i+=l*s.radius*s.radius/(u*u)}return up+(1-up)*Math.exp(-i*Vy)}function Xy(n){const e=n[1],t=Math.hypot(n[0],n[2])*2.2+Math.max(0,1.35-e)*.25,i=Math.min(.16,t*.16),s=Math.min(.06,Math.max(0,e-1)*.05);return[1+i*.55+s,1-i*.16+s,1-i*.42+s]}function dp(n){return Ji(`shoulder${n}`,.2,[.086,.09,.084],[n==="L"?-.026:.026,.006,0],18,14)}function Ky(){return Va([An(sp,22),An(rp,16),dp("L"),dp("R"),Ji("head",Zi,ks,Mi,48,40,op),hp("L"),hp("R"),An(rh("L"),18),An(rh("R"),18),An(ah("L"),20),An(ah("R"),20),An(oh("L"),14),An(oh("R"),14)])}function Yy(n=.5){return Va([An(Oy,18),An(ap("L",n),16),An(ap("R",n),16)])}function qy(){return Va([Ji("handL",.45,[.055,.067,.059],[0,0,.006],14,10),Ji("handR",.45,[.055,.067,.059],[0,0,.006],14,10)])}function Jy(n=256,e=.5){const t=document.createElement("canvas");t.width=n,t.height=n;const i=t.getContext("2d");if(!i)return new Nt;const s=i.createImageData(n,n),r=(c,l)=>{const u=Math.sin(c*127.1+l*311.7)*43758.5453;return u-Math.floor(u)},a=(c,l,u)=>{const f=c/u,h=l/u,p=Math.floor(f),g=Math.floor(h),v=f-p,d=h-g,m=v*v*(3-2*v),y=d*d*(3-2*d),b=r(p,g),S=r(p+1,g),A=r(p,g+1),E=r(p+1,g+1);return(b+(S-b)*m)*(1-y)+(A+(E-A)*m)*y};for(let c=0;c<n;c++)for(let l=0;l<n;l++){const u=a(l,c,26)*.55+a(l,c,9)*.3+a(l,c,3)*.15,f=Math.round(255*(.5+(u-.5)*e)),h=(c*n+l)*4;s.data[h]=f,s.data[h+1]=f,s.data[h+2]=f,s.data[h+3]=255}i.putImageData(s,0,0);const o=new Ng(t);return o.wrapS=Ys,o.wrapT=Ys,o.repeat.set(3,3),o}let fp;function pp(){return fp??(fp=Jy(256,.75)),fp}const Zy={skin:11565650,trunks:12071485,gloves:12857914,hair:2826265,hairStyle:0,trunkLength:.22,beard:!0,subsurface:11026986},Qy={skin:8211760,trunks:2777028,gloves:3104464,hair:1643280,hairStyle:1,trunkLength:.85,beard:!1,subsurface:9187872},Wa="#include <opaque_fragment>",jy=`
  {
  ...
  ${Wa}`,$y=new k(2.6,10.5,3.4).normalize();function eb(n,e){const t=new xd({color:n.skin,roughness:.74,metalness:0,vertexColors:!0,clearcoat:.1,clearcoatRoughness:.62,clearcoatRoughnessMap:e,sheen:.22,sheenColor:new Ve(16767426),sheenRoughness:.8,roughnessMap:e,bumpMap:e,bumpScale:.0032});return t.onBeforeCompile=i=>{if(i.uniforms.uSubsurface={value:new Ve(n.subsurface)},i.uniforms.uSubsurfaceStrength={value:.62},i.uniforms.uKeyDirection={value:$y},i.fragmentShader=i.fragmentShader.replace("#include <common>",`#include <common>
      uniform vec3 uSubsurface;
      uniform float uSubsurfaceStrength;
      uniform vec3 uKeyDirection;`),!i.fragmentShader.includes(Wa))throw new Error(`skin shader: three.js no longer emits ${Wa}`);i.fragmentShader=i.fragmentShader.replace(Wa,jy)},t}function tb(n){const e=new Ht;return e.setAttribute("position",new lt(n.positions,3)),e.setAttribute("uv",new lt(n.uvs,2)),e.setAttribute("skinIndex",new qc(n.skinIndices,4)),e.setAttribute("skinWeight",new lt(n.skinWeights,4)),e.setIndex(n.indices),e.computeVertexNormals(),e}function nb(n,e){const t=n.getAttribute("position"),i=n.getAttribute("normal"),s=zy(),r=new Float32Array(t.count*3);for(let a=0;a<t.count;a++){const o=[t.getX(a),t.getY(a),t.getZ(a)],c=[i.getX(a),i.getY(a),i.getZ(a)],l=Wy(o,c,s),[u,f,h]=e?Xy(o):[1,1,1];r[a*3]=l*u,r[a*3+1]=l*f,r[a*3+2]=l*h}n.setAttribute("color",new mn(r,3))}class mp{constructor(e){Je(this,"root");Je(this,"bones",new Map);Je(this,"materials",[]);Je(this,"geometries",[]);Je(this,"meshes",[]);this.root=new fs;for(const f of Vl){const h=bn[f],p=new Gu;p.position.set(h.offset[0],h.offset[1],h.offset[2]);const g=h.parent===null?this.root:this.bones.get(h.parent);if(!g)throw new Error(`joint ${f} has an unbuilt parent`);g.add(p),this.bones.set(f,p)}this.root.updateMatrixWorld(!0);const t=Vl.map(f=>this.bones.get(f)),i=new rl(t),s=pp(),r=eb(e,s),a=new ei({vertexColors:!0,color:e.trunks,roughness:.9,metalness:0,roughnessMap:s}),o=new xd({vertexColors:!0,color:e.gloves,roughness:.42,metalness:0,clearcoat:.55,clearcoatRoughness:.35,roughnessMap:s}),c=new ei({vertexColors:!0,color:e.hair,roughness:.82,metalness:0,roughnessMap:s}),l=new ei({color:1314572,roughness:.28,metalness:0});this.materials.push(r,a,o,c,l);const u=[[Ky(),r,!0],[Yy(e.trunkLength),a,!0],[qy(),o,!0],[By(e.hairStyle),c,!1],[Hy(),l,!1]];e.beard&&u.push([Gy(),c,!1]);for(const[f,h,p]of u){const g=tb(f);h!==l&&nb(g,h===r),this.geometries.push(g);const v=new Tg(g,h);v.castShadow=p,v.receiveShadow=!0,v.frustumCulled=!1,this.root.add(v),v.bind(i),this.meshes.push(v)}}applyPose(e){for(const[i,s]of this.bones){const r=e.joints[i];s.rotation.set(r[0],r[1],r[2])}const t=this.bones.get("hips");if(t){const i=bn.hips.offset;t.position.set(i[0]+e.offset[0],i[1]+e.offset[1],i[2]+e.offset[2])}}setPlacement(e,t){this.root.position.set(e[0],e[1],e[2]),this.root.rotation.y=t}headPosition(e){const t=this.bones.get("head");return t?t.getWorldPosition(e):e.set(0,1.6,0)}dispose(){for(const e of this.geometries)e.dispose();for(const e of this.materials)e.dispose();for(const e of this.meshes)e.skeleton.dispose();this.geometries.length=0,this.materials.length=0,this.meshes.length=0,this.bones.clear()}}const lh=4.55,Os=1.83;function ib(n){const e=[];for(let t=0;t<8;t++){const i=t/8*Math.PI*2+Math.PI/8;e.push(new le(Math.cos(i)*n,Math.sin(i)*n))}return e}function sb(){const n=new fs,e=[],t=C=>(e.push(C),C),i=ib(lh),s=new od;i.forEach((C,_)=>{_===0?s.moveTo(C.x,C.y):s.lineTo(C.x,C.y)}),s.closePath();const r=t(new xl(s)),a=pp(),o=t(new ei({color:7239039,roughness:.94,metalness:0,roughnessMap:a,bumpMap:a,bumpScale:.004})),c=new vt(r,o);c.rotation.x=-Math.PI/2,c.receiveShadow=!0,n.add(c);const l=t(new da(lh+1.1,lh+1.4,.9,8,1)),u=t(new ei({color:1053465,roughness:1,roughnessMap:a})),f=new vt(l,u);f.position.y=-.46,f.rotation.y=Math.PI/8,f.receiveShadow=!0,n.add(f);const h=t(new vl(1.05,1.2,48)),p=t(new Qr({color:9344934,transparent:!0,opacity:.35,side:Cn})),g=new vt(h,p);g.rotation.x=-Math.PI/2,g.position.y=.005,n.add(g);const v=t(new da(.075,.075,Os+.16,10)),d=t(new ei({color:2303791,roughness:.45,metalness:.55,roughnessMap:a}));for(const C of i){const _=new vt(v,d);_.position.set(C.x,(Os+.16)/2,C.y),_.castShadow=!0,n.add(_)}const m=[],y=[];for(let C=0;C<i.length;C++){const _=i[C],T=i[(C+1)%i.length];if(!_||!T)continue;const N=14;for(let I=0;I<=N;I++){const F=I/N,J=_.x+(T.x-_.x)*F,q=_.y+(T.y-_.y)*F;if(m.push(J,.06,q,J,Os,q),I<N){const H=(I+1)/N,Z=_.x+(T.x-_.x)*H,K=_.y+(T.y-_.y)*H;for(let te=0;te<5;te++){const re=.06+(Os-.06)*(te/5),ue=.06+(Os-.06)*((te+1)/5);m.push(J,re,q,Z,ue,K),m.push(J,ue,q,Z,re,K)}}}for(const I of[.06,Os])y.push(_.x,I,_.y,T.x,I,T.y)}const b=t(new Ht);b.setAttribute("position",new lt(m,3));const S=t(new cl({color:7173766,transparent:!0,opacity:.32}));n.add(new Ju(b,S));const A=t(new Ht);A.setAttribute("position",new lt(y,3));const E=t(new cl({color:14212582,transparent:!0,opacity:.55}));return n.add(new Ju(A,E)),{group:n,dispose(){for(const C of e)C.dispose();e.length=0}}}function rb(n){const e=new Sv(7175321,461069,.12);n.add(e);const t=new Av(16773856,1.5);t.position.set(2.6,10.5,3.4),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.near=2,t.shadow.camera.far=22,t.shadow.camera.left=-5.5,t.shadow.camera.right=5.5,t.shadow.camera.top=5.5,t.shadow.camera.bottom=-5.5,t.shadow.bias=-9e-4,t.shadow.normalBias=.02,t.shadow.radius=2,n.add(t);const i=[];for(const[r,a]of[[-3.2,-3.2],[3.2,-3.2],[-3.2,3.2],[3.2,3.2]]){const o=new Ed(16774374,11,16,Math.PI/4.6,.55,1.6);o.position.set(r,7.4,a),o.target.position.set(r*.25,1,a*.25),n.add(o,o.target),i.push(o)}const s=new Ed(10337535,14,20,Math.PI/5,.7,1.5);return s.position.set(-6.5,4.6,-5.2),s.target.position.set(0,1.1,0),n.add(s,s.target),()=>{n.remove(e,t,s,s.target);for(const r of i)n.remove(r,r.target);t.dispose(),s.dispose();for(const r of i)r.dispose()}}class ab{constructor(e,t={}){Je(this,"renderer");Je(this,"scene",new Lu);Je(this,"camera",new tn(40,16/9,.1,120));Je(this,"arena");Je(this,"disposeLighting");Je(this,"fighterA",new mp(Zy));Je(this,"fighterB",new mp(Qy));Je(this,"cameraTarget",new k(0,1.2,0));Je(this,"desiredPosition",new k);Je(this,"desiredTarget",new k);Je(this,"observer");Je(this,"composer");Je(this,"bloom");Je(this,"environment");Je(this,"timeline");Je(this,"raf",0);Je(this,"lastTick",0);Je(this,"costs",[]);Je(this,"downgraded",!1);Je(this,"lastWidth",0);Je(this,"lastHeight",0);Je(this,"time",0);Je(this,"rate",1);Je(this,"running",!1);Je(this,"disposed",!1);this.container=e,this.options=t,this.renderer=new XM({antialias:!0,alpha:!1}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=eu,this.renderer.setClearColor(329483,1),this.renderer.toneMapping=Rr,this.renderer.toneMappingExposure=.72,this.renderer.outputColorSpace=an,e.appendChild(this.renderer.domElement),this.renderer.domElement.style.display="block",this.renderer.domElement.style.width="100%",this.renderer.domElement.style.height="100%",this.scene.fog=new Bc(329483,10,26);const i=new Al(this.renderer);this.environment=i.fromScene(new KM,.04).texture,this.scene.environment=this.environment,this.scene.environmentIntensity=.16,i.dispose(),this.arena=sb(),this.scene.add(this.arena.group),this.disposeLighting=rb(this.scene),this.scene.add(this.fighterA.root,this.fighterB.root),this.composer=new jM(this.renderer),this.composer.addPass(new $M(this.scene,this.camera)),this.bloom=new Ls(new le(1,1),.22,.7,.92),this.composer.addPass(this.bloom),this.composer.addPass(new n1),this.composer.addPass(new t1),this.camera.position.set(2.9,2.5,4.6),this.camera.lookAt(this.cameraTarget),this.observer=new ResizeObserver(()=>this.resize()),this.observer.observe(e),this.resize()}resize(){const e=Math.max(this.container.clientWidth,1),t=Math.max(this.container.clientHeight,1);this.lastWidth=e,this.lastHeight=t,this.renderer.setSize(e,t,!1),this.composer?.setSize(e,t),this.bloom?.setSize(e,t),this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}load(e){this.timeline=e,this.time=0,this.renderAt(0,!0)}get duration(){return this.timeline?.duration??0}get currentTime(){return this.time}get isPlaying(){return this.running}setRate(e){this.rate=e}seek(e){this.time=Math.max(0,Math.min(e,this.duration)),this.renderAt(this.time,!0)}play(){if(this.running||this.disposed)return;this.time>=this.duration&&(this.time=0),this.running=!0,this.lastTick=performance.now();const e=t=>{if(!this.running)return;const i=Math.min((t-this.lastTick)/1e3,.1);this.measure(i),this.lastTick=t,this.time+=i*this.rate,this.time>=this.duration&&(this.time=this.duration,this.running=!1),this.renderAt(this.time,!1,i),this.running&&(this.raf=requestAnimationFrame(e))};this.raf=requestAnimationFrame(e)}measure(e){if(this.downgraded||this.costs.length>60||(this.costs.push(e),this.costs.length<45))return;const t=[...this.costs].sort((s,r)=>s-r);(t[Math.floor(t.length/2)]??0)>.033?(this.downgraded=!0,this.renderer.setPixelRatio(1),this.renderer.shadowMap.enabled=!1,this.scene.environmentIntensity=.22,this.resize(),this.options.onQuality?.("reduced")):(this.downgraded=!0,this.options.onQuality?.("full"))}pause(){this.running=!1,this.raf&&cancelAnimationFrame(this.raf),this.raf=0}renderAt(e,t=!1,i=0){if(this.disposed||!this.timeline)return;(this.renderer.domElement.clientWidth!==this.lastWidth||this.renderer.domElement.clientHeight!==this.lastHeight)&&this.resize();const s=Ly(this.timeline,e);this.fighterA.applyPose(s.a.pose),this.fighterA.setPlacement(s.a.position,s.a.yaw),this.fighterB.applyPose(s.b.pose),this.fighterB.setPlacement(s.b.position,s.b.yaw);const r=(s.a.position[0]+s.b.position[0])/2,a=(s.a.position[2]+s.b.position[2])/2,o=Math.atan2(s.b.position[0]-s.a.position[0],s.b.position[2]-s.a.position[2]),c=iy(s.camera,r,a,e,o,s.cameraSide);if(this.desiredPosition.set(c.position[0],c.position[1],c.position[2]),this.desiredTarget.set(c.target[0],c.target[1],c.target[2]),t)this.camera.position.copy(this.desiredPosition),this.cameraTarget.copy(this.desiredTarget),this.camera.fov=c.fov;else{const l=1-Math.exp(-6*i);this.camera.position.lerp(this.desiredPosition,l),this.cameraTarget.lerp(this.desiredTarget,l),this.camera.fov+=(c.fov-this.camera.fov)*l}this.camera.updateProjectionMatrix(),this.camera.lookAt(this.cameraTarget),this.downgraded&&!this.renderer.shadowMap.enabled?this.renderer.render(this.scene,this.camera):this.composer.render(),this.options.onFrame?.(s)}dispose(){this.pause(),this.disposed=!0,this.observer.disconnect(),this.disposeLighting(),this.arena.dispose(),this.fighterA.dispose(),this.fighterB.dispose(),this.environment.dispose(),this.composer.dispose(),this.renderer.dispose(),this.renderer.domElement.remove()}}function ob(n,e={}){try{return new ab(n,e)}catch(t){e.onError?.(t instanceof Error?t.message:String(t));return}}let Qi,Us=[],Fs=new Map,mt=[void 0,void 0],xt,yi,$t;const Fe=n=>{const e=document.getElementById(n);if(!e)throw new Error(`missing #${n}`);return e},yt=n=>n.replace(/[&<>"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[e]??e),hh=n=>{const e=Math.max(0,Math.floor(n));return`${String(Math.floor(e/60)).padStart(2,"0")}:${String(e%60).padStart(2,"0")}`},Xa=n=>n.replace(/_/g," ").toLowerCase().replace(/(^|\s)\w/g,e=>e.toUpperCase());function Ka(n){const e=new Date(n.birthDate),t=new Date(Qi.state.currentDate);let i=t.getFullYear()-e.getFullYear();const s=t.getMonth()-e.getMonth();return(s<0||s===0&&t.getDate()<e.getDate())&&i--,i}function gp(n){const e=performance.now();Qi=k0({seed:n}),Us=Qi.state.fighters.filter(c=>c.status==="active"),Fs=new Map;for(const c of fo(Qi.state.promotions,Qi.state.fighters,Qi.state.currentDate))Fs.set(c.fighterId,c.rank);const t=Math.round(performance.now()-e);Fe("built").textContent=`${Us.length} active fighters across ${Qi.state.camps.length} camps, built in ${t}ms`;const i=Fe("division"),s=new Set(Us.map(c=>c.divisionKey));i.innerHTML='<option value="">All divisions</option>'+["male","female"].flatMap(c=>Gp(c).filter(l=>s.has(l.key))).map(c=>`<option value="${c.key}">${yt(c.name)}</option>`).join("");const r=[...Us].sort((c,l)=>dn(l)-dn(c)),a=r[0],o=r.find(c=>c!==a&&c.divisionKey===a?.divisionKey);mt=[a,o??r[1]],xt=void 0,yi=void 0,Bs(),Ya(),Fe("result").hidden=!0,Fe("replay").hidden=!0,mt[0]&&mt[1]&&xp()}function vp(){const n=Fe("division").value,e=Fe("search").value.trim().toLowerCase(),t=Fe("sort").value;let i=Us;n&&(i=i.filter(r=>r.divisionKey===n)),e&&(i=i.filter(r=>{const a=co(r).primary.label.toLowerCase();return un(r).toLowerCase().includes(e)||a.includes(e)}));const s={ability:(r,a)=>dn(a)-dn(r),rank:(r,a)=>(Fs.get(r.id)??999)-(Fs.get(a.id)??999),name:(r,a)=>un(r).localeCompare(un(a)),age:(r,a)=>Ka(r)-Ka(a),wins:(r,a)=>a.record.wins-r.record.wins};return[...i].sort(s[t]??s.ability).slice(0,300)}function Bs(){const n=vp();Fe("count").textContent=`${n.length} shown`,Fe("roster").innerHTML=n.map(e=>{const t=co(e),i=Fs.get(e.id),s=mt[0]?.id===e.id?"a":mt[1]?.id===e.id?"b":"";return`<tr data-id="${e.id}" class="${s}"><td class="rank">${i===0?"<b>C</b>":i&&i<=15?`#${i}`:""}</td><td class="who"><span class="nm">${yt(un(e))}</span><span class="sub">${yt(t.primary.label)}</span></td><td class="div">${yt(e.divisionKey.replace(/^[mw]_/,"").replace(/_/g," "))}</td><td class="num">${yt(Eh(e))}</td><td class="num">${Ka(e)}</td><td class="num ca">${Math.round(dn(e))}</td><td class="pick"><button data-corner="0">A</button><button data-corner="1">B</button></td></tr>`}).join("")}function Ya(){for(const e of[0,1]){const t=mt[e],i=Fe(`corner-${e}`);if(!t){i.innerHTML='<p class="empty">Pick a fighter from the roster</p>';continue}const s=co(t),r=Fs.get(t.id),a=(o,c)=>`<div class="tp"><span>${o}</span><b>${yt(c)}</b></div>`;i.innerHTML=`<h3>${yt(un(t))}</h3><p class="sub">${r===0?"Champion · ":r?`#${r} · `:""}${yt(t.divisionKey.replace(/^[mw]_/,"").replace(/_/g," "))}</p>`+a("Record",Eh(t))+a("Style",s.primary.label)+a("Signature",s.signatureSkill.label)+a("Age",String(Ka(t)))+a("Height",`${Math.floor(t.heightIn/12)}'${t.heightIn%12}"`)+a("Reach",`${t.reachIn}"`)+a("Stance",Xa(t.stance))+a("Ability",String(Math.round(dn(t))))}const n=!!(mt[0]&&mt[1]&&mt[0].id!==mt[1].id);Fe("run").disabled=!n,Fe("mismatch").hidden=!(mt[0]&&mt[1]&&mt[0].divisionKey!==mt[1].divisionKey)}function xp(){const[n,e]=mt;if(!n||!e)return;const t=Number(Fe("rounds").value),i=Fe("fight-seed").value.trim()||`lab-${n.id}-${e.id}`;xt=pm(n,e,{fightId:i,rounds:t},Tn.fromSeed(i));const s=xt.events.map(r=>({event:r,directive:Qh(r)}));yi=yy(s,n.id,e.id,void 0,[jh(n,i),jh(e,i)]),cb(n,e),hb(),ub()}function cb(n,e){if(!xt)return;const t=xt.winnerId===n.id?n:xt.winnerId===e.id?e:void 0,i=xt.technique?` (${Xa(xt.technique)})`:"",s=xt.finishRound?`R${xt.finishRound} ${xt.finishTime}`:"decision";Fe("verdict").innerHTML=t?`<strong>${yt(un(t))}</strong> def. ${yt(un(t.id===n.id?e:n))} — ${yt(Xa(xt.outcome))}${yt(i)}, ${yt(s)}`:`<strong>${yt(Xa(xt.outcome))}</strong> after ${xt.rounds} rounds`;const r=xt.scorecards.map(l=>`<li>${yt(l.judgeName)}: ${l.totalA} &ndash; ${l.totalB}</li>`).join("");Fe("cards").innerHTML=xt.scorecards.length?`<ul>${r}</ul>`:"";const a=xt.stats[n.id],o=xt.stats[e.id],c=(l,u)=>a&&o?`<div class="tape-row"><span>${u(a)}</span><em>${l}</em><span>${u(o)}</span></div>`:"";Fe("stats").innerHTML=`<div class="tape-row head"><span>${yt(un(n))}</span><em></em><span>${yt(un(e))}</span></div>`+c("Significant strikes",l=>`${l.significantStrikesLanded}/${l.significantStrikesAttempted}`)+c("Head / body / leg",l=>`${l.headStrikes} / ${l.bodyStrikes} / ${l.legStrikes}`)+c("Takedowns",l=>`${l.takedownsLanded}/${l.takedownsAttempted}`)+c("Submission attempts",l=>String(l.submissionAttempts))+c("Knockdowns",l=>String(l.knockdowns))+c("Control time",l=>hh(l.controlTime)),lb(n,e),Fe("result").hidden=!1}function lb(n,e){if(!xt)return;const t=xt.roundStats,i=t[n.id]??[],s=t[e.id]??[],r=Math.max(i.length,s.length);if(r===0){Fe("breakdown").innerHTML="";return}const a=c=>c?`<b>${c.significantStrikesLanded}</b><span>${c.headStrikes}/${c.bodyStrikes}/${c.legStrikes}</span>`:"<b>—</b><span></span>";let o='<div class="rounds"><div class="rhead"><span></span>';for(let c=0;c<r;c++)o+=`<span>R${c+1}</span>`;o+="</div>";for(const[c,l,u]of[[n,i,"red"],[e,s,"blue"]]){o+=`<div class="rrow ${u}"><span class="rname">${yt(un(c))}</span>`;for(let f=0;f<r;f++){const h=l[f]?.significantStrikesLanded??0,p=(c===n?s:i)[f]?.significantStrikesLanded??0;o+=`<span class="rcell${h>p?" won":""}">${a(l[f])}</span>`}o+="</div>"}o+='</div><p class="rlegend">Significant strikes landed, with head / body / leg beneath. Shaded cell led the round on volume.</p>',Fe("breakdown").innerHTML=o}function hb(){xt&&(Fe("stream").innerHTML=xt.events.map((n,e)=>{const t=Qh(n);return`<li data-beat="${e}"><span class="c1">R${n.round} ${n.roundTime}</span><span class="c2">${yt(t.clip)}</span><span class="c3">${yt(t.reaction.toLowerCase())}</span><span class="c4">${yt(n.description)}</span></li>`}).join(""))}function ub(){if(!yi)return;Fe("replay").hidden=!1;const[n,e]=mt;Fe("hud-a").textContent=n?un(n):"",Fe("hud-b").textContent=e?un(e):"",$t||($t=ob(Fe("stage"),{onFrame:db,onError:t=>{Fe("stage").innerHTML=`<p class="empty">${yt(t)}</p>`}})),$t&&($t.load(yi),Fe("scrub").max=String(yi.duration),$t.seek(0),$t.play(),Fe("play").textContent="Pause")}function db(n){Fe("scrub").value=String(n.time),fb(n.time),Fe("time").textContent=`${hh(n.time)} / ${hh(yi?.duration??0)}`,Fe("hud-clock").textContent=`R${n.round} · ${n.roundTime}`,Fe("hud-line").textContent=n.description,Fe("hud-cam").textContent=n.camera.toLowerCase().replace(/_/g," ")}function fb(n){if(!xt||!mt[0]||!mt[1])return;let e=0,t=0;for(const i of xt.events){if(i.timestamp>n)break;i.eventType!=="SIGNIFICANT_STRIKE"||!("result"in i&&(i.result==="LANDED"||i.result==="PARTIAL"))||!("attacker"in i)||(i.attacker===mt[0].id?e++:t++)}Fe("count-a").textContent=String(e),Fe("count-b").textContent=String(t)}function pb(){Fe("generate").addEventListener("click",()=>gp(Fe("seed").value.trim()||"sandbox"));for(const n of["division","sort"])Fe(n).addEventListener("change",Bs);Fe("search").addEventListener("input",Bs),Fe("roster").addEventListener("click",n=>{const e=n.target.closest("button[data-corner]"),t=n.target.closest("tr[data-id]");if(!t)return;const i=Us.find(r=>r.id===t.dataset.id);if(!i)return;const s=e?Number(e.dataset.corner):mt[0]?1:0;mt[s]=i,Bs(),Ya()}),Fe("swap").addEventListener("click",()=>{mt=[mt[1],mt[0]],Bs(),Ya()}),Fe("random").addEventListener("click",()=>{const n=vp();if(n.length<2)return;const e=Math.floor(Math.random()*n.length);let t=Math.floor(Math.random()*n.length);t===e&&(t=(t+1)%n.length),mt=[n[e],n[t]],Bs(),Ya()}),Fe("run").addEventListener("click",xp),Fe("play").addEventListener("click",()=>{$t&&($t.isPlaying?($t.pause(),Fe("play").textContent="Play"):($t.play(),Fe("play").textContent="Pause"))}),Fe("scrub").addEventListener("input",n=>{$t?.pause(),Fe("play").textContent="Play",$t?.seek(Number(n.target.value))}),Fe("rate").addEventListener("change",n=>{$t?.setRate(Number(n.target.value))}),Fe("stream").addEventListener("click",n=>{const e=n.target.closest("li[data-beat]");if(!e||!yi)return;const t=yi.beats[Number(e.dataset.beat)];t&&($t?.pause(),Fe("play").textContent="Play",$t?.seek(t.start))})}pb(),gp("sandbox")})();
