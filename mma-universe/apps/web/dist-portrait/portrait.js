...
#endif`;const Oe={alphahash_fragment:sc,alphahash_pars_fragment:ac,alphamap_fragment:oc,alphamap_pars_fragment:lc,alphatest_fragment:cc,alphatest_pars_fragment:hc,aomap_fragment:uc,aomap_pars_fragment:fc,batching_pars_vertex:dc,batching_vertex:pc,begin_vertex:mc,beginnormal_vertex:_c,bsdfs:gc,iridescence_fragment:xc,bumpmap_pars_fragment:vc,clipping_planes_fragment:Mc,clipping_planes_pars_fragment:Sc,clipping_planes_pars_vertex:Ec,clipping_planes_vertex:Tc,color_fragment:bc,color_pars_fragment:yc,color_pars_vertex:Ac,color_vertex:Rc,common:Cc,cube_uv_reflection_fragment:wc,defaultnormal_vertex:Pc,displacementmap_pars_vertex:Lc,displacementmap_vertex:Dc,emissivemap_fragment:Ic,emissivemap_pars_fragment:Uc,colorspace_fragment:Fc,colorspace_pars_fragment:Nc,envmap_fragment:Oc,envmap_common_pars_fragment:Bc,envmap_pars_fragment:Gc,envmap_pars_vertex:zc,envmap_physical_pars_fragment:Jc,envmap_vertex:Vc,fog_vertex:kc,fog_pars_vertex:Hc,fog_fragment:Wc,fog_pars_fragment:Xc,gradientmap_pars_fragment:qc,lightmap_pars_fragment:Yc,lights_lambert_fragment:Kc,lights_lambert_pars_fragment:$c,lights_pars_begin:Zc,lights_toon_fragment:Qc,lights_toon_pars_fragment:jc,lights_phong_fragment:eh,lights_phong_pars_fragment:th,lights_physical_fragment:nh,lights_physical_pars_fragment:ih,lights_fragment_begin:rh,lights_fragment_maps:sh,lights_fragment_end:ah,lightprobes_pars_fragment:oh,logdepthbuf_fragment:lh,logdepthbuf_pars_fragment:ch,logdepthbuf_pars_vertex:hh,logdepthbuf_vertex:uh,map_fragment:fh,map_pars_fragment:dh,map_particle_fragment:ph,map_particle_pars_fragment:mh,metalnessmap_fragment:_h,metalnessmap_pars_fragment:gh,morphinstance_vertex:xh,morphcolor_vertex:vh,morphnormal_vertex:Mh,morphtarget_pars_vertex:Sh,morphtarget_vertex:Eh,normal_fragment_begin:Th,normal_fragment_maps:bh,normal_pars_fragment:yh,normal_pars_vertex:Ah,normal_vertex:Rh,normalmap_pars_fragment:Ch,clearcoat_normal_fragment_begin:wh,clearcoat_normal_fragment_maps:Ph,clearcoat_pars_fragment:Lh,iridescence_pars_fragment:Dh,opaque_fragment:Ih,packing:Uh,premultiplied_alpha_fragment:Fh,project_vertex:Nh,dithering_fragment:Oh,dithering_pars_fragment:Bh,roughnessmap_fragment:Gh,roughnessmap_pars_fragment:zh,shadowmap_pars_fragment:Vh,shadowmap_pars_vertex:kh,shadowmap_vertex:Hh,shadowmask_pars_fragment:Wh,skinbase_vertex:Xh,skinning_pars_vertex:qh,skinning_vertex:Yh,skinnormal_vertex:Kh,specularmap_fragment:$h,specularmap_pars_fragment:Zh,tonemapping_fragment:Jh,tonemapping_pars_fragment:Qh,transmission_fragment:jh,transmission_pars_fragment:eu,uv_pars_fragment:tu,uv_pars_vertex:nu,uv_vertex:iu,worldpos_vertex:ru,background_vert:`varying vec2 vUv;
uniform mat3 uvTransform;
void main() {
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new jt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:pr(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(){return new jt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:pr(),fragmentShader:`
	...
	`}class Ja extends Qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new wa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Pi(5,5,5),s=new jt({name:"CubemapFromEquirect",uniforms:hi(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:1,blending:0});s.uniforms.tEquirect.value=t;const a=new Zt(r,s),o=t.minFilter;return t.minFilter===1008&&(t.minFilter=1006),new tc(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,r);e.setRenderTarget(s)}}function _u(i){let e=new WeakMap,t=new WeakMap,n=null;function r(h,_=!1){return h==null?null:_?a(h):s(h)}function s(h){if(h&&h.isTexture){const _=h.mapping;if(_===303||_===304)if(e.has(h)){const g=e.get(h).texture;return o(g,h.mapping)}else{const g=h.image;if(g&&g.height>0){const S=new Ja(g.height);return S.fromEquirectangularTexture(i,h),e.set(h,S),h.addEventListener("dispose",l),o(S.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const _=h.mapping,g=_===303||_===304,S=_===301||_===302;if(g||S){let p=t.get(h);const u=p!==void 0?p.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==u)return n===null&&(n=new Ya(i)),p=g?n.fromEquirectangular(h,p):n.fromCubemap(h,p),p.texture.pmremVersion=h.pmremVersion,t.set(h,p),p.texture;if(p!==void 0)return p.texture;{const y=h.image;return g&&y&&y.height>0||S&&y&&c(y)?(n===null&&(n=new Ya(i)),p=g?n.fromEquirectangular(h):n.fromCubemap(h),p.texture.pmremVersion=h.pmremVersion,t.set(h,p),h.addEventListener("dispose",f),p.texture):null}}}return h}function o(h,_){return _===303?h.mapping=301:_===304&&(h.mapping=302),h}function c(h){let _=0;const g=6;for(let S=0;S<g;S++)h[S]!==void 0&&_++;return _===g}function l(h){const _=h.target;_.removeEventListener("dispose",l);const g=e.get(_);g!==void 0&&(e.delete(_),g.dispose())}function f(h){const _=h.target;_.removeEventListener("dispose",f);const g=t.get(_);g!==void 0&&(t.delete(_),g.dispose())}function m(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:m}}function gu(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Kn("WebGLRenderer: "+n+" extension not supported."),r}}}function xu(i,e,t,n){const r={},s=new WeakMap;function a(m){const h=m.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);h.removeEventListener("dispose",a),delete r[h.id];const _=s.get(h);_&&(e.remove(_),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(m,h){return r[h.id]===!0||(h.addEventListener("dispose",a),r[h.id]=!0,t.memory.geometries++),h}function c(m){const h=m.attributes;for(const _ in h)e.update(h[_],i.ARRAY_BUFFER)}function l(m){const h=[],_=m.index,g=m.attributes.position;let S=0;if(g===void 0)return;if(_!==null){const y=_.array;S=_.version;for(let R=0,M=y.length;R<M;R+=3){const A=y[R+0],T=y[R+1],C=y[R+2];h.push(A,T,T,C,C,A)}}else{const y=g.array;S=g.version;for(let R=0,M=y.length/3-1;R<M;R+=3){const A=R+0,T=R+1,C=R+2;h.push(A,T,T,C,C,A)}}const p=new(g.count>=65535?_a:Zr)(h,1);p.version=S;const u=s.get(m);u&&e.remove(u),s.set(m,p)}function f(m){const h=s.get(m);if(h){const _=m.index;_!==null&&h.version<_.version&&l(m)}else l(m);return s.get(m)}return{get:o,update:c,getWireframeAttribute:f}}function vu(i,e,t){let n;function r(m){n=m}let s,a;function o(m){s=m.type,a=m.bytesPerElement}function c(m,h){i.drawElements(n,h,s,m*a),t.update(h,n,1)}function l(m,h,_){_!==0&&(i.drawElementsInstanced(n,h,s,m*a,_),t.update(h,n,_))}function f(m,h,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,s,m,0,_);let S=0;for(let p=0;p<_;p++)S+=h[p];t.update(S,n,1)}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=f}function Mu(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:He("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Su(i,e,t){const n=new WeakMap,r=new je;function s(a,o,c){const l=a.morphTargetInfluences,f=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,m=f!==void 0?f.length:0;let h=n.get(o);if(h===void 0||h.count!==m){let b=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",b)};h!==void 0&&h.texture.dispose();const _=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,S=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],u=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let R=0;_===!0&&(R=1),g===!0&&(R=2),S===!0&&(R=3);let M=o.attributes.position.count*R,A=1;M>e.maxTextureSize&&(A=Math.ceil(M/e.maxTextureSize),M=e.maxTextureSize);const T=new Float32Array(M*A*4*m),C=new sa(T,M,A,m);C.type=1015,C.needsUpdate=!0;const x=R*4;for(let I=0;I<m;I++){const L=p[I],B=u[I],K=y[I],Z=M*A*4*I;for(let z=0;z<L.count;z++){const q=z*x;_===!0&&(r.fromBufferAttribute(L,z),T[Z+q+0]=r.x,T[Z+q+1]=r.y,T[Z+q+2]=r.z,T[Z+q+3]=0),g===!0&&(r.fromBufferAttribute(B,z),T[Z+q+4]=r.x,T[Z+q+5]=r.y,T[Z+q+6]=r.z,T[Z+q+7]=0),S===!0&&(r.fromBufferAttribute(K,z),T[Z+q+8]=r.x,T[Z+q+9]=r.y,T[Z+q+10]=r.z,T[Z+q+11]=K.itemSize===4?r.w:1)}}h={count:m,texture:C,size:new ze(M,A)},n.set(o,h),o.addEventListener("dispose",b)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let _=0;for(let S=0;S<l.length;S++)_+=l[S];const g=o.morphTargetsRelative?1:1-_;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:s}}function Eu(i,e,t,n,r){let s=new WeakMap;function a(l){const f=r.render.frame,m=l.geometry,h=e.get(l,m);if(s.get(h)!==f&&(e.update(h),s.set(h,f)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==f&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,f))),l.isSkinnedMesh){const _=l.skeleton;s.get(_)!==f&&(_.update(),s.set(_,f))}return h}function o(){s=new WeakMap}function c(l){const f=l.target;f.removeEventListener("dispose",c),n.releaseStatesOfObject(f),t.remove(f.instanceMatrix),f.instanceColor!==null&&t.remove(f.instanceColor)}return{update:a,dispose:o}}const Tu={1:"LINEAR_TONE_MAPPING",2:"REINHARD_TONE_MAPPING",3:"CINEON_TONE_MAPPING",4:"ACES_FILMIC_TONE_MAPPING",6:"AGX_TONE_MAPPING",7:"NEUTRAL_TONE_MAPPING",5:"CUSTOM_TONE_MAPPING"};function bu(i,e,t,n,r,s){const a=new Qt(e,t,{type:i,depthBuffer:r,stencilBuffer:s,samples:n?4:0,depthTexture:r?new ci(e,t):void 0}),o=new Qt(e,t,{type:1016,depthBuffer:!1,stencilBuffer:!1}),c=new $t;c.setAttribute("position",new Pt([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new Pt([0,2,0,0,2,0],2));const l=new Kl({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),f=new Zt(c,l),m=new us(-1,1,1,-1,0,1);let h=null,_=null,g=!1,S,p=null,u=[],y=!1;this.setSize=function(R,M){a.setSize(R,M),o.setSize(R,M);for(let A=0;A<u.length;A++){const T=u[A];T.setSize&&T.setSize(R,M)}},this.setEffects=function(R){u=R,y=u.length>0&&u[0].isRenderPass===!0;const M=a.width,A=a.height;for(let T=0;T<u.length;T++){const C=u[T];C.setSize&&C.setSize(M,A)}},this.begin=function(R,M){if(g||R.toneMapping===0&&u.length===0)return!1;if(p=M,M!==null){const A=M.width,T=M.height;(a.width!==A||a.height!==T)&&this.setSize(A,T)}return y===!1&&R.setRenderTarget(a),S=R.toneMapping,R.toneMapping=0,!0},this.hasRenderPass=function(){return y},this.end=function(R,M){R.toneMapping=S,g=!0;let A=a,T=o;for(let C=0;C<u.length;C++){const x=u[C];if(x.enabled!==!1&&(x.render(R,T,A,M),x.needsSwap!==!1)){const b=A;A=T,T=b}}if(h!==R.outputColorSpace||_!==R.toneMapping){h=R.outputColorSpace,_=R.toneMapping,l.defines={},ke.getTransfer(h)===Je&&(l.defines.SRGB_TRANSFER="");const C=Tu[_];C&&(l.defines[C]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=A.texture,R.setRenderTarget(p),R.render(f,m),p=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),c.dispose(),l.dispose()}}const Qa=new bt,_s=new ci(1,1),ja=new sa,eo=new El,to=new wa,no=[],io=[],ro=new Float32Array(16),so=new Float32Array(9),ao=new Float32Array(4);function pi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=no[r];if(s===void 0&&(s=new Float32Array(r),no[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function xt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function vt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function mr(i,e){let t=io[e];t===void 0&&(t=new Int32Array(e),io[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function yu(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Au(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;i.uniform2fv(this.addr,e),vt(t,e)}}function Ru(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(xt(t,e))return;i.uniform3fv(this.addr,e),vt(t,e)}}function Cu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;i.uniform4fv(this.addr,e),vt(t,e)}}function wu(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),vt(t,e)}else{if(xt(t,n))return;ao.set(n),i.uniformMatrix2fv(this.addr,!1,ao),vt(t,n)}}function Pu(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),vt(t,e)}else{if(xt(t,n))return;so.set(n),i.uniformMatrix3fv(this.addr,!1,so),vt(t,n)}}function Lu(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),vt(t,e)}else{if(xt(t,n))return;ro.set(n),i.uniformMatrix4fv(this.addr,!1,ro),vt(t,n)}}function Du(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Iu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;i.uniform2iv(this.addr,e),vt(t,e)}}function Uu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;i.uniform3iv(this.addr,e),vt(t,e)}}function Fu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;i.uniform4iv(this.addr,e),vt(t,e)}}function Nu(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Ou(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;i.uniform2uiv(this.addr,e),vt(t,e)}}function Bu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;i.uniform3uiv(this.addr,e),vt(t,e)}}function Gu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;i.uniform4uiv(this.addr,e),vt(t,e)}}function zu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(_s.compareFunction=t.isReversedDepthBuffer()?518:515,s=_s):s=Qa,t.setTexture2D(e||s,r)}function Vu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||eo,r)}function ku(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||to,r)}function Hu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||ja,r)}function Wu(i){switch(i){case 5126:return yu;case 35664:return Au;case 35665:return Ru;case 35666:return Cu;case 35674:return wu;case 35675:return Pu;case 35676:return Lu;case 5124:case 35670:return Du;case 35667:case 35671:return Iu;case 35668:case 35672:return Uu;case 35669:case 35673:return Fu;case 5125:return Nu;case 36294:return Ou;case 36295:return Bu;case 36296:return Gu;case 35678:case 36198:case 36298:case 36306:case 35682:return zu;case 35679:case 36299:case 36307:return Vu;case 35680:case 36300:case 36308:case 36293:return ku;case 36289:case 36303:case 36311:case 36292:return Hu}}function Xu(i,e){i.uniform1fv(this.addr,e)}function qu(i,e){const t=pi(e,this.size,2);i.uniform2fv(this.addr,t)}function Yu(i,e){const t=pi(e,this.size,3);i.uniform3fv(this.addr,t)}function Ku(i,e){const t=pi(e,this.size,4);i.uniform4fv(this.addr,t)}function $u(i,e){const t=pi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Zu(i,e){const t=pi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Ju(i,e){const t=pi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Qu(i,e){i.uniform1iv(this.addr,e)}function ju(i,e){i.uniform2iv(this.addr,e)}function ef(i,e){i.uniform3iv(this.addr,e)}function tf(i,e){i.uniform4iv(this.addr,e)}function nf(i,e){i.uniform1uiv(this.addr,e)}function rf(i,e){i.uniform2uiv(this.addr,e)}function sf(i,e){i.uniform3uiv(this.addr,e)}function af(i,e){i.uniform4uiv(this.addr,e)}function of(i,e,t){const n=this.cache,r=e.length,s=mr(t,r);xt(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));let a;this.type===i.SAMPLER_2D_SHADOW?a=_s:a=Qa;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||a,s[o])}function lf(i,e,t){const n=this.cache,r=e.length,s=mr(t,r);xt(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||eo,s[a])}function cf(i,e,t){const n=this.cache,r=e.length,s=mr(t,r);xt(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||to,s[a])}function hf(i,e,t){const n=this.cache,r=e.length,s=mr(t,r);xt(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||ja,s[a])}function uf(i){switch(i){case 5126:return Xu;case 35664:return qu;case 35665:return Yu;case 35666:return Ku;case 35674:return $u;case 35675:return Zu;case 35676:return Ju;case 5124:case 35670:return Qu;case 35667:case 35671:return ju;case 35668:case 35672:return ef;case 35669:case 35673:return tf;case 5125:return nf;case 36294:return rf;case 36295:return sf;case 36296:return af;case 35678:case 36198:case 36298:case 36306:case 35682:return of;case 35679:case 36299:case 36307:return lf;case 35680:case 36300:case 36308:case 36293:return cf;case 36289:case 36303:case 36311:case 36292:return hf}}class ff{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Wu(t.type)}}class df{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=uf(t.type)}}class pf{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const gs=/(\w+)(\])?(\[|\.)?/g;function oo(i,e){i.seq.push(e),i.map[e.id]=e}function mf(i,e,t){const n=i.name,r=n.length;for(gs.lastIndex=0;;){const s=gs.exec(n),a=gs.lastIndex;let o=s[1];const c=s[2]==="]",l=s[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===r){oo(t,l===void 0?new ff(o,i,e):new df(o,i,e));break}else{let m=t.map[o];m===void 0&&(m=new pf(o),oo(t,m)),t=m}}}class _r{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);mf(o,c,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function lo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const _f=37297;let gf=0;function xf(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const co=new De;function vf(i){ke._getMatrix(co,ke.workingColorSpace,i);const e=`mat3( ${co.elements.map(t=>t.toFixed(4))} )`;switch(ke.getTransfer(i)){case Hi:return[e,"LinearTransferOETF"];case Je:return[e,"sRGBTransferOETF"];default:return Re("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function ho(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}const Sf={1:"Linear",2:"Reinhard",3:"Cineon",4:"ACESFilmic",6:"AgX",7:"Neutral",5:"Custom"};function Ef(i,e){const t=Sf[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const gr=new F;function Tf(){ke.getLuminanceCoefficients(gr);const i=gr.x.toFixed(4),e=gr.y.toFixed(4),t=gr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const Df={1:"SHADOWMAP_TYPE_PCF",3:"SHADOWMAP_TYPE_VSM"};function If(i){return Df[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Uf={301:"ENVMAP_TYPE_CUBE",302:"ENVMAP_TYPE_CUBE",306:"ENVMAP_TYPE_CUBE_UV"};function Ff(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Uf[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Nf={302:"ENVMAP_MODE_REFRACTION"};function Of(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Nf[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Bf={0:"ENVMAP_BLENDING_MULTIPLY",1:"ENVMAP_BLENDING_MIX",2:"ENVMAP_BLENDING_ADD"};function Gf(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Bf[i.combine]||"ENVMAP_BLENDING_NONE"}function zf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Vf(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=If(t),l=Ff(t),f=Of(t),m=Gf(t),h=zf(t),_=bf(t),g=yf(s),S=r.createProgram();let p,u,y=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  ${Sr}`,Vd=new F(2.6,10.5,3.4).normalize();function kd(i,e){const t=new Ia({color:i.skin,roughness:.74,metalness:0,vertexColors:!0,clearcoat:.1,clearcoatRoughness:.62,clearcoatRoughnessMap:e,sheen:.22,sheenColor:new Ne(16767426),sheenRoughness:.8,roughnessMap:e,bumpMap:e,bumpScale:.0032});return t.onBeforeCompile=n=>{if(n.uniforms.uSubsurface={value:new Ne(i.subsurface)},n.uniforms.uSubsurfaceStrength={value:.62},n.uniforms.uKeyDirection={value:Vd},n.fragmentShader=n.fragmentShader.replace("#include <common>",`#include <common>
      uniform vec3 uSubsurface;
      uniform float uSubsurfaceStrength;
      uniform vec3 uKeyDirection;`),!n.fragmentShader.includes(Sr))throw new Error(`skin shader: three.js no longer emits ${Sr}`);n.fragmentShader=n.fragmentShader.replace(Sr,zd)},t}function Hd(i){const e=new $t;return e.setAttribute("position",new Pt(i.positions,3)),e.setAttribute("uv",new Pt(i.uvs,2)),e.setAttribute("skinIndex",new Zr(i.skinIndices,4)),e.setAttribute("skinWeight",new Pt(i.skinWeights,4)),e.setIndex(i.indices),e.computeVertexNormals(),e}function Wd(i,e){const t=i.getAttribute("position"),n=i.getAttribute("normal"),r=Ld(),s=new Float32Array(t.count*3);for(let a=0;a<t.count;a++){const o=[t.getX(a),t.getY(a),t.getZ(a)],c=[n.getX(a),n.getY(a),n.getZ(a)],l=Id(o,c,r),[f,m,h]=e?Ud(o):[1,1,1];s[a*3]=l*f,s[a*3+1]=l*m,s[a*3+2]=l*h}i.setAttribute("color",new Kt(s,3))}class Xd{constructor(e){vi(this,"root");vi(this,"bones",new Map);vi(this,"materials",[]);vi(this,"geometries",[]);vi(this,"meshes",[]);this.root=new Ti;for(const m of Ss){const h=Gn[m],_=new Aa;_.position.set(h.offset[0],h.offset[1],h.offset[2]);const g=h.parent===null?this.root:this.bones.get(h.parent);if(!g)throw new Error(`joint ${m} has an unbuilt parent`);g.add(_),this.bones.set(m,_)}this.root.updateMatrixWorld(!0);const t=Ss.map(m=>this.bones.get(m)),n=new ss(t),r=Gd(),s=kd(e,r),a=new Li({vertexColors:!0,color:e.trunks,roughness:.9,metalness:0,roughnessMap:r}),o=new Ia({vertexColors:!0,color:e.gloves,roughness:.42,metalness:0,clearcoat:.55,clearcoatRoughness:.35,roughnessMap:r}),c=new Li({vertexColors:!0,color:e.hair,roughness:.82,metalness:0,roughnessMap:r}),l=new Li({color:1314572,roughness:.28,metalness:0});this.materials.push(s,a,o,c,l);const f=[[Fd(),s,!0],[Nd(e.trunkLength),a,!0],[Od(),o,!0],[Cd(e.hairStyle),c,!1],[Pd(),l,!1]];e.beard&&f.push([wd(),c,!1]);for(const[m,h,_]of f){const g=Hd(m);h!==l&&Wd(g,h===s),this.geometries.push(g);const S=new Ol(g,h);S.castShadow=_,S.receiveShadow=!0,S.frustumCulled=!1,this.root.add(S),S.bind(n),this.meshes.push(S)}}applyPose(e){for(const[n,r]of this.bones){const s=e.joints[n];r.rotation.set(s[0],s[1],s[2])}const t=this.bones.get("hips");if(t){const n=Gn.hips.offset;t.position.set(n[0]+e.offset[0],n[1]+e.offset[1],n[2]+e.offset[2])}}setPlacement(e,t){this.root.position.set(e[0],e[1],e[2]),this.root.rotation.y=t}headPosition(e){const t=this.bones.get("head");return t?t.getWorldPosition(e):e.set(0,1.6,0)}dispose(){for(const e of this.geometries)e.dispose();for(const e of this.materials)e.dispose();for(const e of this.meshes)e.skeleton.dispose();this.geometries.length=0,this.materials.length=0,this.meshes.length=0,this.bones.clear()}}function qd(i){const e=new Jl(7175321,461069,.12);i.add(e);const t=new ec(16773856,1.5);t.position.set(2.6,10.5,3.4),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.near=2,t.shadow.camera.far=22,t.shadow.camera.left=-5.5,t.shadow.camera.right=5.5,t.shadow.camera.top=5.5,t.shadow.camera.bottom=-5.5,t.shadow.bias=-9e-4,t.shadow.normalBias=.02,t.shadow.radius=2,i.add(t);const n=[];for(const[s,a]of[[-3.2,-3.2],[3.2,-3.2],[-3.2,3.2],[3.2,3.2]]){const o=new za(16774374,11,16,Math.PI/4.6,.55,1.6);o.position.set(s,7.4,a),o.target.position.set(s*.25,1,a*.25),i.add(o,o.target),n.push(o)}const r=new za(10337535,14,20,Math.PI/5,.7,1.5);return r.position.set(-6.5,4.6,-5.2),r.target.position.set(0,1.1,0),i.add(r,r.target),()=>{i.remove(e,t,r,r.target);for(const s of n)i.remove(s,s.target);t.dispose(),r.dispose();for(const s of n)s.dispose()}}const Go=[0,0,0];function Yd(i){const e={};for(const t of Ms)e[t]=i.joints[t]??Go;return{joints:e,offset:i.offset??Go}}function Pe(i,e,t){return{joints:{...i.joints,...e},offset:t??i.offset}}function zt(i,e,t){const n={},r=new Set([...Object.keys(i.joints),...Object.keys(e.joints)]);for(const o of r){const c=i.joints[o]??[0,0,0],l=e.joints[o]??[0,0,0];n[o]=[c[0]+(l[0]-c[0])*t,c[1]+(l[1]-c[1])*t,c[2]+(l[2]-c[2])*t]}const s=i.offset??[0,0,0],a=e.offset??[0,0,0];return{joints:n,offset:[s[0]+(a[0]-s[0])*t,s[1]+(a[1]-s[1])*t,s[2]+(a[2]-s[2])*t]}}const pe={joints:{hips:[.04,-.34,0],spine:[.06,.12,0],chest:[.04,.1,0],neck:[-.06,0,0],head:[0,.16,0],shoulderL:[0,0,-.12],armL:[-.78,.1,-.16],forearmL:[-2.3,0,.2],handL:[0,0,0],shoulderR:[0,0,.12],armR:[-.62,-.1,.2],forearmR:[-2.42,0,-.24],handR:[0,0,0],thighL:[-.34,.06,.06],shinL:[.42,0,0],footL:[-.12,0,0],thighR:[.3,-.06,-.06],shinR:[.5,0,0],footR:[-.42,0,0]},offset:[0,-.075,0]},Ut=Pe(pe,{hips:[.06,-.42,0],spine:[.1,.16,0],thighR:[.44,-.06,-.06],shinR:[.62,0,0]},[0,-.11,-.05]),Kd=Pe(pe,{hips:[.04,-.22,0],chest:[.04,-.16,0],shoulderL:[0,0,-.3],armL:[-1.42,.16,-.06],forearmL:[-.1,0,0],armR:[-.58,-.1,.24]},[0,-.075,.14]),$d=Pe(Ut,{hips:[.05,.06,0],spine:[.1,-.2,0],chest:[.05,-.24,0],shoulderR:[0,0,.3],armR:[-1.48,-.18,.06],forearmR:[-.08,0,0],armL:[-.7,.1,-.34],forearmL:[-2.4,0,.24],thighR:[.12,-.06,-.06],footR:[-.62,0,0]},[0,-.085,.2]),Zd=Pe(pe,{hips:[.04,-.02,0],spine:[.05,-.24,0],chest:[.02,-.2,0],shoulderL:[0,0,-.36],armL:[-1.62,.9,-.2],forearmL:[-1.5,0,0]},[0,-.075,.13]),Jd=Pe(Ut,{hips:[.04,.1,0],spine:[.06,-.26,0],chest:[.03,-.22,0],shoulderR:[0,0,.36],armR:[-1.6,-.95,.2],forearmR:[-1.52,0,0]},[0,-.09,.15]),Qd=Pe(Ut,{hips:[-.06,.04,0],spine:[-.14,-.18,0],chest:[-.1,-.18,0],armR:[-1.15,-.2,.24],forearmR:[-1.95,0,-.1],armL:[-.72,.1,-.3]},[0,-.09,.17]),jd=Pe(Ut,{hips:[.14,.04,0],spine:[.24,-.22,0],chest:[.16,-.2,.14],armR:[-2.1,-.5,.2],forearmR:[-.9,0,0]},[0,-.08,.22]),zo=Pe(pe,{hips:[.3,0,0],spine:[.2,-.18,0],armR:[-1.9,-.2,.06],forearmR:[-.1,0,0],thighL:[.9,.06,.06],shinL:[.9,0,0],thighR:[1,-.06,-.06],shinR:[.7,0,0]},[0,.16,.24]),Vo=Pe(pe,{hips:[.04,.6,0],spine:[.04,.4,0],chest:[.02,.3,0],armR:[-1.5,-1.2,.4],forearmR:[-.4,0,0]},[0,-.075,.12]),ep=Pe(Ut,{hips:[.04,.08,0],spine:[.08,-.28,0],chest:[.04,-.24,0],shoulderR:[0,0,.44],armR:[-1.9,-.85,.3],forearmR:[-2.4,0,0]}),ko=Pe(pe,{hips:[-.16,-.2,0],spine:[-.18,.08,0],armL:[-1.1,.3,-.2],armR:[-1.05,-.3,.24],forearmL:[-1.9,0,0],forearmR:[-1.9,0,0],thighR:[-1.55,-.1,-.06],shinR:[1.9,0,0],thighL:[-.16,.06,.06],shinL:[.18,0,0]},[0,.02,.06]),Ho=Pe(ko,{hips:[-.2,-.16,0],thighR:[-1.75,-.1,-.06],shinR:[1.6,0,0],thighL:[-.6,.06,.06],shinL:[1.5,0,0]},[0,.42,.18]);function Ls(i,e,t){return Pe(pe,{hips:[.02,-.9,e*.4],spine:[-e*.5,.4,e*.6],chest:[-e*.3,.2,e*.4],armL:[-.4,.2,-.9],forearmL:[-1.2,0,0],armR:[-.2,-.2,1.1],forearmR:[-.6,0,0],thighR:[i,-.2,-1.05],shinR:[.34,0,0],footR:[-.3,0,0],thighL:[-.08,.06,.06],shinL:[.14,0,0],footL:[.5,0,0]},[0,t,.02])}const tp=Ls(-.55,.2,-.04),np=Ls(-1.15,.5,.02),ip=Ls(-1.75,.85,.08),rp=Pe(pe,{hips:[-.18,-.28,0],spine:[-.24,.1,0],armL:[-.9,.2,-.5],armR:[-.5,-.2,.6],thighR:[-1.5,-.06,-.06],shinR:[.12,0,0],footR:[-.5,0,0]},[0,-.02,.04]),sp=Pe(pe,{hips:[0,-1.35,.14],spine:[-.2,.6,-.2],chest:[-.1,.4,-.1],armL:[-.8,.2,-.7],armR:[-.2,-.2,.9],thighR:[-1.35,-.1,-.5],shinR:[.1,0,0],footR:[-.2,0,0]},[0,.02,0]),_n=Pe(pe,{hips:[.02,2.4,0],spine:[.06,.5,0],chest:[.04,.3,0],armL:[-.5,.3,-.8],armR:[-.5,-.3,.8],thighR:[-.7,-.06,-.3],shinR:[1,0,0]},[0,-.04,0]);function Er(i,e){const t=i.joints.hips??[0,0,0];return Pe(i,{hips:[t[0],e,t[2]]})}const Wo=Pe(_n,{hips:[.06,Math.PI,0],spine:[.1,.4,0],chest:[.06,.2,0],armL:[-.9,.3,-.5],forearmL:[-1.6,0,0],armR:[-.9,-.3,.5],forearmR:[-1.6,0,0],thighR:[2,0,-.06],shinR:[.1,0,0],footR:[.3,0,0],thighL:[-.1,.06,.06],shinL:[.16,0,0]},[0,-.02,.06]),Xo=Pe(pe,{hips:[.04,Math.PI*2-.34,0]}),Ds=Math.PI*2+.93,Is=Pe(_n,{hips:[.02,Ds,.08],spine:[-.1,.4,-.08],chest:[-.06,.2,-.06],thighR:[-1.7,-.2,-.95],shinR:[.2,0,0],thighL:[-.06,.06,.06],shinL:[.12,0,0]},[0,.06,.04]);Pe(pe,{spine:[.14,.06,0],neck:[.18,0,0],head:[.1,.1,0],armL:[-1.15,.35,-.42],forearmL:[-2.35,0,.5],armR:[-1.15,-.35,.42],forearmR:[-2.35,0,-.5]},[0,-.13,-.02]),Pe(pe,{hips:[.08,-.4,.22],spine:[.18,.16,.3],chest:[.1,.1,.22],neck:[.1,0,.16],thighL:[-.46,.06,.06],shinL:[.6,0,0]},[.12,-.17,-.03]);const ap=Pe(pe,{neck:[-.24,-.1,0],head:[-.16,.24,.1],spine:[-.06,.14,0]},[0,-.08,-.05]),Hn=Pe(pe,{hips:[-.12,-.3,0],spine:[-.26,.2,.1],chest:[-.18,.16,.08],neck:[-.5,-.16,0],head:[-.3,.3,.16],armL:[-.4,.1,-.3],forearmL:[-1.6,0,0],armR:[-.3,-.1,.34],forearmR:[-1.5,0,0],thighL:[-.1,.06,.06],shinL:[.3,0,0]},[0,-.12,-.18]),Us=Pe(Hn,{hips:[-.2,-.1,.3],spine:[-.34,.1,.34],neck:[-.55,-.2,.12],armL:[-.2,.2,-.9],forearmL:[-.7,0,0],armR:[-.1,-.2,.8],forearmR:[-.5,0,0],thighL:[-.7,.1,.2],shinL:[.8,0,0],thighR:[.2,-.06,-.2],shinR:[.4,0,0]},[.18,-.22,-.3]),Fs=Pe(pe,{hips:[.42,-.3,0],spine:[.44,.12,.06],chest:[.3,.1,.04],neck:[.36,0,0],head:[.16,.14,0],armL:[-.34,.4,-.5],forearmL:[-2.5,0,.5],armR:[-.28,-.4,.52],forearmR:[-2.5,0,-.5],thighL:[-.6,.06,.08],shinL:[.8,0,0],thighR:[-.2,-.06,-.08],shinR:[.7,0,0]},[0,-.22,-.08]),Ns=Pe(pe,{hips:[.06,-.36,.26],spine:[.1,.12,-.14],chest:[.04,.1,-.08],neck:[-.02,0,-.08],armL:[-.66,.1,-.24],forearmL:[-2.2,0,.22],armR:[-.5,-.1,.3],forearmR:[-2.3,0,-.28],thighL:[-.16,.06,.3],shinL:[.96,0,0],footL:[-.3,0,0],thighR:[.22,-.06,-.18],shinR:[.72,0,0]},[.1,-.2,-.04]),qo=Pe(pe,{hips:[.8,-.2,0],spine:[.5,.1,0],chest:[.3,.1,0],neck:[-.5,0,0],armL:[-2.5,.4,-.3],forearmL:[-.5,0,0],armR:[-2.5,-.4,.3],forearmR:[-.5,0,0],thighL:[.7,.06,.1],shinL:[.2,0,0],thighR:[.7,-.06,-.1],shinR:[.2,0,0]},[0,-.5,-.34]),Wn=Pe(pe,{hips:[.34,-.34,0],spine:[.28,.12,0],thighL:[-.9,.06,.1],shinL:[1.2,0,0],thighR:[-.6,-.06,-.1],shinR:[1.3,0,0]},[0,-.3,.04]),Dt=Pe(pe,{hips:[.12,-.16,0],spine:[.2,.06,0],chest:[.14,0,0],neck:[-.3,.3,0],armL:[-1.5,.5,-.5],forearmL:[-1.9,0,.6],armR:[-1.5,-.5,.5],forearmR:[-1.9,0,-.6],thighL:[-.3,.06,.1],shinL:[.4,0,0],thighR:[.1,-.06,-.1],shinR:[.5,0,0]},[0,-.11,.06]),Yo=Pe(pe,{hips:[-.1,-.3,0],armL:[-1.6,.3,-.7],forearmL:[-.9,0,0],armR:[-1.6,-.3,.7],forearmR:[-.9,0,0]},[0,-.08,-.2]),Tr={joints:{hips:[-1.5,0,0],spine:[-.1,0,0],chest:[-.06,0,0],neck:[.5,0,0],head:[.2,0,0],armL:[-.6,.2,-.7],forearmL:[-1.8,0,0],armR:[-.6,-.2,.7],forearmR:[-1.8,0,0],thighL:[-.7,.1,.3],shinL:[1.3,0,0],footL:[-.4,0,0],thighR:[-.7,-.1,-.3],shinR:[1.3,0,0],footR:[-.4,0,0]},offset:[0,-.66,-.18]},Et={joints:{hips:[.24,0,0],spine:[.16,0,0],chest:[.1,0,0],neck:[-.2,0,0],armL:[-1.2,.3,-.4],forearmL:[-1.5,0,0],armR:[-1.2,-.3,.4],forearmR:[-1.5,0,0],thighL:[-1.5,.1,.5],shinL:[2.2,0,0],thighR:[-1.5,-.1,-.5],shinR:[2.2,0,0]},offset:[0,-.44,0]},Ko=Pe(Tr,{neck:[.8,0,0],spine:[.2,0,0],thighL:[-1.5,.1,.4],shinL:[1.7,0,0],thighR:[-1.5,-.1,-.4],shinR:[1.7,0,0],armL:[-1.4,.3,-.4],forearmL:[-1.7,0,0],armR:[-1.4,-.3,.4],forearmR:[-1.7,0,0]},[0,-.6,-.16]),op={joints:{hips:[1.2,0,0],spine:[.3,0,0],chest:[.2,0,0],neck:[-.8,0,0],armL:[-2.2,.3,-.3],forearmL:[-1.6,0,0],armR:[-2.2,-.3,.3],forearmR:[-1.6,0,0],thighL:[-.4,.1,.3],shinL:[2.3,0,0],thighR:[-.4,-.1,-.3],shinR:[2.3,0,0]},offset:[0,-.5,-.1]},$o=Pe(Et,{spine:[.3,-.16,0],armR:[-2.6,-.4,.3],forearmR:[-.4,0,0]}),Os=Pe(Et,{spine:[.42,-.1,0],chest:[.24,-.1,0],armR:[-.5,-.2,.3],forearmR:[-.5,0,0]}),br=Pe(Et,{spine:[.4,.1,0],chest:[.24,.1,0],neck:[-.4,.2,0],armL:[-1.9,.7,-.55],forearmL:[-2.5,0,.7],armR:[-1.9,-.7,.55],forearmR:[-2.5,0,-.7]},[0,-.46,-.1]),yr=Pe(Tr,{hips:[-1.35,.4,0],spine:[-.3,.2,0],armL:[-1.9,.6,-.5],forearmL:[-2.2,0,.4],armR:[-1.9,-.6,.5],forearmR:[-2.2,0,-.4],thighL:[-1.4,.1,.4],shinL:[.9,0,0],thighR:[-1.3,-.1,-.4],shinR:[.6,0,0]},[0,-.6,.1]),Bs=Pe(Tr,{neck:[.9,.2,0],spine:[.24,.1,0],armL:[-1.5,.6,-.5],forearmL:[-2.4,0,.6],armR:[-1.5,-.6,.5],forearmR:[-2.4,0,-.6],thighL:[-1.1,.1,.4],shinL:[1.1,0,0]},[0,-.56,-.16]),Ar=Pe(Tr,{neck:[.3,.3,0],head:[.1,.3,0],armL:[-.3,.2,-1.1],forearmL:[-.6,0,0],armR:[-.3,-.2,1.1],forearmR:[-.5,0,0],thighL:[-.3,.1,.4],shinL:[.5,0,0],thighR:[-.4,-.1,-.3],shinR:[.7,0,0]},[0,-.68,-.3]),Rr={joints:{hips:[.6,-.3,0],spine:[.4,.2,0],chest:[.2,.1,0],neck:[-.5,0,0],armL:[-2,.4,-.4],forearmL:[-.8,0,0],armR:[-1.2,-.3,.5],forearmR:[-1.4,0,0],thighL:[-1.5,.1,.3],shinL:[1.6,0,0],thighR:[-.2,-.1,-.3],shinR:[2.2,0,0]},offset:[0,-.44,-.06]},Cr=Pe(pe,{hips:[.62,-.3,0],spine:[.4,.14,0],chest:[.24,.1,0],neck:[-.5,0,0],armL:[-2.2,.5,-.3],forearmL:[-.7,0,0],armR:[-2.2,-.5,.3],forearmR:[-.7,0,0],thighL:[-1.3,.1,.2],shinL:[1.5,0,0],thighR:[-.1,-.1,-.2],shinR:[1.7,0,0]},[0,-.42,.36]),Gs=Pe(Cr,{hips:[.9,-.24,0],spine:[.3,.1,0],thighL:[-.9,.1,.2],shinL:[1,0,0],thighR:[.4,-.1,-.2],shinR:[.9,0,0]},[0,-.5,.62]),Oi=Pe(pe,{hips:[-.2,-.2,0],spine:[-.24,.1,0],chest:[-.14,.1,0],armL:[-2.4,.5,-.4],forearmL:[-1.4,0,0],armR:[-2.4,-.5,.4],forearmR:[-1.4,0,0],thighL:[-.5,.1,.14],shinL:[.7,0,0],thighR:[-.3,-.1,-.14],shinR:[.6,0,0]},[0,-.02,.2]),zs=Pe(pe,{hips:[.8,-.2,0],spine:[.5,.1,0],armL:[-2.6,.4,-.3],forearmL:[-.6,0,0],armR:[-2.6,-.4,.3],forearmR:[-.6,0,0],thighL:[-1.4,.1,.3],shinL:[2,0,0],thighR:[-1.4,-.1,-.3],shinR:[2,0,0]},[0,-.44,.34]),lp=Pe(Oi,{hips:[-.7,-.2,0],spine:[-.5,.1,0],chest:[-.3,.1,0],neck:[.4,0,0],armL:[-2.8,.5,-.4],armR:[-2.8,-.5,.4],thighL:[-.2,.1,.14],thighR:[0,-.1,-.14]},[0,.06,.08]),sn=Pe(pe,{hips:[.02,-.2,0],armL:[-.5,.1,-.24],forearmL:[-1.4,0,.1],armR:[-.5,-.1,.24],forearmR:[-1.4,0,-.1]},[0,-.04,0]),Zo=Pe(pe,{hips:[.2,-.1,0],spine:[.16,.06,0],armL:[-1.3,.3,-.2],forearmL:[-.5,0,0],armR:[-1.3,-.3,.2],forearmR:[-.5,0,0]},[0,-.1,.06]),Bi=Pe(pe,{hips:[-.06,-.1,0],spine:[-.12,0,0],neck:[.2,0,0],head:[.1,0,0],armL:[-2.9,.3,-.5],forearmL:[-.3,0,0],armR:[-2.9,-.3,.5],forearmR:[-.3,0,0],thighL:[-.1,.06,.06],shinL:[.12,0,0],thighR:[.1,-.06,-.06],shinR:[.12,0,0]},[0,-.01,0]),Vs={joints:{hips:[.16,0,0],spine:[.1,0,0],chest:[.06,0,0],neck:[-.3,0,0],armL:[-.9,.2,-.4],forearmL:[-1.5,0,0],armR:[-.9,-.2,.4],forearmR:[-1.5,0,0],thighL:[-1.5,.1,.2],shinL:[1.5,0,0],thighR:[-1.5,-.1,-.2],shinR:[1.5,0,0]},offset:[0,-.42,-.06]},Gi=Pe(pe,{hips:[-.1,-.3,.24],spine:[-.2,.1,.2],neck:[-.3,-.2,.14],head:[-.1,.2,.2],armL:[-.4,.2,-.5],forearmL:[-1,0,0],armR:[-.3,-.2,.5],forearmR:[-.9,0,0],thighL:[-.5,.1,.2],shinL:[.7,0,0],thighR:[.2,-.06,-.16],shinR:[.5,0,0]},[.08,-.2,-.06]),ks=Pe(pe,{neck:[-.16,0,0],armL:[-2.3,.3,-.24],forearmL:[-2.2,0,.4],armR:[-.6,-.1,.2],forearmR:[-2.3,0,-.24]},[0,-.09,-.06]);function qe(i,e,t){return{duration:i,impactAt:e,keys:t,variants:1}}function k(i,e,t){return t?{t:i,pose:e,ease:t}:{t:i,pose:e}}function Ct(i,e,t,n=pe){return qe(t,.45,[k(0,n),k(.2,i,"anticipate"),k(.45,e,"snap"),k(.53,zt(i,e,1.08),"linear"),k(.74,zt(n,e,.22),"settle"),k(1,n,"settle")])}function Xn(i,e,t=pe){const n=[k(0,t)],r=["anticipate","snap","settle"];return e.forEach((s,a)=>{n.push(k((a+1)/e.length,s,r[Math.min(a,r.length-1)]))}),qe(i,.72,n)}const cp={strike_jab:Ct(pe,Kd,.4),strike_cross:Ct(Ut,$d,.5),strike_hook_left:Ct(pe,Zd,.52),strike_hook_right:Ct(Ut,Jd,.54),strike_uppercut:Ct(Ut,Qd,.5),strike_overhand:Ct(Ut,jd,.62),strike_elbow:Ct(Dt,ep,.48,Dt),strike_knee:Ct(Dt,ko,.54,Dt),strike_superman:qe(.72,.52,[k(0,pe),k(.22,Wn,"anticipate"),k(.52,zo,"snap"),k(.6,zt(Wn,zo,1.06),"linear"),k(1,pe,"settle")]),strike_backfist:qe(.62,.58,[k(0,pe),k(.34,_n,"anticipate"),k(.58,Vo,"snap"),k(.66,zt(_n,Vo,1.07),"linear"),k(1,pe,"settle")]),strike_flying_knee:qe(.82,.48,[k(0,pe),k(.2,Wn,"anticipate"),k(.48,Ho,"snap"),k(.58,zt(Wn,Ho,1.05),"linear"),k(.86,Wn,"settle"),k(1,pe,"settle")]),kick_low:Ct(Ut,tp,.52),kick_body:Ct(Ut,np,.62),kick_head:Ct(Ut,ip,.72),kick_front:Ct(pe,rp,.52),kick_side:Ct(Ut,sp,.62),kick_spinning_back:qe(.88,.64,[k(0,pe),k(.24,Er(_n,1.1),"anticipate"),k(.46,_n,"linear"),k(.64,Wo,"snap"),k(.72,zt(_n,Wo,1.06),"linear"),k(1,Xo,"settle")]),kick_wheel:qe(.96,.68,[k(0,pe),k(.2,Er(_n,1.1),"anticipate"),k(.38,_n,"linear"),k(.54,Er(Is,Ds-2.1),"linear"),k(.68,Is,"snap"),k(.77,Er(Is,Ds+.22),"linear"),k(1,Xo,"settle")]),ground_punch:Ct(Et,Os,.4,Et),ground_elbow:Ct($o,Os,.46,Et),ground_hammerfist:Ct($o,Os,.42,Et)},hp={td_double_leg:Xn(1,[Cr,Gs,Et]),td_single_leg:Xn(1.05,[Cr,Oi,Et]),td_body_lock:Xn(1,[Dt,Oi,Et],Dt),td_trip:Xn(.9,[Dt,Gs,Et],Dt),td_throw:Xn(1.05,[Dt,Oi,zs,Et],Dt),td_suplex:qe(1.35,.66,[k(0,Dt),k(.24,Oi),k(.46,lp),k(.66,zs),k(.84,Rr),k(1,Et)]),td_ankle_pick:Xn(.92,[Cr,zs,Et]),td_cage_drag:Xn(1,[Dt,Gs,Et],Dt)};function Cn(i=1.2){return qe(i,.75,[k(0,Et),k(.34,br),k(.75,br),k(1,br)])}function Jo(i=1.25){return qe(i,.72,[k(0,Et),k(.32,Rr),k(.72,yr),k(1,yr)])}const up={sub_rnc:Cn(1.3),sub_guillotine:Cn(1.15),sub_triangle:qe(1.25,.74,[k(0,Ko),k(.36,Bs),k(.74,Bs),k(1,Bs)]),sub_armbar:qe(1.3,.74,[k(0,Et),k(.34,br),k(.74,yr),k(1,yr)]),sub_kimura:Cn(1.2),sub_americana:Cn(1.15),sub_darce:Cn(1.2),sub_anaconda:Cn(1.2),sub_arm_triangle:Cn(1.25),sub_neck_crank:Cn(1.1),sub_heel_hook:Jo(1.25),sub_kneebar:Jo(1.3)},fp={def_sprawl:qe(.7,.4,[k(0,pe),k(.24,Wn),k(.5,qo),k(.72,qo),k(1,pe)]),clinch_enter:qe(.7,.6,[k(0,pe),k(.4,Wn),k(1,Dt)]),clinch_break:qe(.6,.35,[k(0,Dt),k(.4,Yo),k(1,pe)]),scramble:qe(.9,.5,[k(0,Ko),k(.3,Rr),k(.62,op),k(1,Rr)]),knockdown:qe(1.15,.28,[k(0,pe),k(.14,Hn,"snap"),k(.42,Us,"settle"),k(.72,Ar,"anticipate"),k(1,Ar,"settle")]),stun_wobble:qe(1,.36,[k(0,pe),k(.26,Hn,"snap"),k(.62,Gi,"settle"),k(1,Gi,"smooth")]),reaction_cut:qe(.9,.35,[k(0,pe),k(.3,ap),k(.6,ks),k(1,pe)]),stance_idle:qe(2.2,.5,[k(0,pe),k(.25,Ut),k(.5,pe),k(.75,sn),k(1,pe)]),intro_touch_gloves:qe(1.3,.55,[k(0,sn),k(.5,Zo),k(.7,Zo),k(1,pe)]),round_end_return:qe(1.4,.5,[k(0,pe),k(.4,sn),k(1,sn)]),corner_seated:qe(2,.5,[k(0,Vs),k(.5,Vs),k(1,Vs)]),ref_intervene:qe(1,.4,[k(0,pe),k(.4,Yo),k(1,sn)]),doctor_check:qe(1.6,.5,[k(0,sn),k(.4,ks),k(.8,ks),k(1,sn)]),fight_end_celebrate:qe(2,.35,[k(0,pe),k(.3,Bi),k(.6,Bi),k(.8,sn),k(1,Bi)]),decision_announce:qe(2,.5,[k(0,sn),k(.35,sn),k(.6,Bi),k(1,Bi)])},dp={...cp,...hp,...up,...fp};qe(.72,0,[k(0,pe),k(.18,zt(pe,Hn,1.12),"snap"),k(.42,Hn,"linear"),k(.68,Gi,"settle"),k(1,pe,"settle")]),qe(1.1,0,[k(0,pe),k(.15,zt(pe,Hn,1.15),"snap"),k(.42,Us,"settle"),k(.76,Gi,"smooth"),k(1,Gi,"settle")]),qe(1.25,0,[k(0,pe),k(.13,zt(pe,Hn,1.18),"snap"),k(.4,Us,"settle"),k(.72,Ar,"anticipate"),k(1,Ar,"settle")]),qe(.85,0,[k(0,pe),k(.16,zt(pe,Fs,1.1),"snap"),k(.44,Fs,"linear"),k(.78,zt(pe,Fs,.4),"settle"),k(1,pe,"settle")]),qe(.72,0,[k(0,pe),k(.14,zt(pe,Ns,1.12),"snap"),k(.4,Ns,"linear"),k(.74,zt(pe,Ns,.35),"settle"),k(1,pe,"settle")]);const Qo={front:{position:[0,1.63,.62],target:[0,1.6,0],fov:30},"three-quarter":{position:[.42,1.66,.48],target:[0,1.59,0],fov:30},profile:{position:[.66,1.62,.06],target:[0,1.59,0],fov:30},torso:{position:[.5,1.45,1.5],target:[0,1.25,0],fov:38},full:{position:[1.5,1.2,2.4],target:[0,.95,0],fov:40},"full-front":{position:[.05,1.15,2.9],target:[0,.95,0],fov:38},back:{position:[-.6,1.2,-2.6],target:[0,.95,0],fov:40},hips:{position:[.35,1,1.25],target:[0,.82,0],fov:40}},gn=new vd({antialias:!0});gn.setPixelRatio(Math.min(window.devicePixelRatio,2)),gn.setSize(window.innerWidth,window.innerHeight),gn.shadowMap.enabled=!0,gn.shadowMap.type=2,gn.toneMapping=4,gn.toneMappingExposure=.72,gn.outputColorSpace=Nt,document.body.appendChild(gn.domElement);const zi=new Pl;zi.background=new Ne(790035),qd(zi);const jo=new Zt(new ls(3,48).rotateX(-Math.PI/2),new Li({color:2764600,roughness:.95}));jo.receiveShadow=!0,zi.add(jo);const Hs=new Xd(Ni),el=new URLSearchParams(location.search).get("only");el&&Hs.root.traverse(i=>{const e=i;if(!e.isMesh)return;const n=e.material.color.getHex(),r=n===Ni.trunks?"trunks":n===Ni.gloves?"gloves":n===Ni.hair?"hair":n===Ni.skin?"skin":"other";e.visible=el.split(",").includes(r)}),Hs.applyPose(Yd(dp.stance_idle.keys[0].pose)),zi.add(Hs.root);const Vi=new Gt(30,window.innerWidth/window.innerHeight,.05,40);function tl(i){const e=Qo[i]??Qo.front;Vi.position.set(...e.position),Vi.lookAt(...e.target),Vi.fov=e.fov,Vi.updateProjectionMatrix(),gn.render(zi,Vi)}window.__POSE__=tl,tl("front"),window.__READY__=!0})();
