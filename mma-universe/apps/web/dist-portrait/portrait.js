...
#endif`;const Oe={alphahash_fragment:nc,alphahash_pars_fragment:ic,alphamap_fragment:rc,alphamap_pars_fragment:sc,alphatest_fragment:ac,alphatest_pars_fragment:oc,aomap_fragment:lc,aomap_pars_fragment:cc,batching_pars_vertex:hc,batching_vertex:uc,begin_vertex:fc,beginnormal_vertex:dc,bsdfs:pc,iridescence_fragment:mc,bumpmap_pars_fragment:_c,clipping_planes_fragment:gc,clipping_planes_pars_fragment:xc,clipping_planes_pars_vertex:vc,clipping_planes_vertex:Mc,color_fragment:Sc,color_pars_fragment:Ec,color_pars_vertex:Tc,color_vertex:bc,common:yc,cube_uv_reflection_fragment:Ac,defaultnormal_vertex:Rc,displacementmap_pars_vertex:Cc,displacementmap_vertex:wc,emissivemap_fragment:Pc,emissivemap_pars_fragment:Lc,colorspace_fragment:Dc,colorspace_pars_fragment:Ic,envmap_fragment:Uc,envmap_common_pars_fragment:Fc,envmap_pars_fragment:Nc,envmap_pars_vertex:Oc,envmap_physical_pars_fragment:$c,envmap_vertex:Bc,fog_vertex:Gc,fog_pars_vertex:zc,fog_fragment:Vc,fog_pars_fragment:kc,gradientmap_pars_fragment:Hc,lightmap_pars_fragment:Wc,lights_lambert_fragment:Xc,lights_lambert_pars_fragment:qc,lights_pars_begin:Yc,lights_toon_fragment:Kc,lights_toon_pars_fragment:Zc,lights_phong_fragment:Jc,lights_phong_pars_fragment:Qc,lights_physical_fragment:jc,lights_physical_pars_fragment:eh,lights_fragment_begin:th,lights_fragment_maps:nh,lights_fragment_end:ih,lightprobes_pars_fragment:rh,logdepthbuf_fragment:sh,logdepthbuf_pars_fragment:ah,logdepthbuf_pars_vertex:oh,logdepthbuf_vertex:lh,map_fragment:ch,map_pars_fragment:hh,map_particle_fragment:uh,map_particle_pars_fragment:fh,metalnessmap_fragment:dh,metalnessmap_pars_fragment:ph,morphinstance_vertex:mh,morphcolor_vertex:_h,morphnormal_vertex:gh,morphtarget_pars_vertex:xh,morphtarget_vertex:vh,normal_fragment_begin:Mh,normal_fragment_maps:Sh,normal_pars_fragment:Eh,normal_pars_vertex:Th,normal_vertex:bh,normalmap_pars_fragment:yh,clearcoat_normal_fragment_begin:Ah,clearcoat_normal_fragment_maps:Rh,clearcoat_pars_fragment:Ch,iridescence_pars_fragment:wh,opaque_fragment:Ph,packing:Lh,premultiplied_alpha_fragment:Dh,project_vertex:Ih,dithering_fragment:Uh,dithering_pars_fragment:Fh,roughnessmap_fragment:Nh,roughnessmap_pars_fragment:Oh,shadowmap_pars_fragment:Bh,shadowmap_pars_vertex:Gh,shadowmap_vertex:zh,shadowmask_pars_fragment:Vh,skinbase_vertex:kh,skinning_pars_vertex:Hh,skinning_vertex:Wh,skinnormal_vertex:Xh,specularmap_fragment:qh,specularmap_pars_fragment:Yh,tonemapping_fragment:$h,tonemapping_pars_fragment:Kh,transmission_fragment:Zh,transmission_pars_fragment:Jh,uv_pars_fragment:Qh,uv_pars_vertex:jh,uv_vertex:eu,worldpos_vertex:tu,background_vert:`varying vec2 vUv;
uniform mat3 uvTransform;
void main() {
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qa(){return new jt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:dr(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ya(){return new jt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:dr(),fragmentShader:`
	...
	`}class $a extends Qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Aa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Pi(5,5,5),s=new jt({name:"CubemapFromEquirect",uniforms:ci(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:1,blending:0});s.uniforms.tEquirect.value=t;const a=new Zt(r,s),o=t.minFilter;return t.minFilter===1008&&(t.minFilter=1006),new Ql(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,r);e.setRenderTarget(s)}}function du(i){let e=new WeakMap,t=new WeakMap,n=null;function r(h,_=!1){return h==null?null:_?a(h):s(h)}function s(h){if(h&&h.isTexture){const _=h.mapping;if(_===303||_===304)if(e.has(h)){const g=e.get(h).texture;return o(g,h.mapping)}else{const g=h.image;if(g&&g.height>0){const S=new $a(g.height);return S.fromEquirectangularTexture(i,h),e.set(h,S),h.addEventListener("dispose",l),o(S.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const _=h.mapping,g=_===303||_===304,S=_===301||_===302;if(g||S){let p=t.get(h);const u=p!==void 0?p.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==u)return n===null&&(n=new Wa(i)),p=g?n.fromEquirectangular(h,p):n.fromCubemap(h,p),p.texture.pmremVersion=h.pmremVersion,t.set(h,p),p.texture;if(p!==void 0)return p.texture;{const y=h.image;return g&&y&&y.height>0||S&&y&&c(y)?(n===null&&(n=new Wa(i)),p=g?n.fromEquirectangular(h):n.fromCubemap(h),p.texture.pmremVersion=h.pmremVersion,t.set(h,p),h.addEventListener("dispose",f),p.texture):null}}}return h}function o(h,_){return _===303?h.mapping=301:_===304&&(h.mapping=302),h}function c(h){let _=0;const g=6;for(let S=0;S<g;S++)h[S]!==void 0&&_++;return _===g}function l(h){const _=h.target;_.removeEventListener("dispose",l);const g=e.get(_);g!==void 0&&(e.delete(_),g.dispose())}function f(h){const _=h.target;_.removeEventListener("dispose",f);const g=t.get(_);g!==void 0&&(t.delete(_),g.dispose())}function m(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:m}}function pu(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Yn("WebGLRenderer: "+n+" extension not supported."),r}}}function mu(i,e,t,n){const r={},s=new WeakMap;function a(m){const h=m.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);h.removeEventListener("dispose",a),delete r[h.id];const _=s.get(h);_&&(e.remove(_),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(m,h){return r[h.id]===!0||(h.addEventListener("dispose",a),r[h.id]=!0,t.memory.geometries++),h}function c(m){const h=m.attributes;for(const _ in h)e.update(h[_],i.ARRAY_BUFFER)}function l(m){const h=[],_=m.index,g=m.attributes.position;let S=0;if(g===void 0)return;if(_!==null){const y=_.array;S=_.version;for(let R=0,M=y.length;R<M;R+=3){const A=y[R+0],T=y[R+1],C=y[R+2];h.push(A,T,T,C,C,A)}}else{const y=g.array;S=g.version;for(let R=0,M=y.length/3-1;R<M;R+=3){const A=R+0,T=R+1,C=R+2;h.push(A,T,T,C,C,A)}}const p=new(g.count>=65535?da:$r)(h,1);p.version=S;const u=s.get(m);u&&e.remove(u),s.set(m,p)}function f(m){const h=s.get(m);if(h){const _=m.index;_!==null&&h.version<_.version&&l(m)}else l(m);return s.get(m)}return{get:o,update:c,getWireframeAttribute:f}}function _u(i,e,t){let n;function r(m){n=m}let s,a;function o(m){s=m.type,a=m.bytesPerElement}function c(m,h){i.drawElements(n,h,s,m*a),t.update(h,n,1)}function l(m,h,_){_!==0&&(i.drawElementsInstanced(n,h,s,m*a,_),t.update(h,n,_))}function f(m,h,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,s,m,0,_);let S=0;for(let p=0;p<_;p++)S+=h[p];t.update(S,n,1)}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=f}function gu(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:He("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function xu(i,e,t){const n=new WeakMap,r=new je;function s(a,o,c){const l=a.morphTargetInfluences,f=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,m=f!==void 0?f.length:0;let h=n.get(o);if(h===void 0||h.count!==m){let b=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",b)};h!==void 0&&h.texture.dispose();const _=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,S=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],u=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let R=0;_===!0&&(R=1),g===!0&&(R=2),S===!0&&(R=3);let M=o.attributes.position.count*R,A=1;M>e.maxTextureSize&&(A=Math.ceil(M/e.maxTextureSize),M=e.maxTextureSize);const T=new Float32Array(M*A*4*m),C=new na(T,M,A,m);C.type=1015,C.needsUpdate=!0;const x=R*4;for(let I=0;I<m;I++){const L=p[I],B=u[I],$=y[I],Z=M*A*4*I;for(let z=0;z<L.count;z++){const q=z*x;_===!0&&(r.fromBufferAttribute(L,z),T[Z+q+0]=r.x,T[Z+q+1]=r.y,T[Z+q+2]=r.z,T[Z+q+3]=0),g===!0&&(r.fromBufferAttribute(B,z),T[Z+q+4]=r.x,T[Z+q+5]=r.y,T[Z+q+6]=r.z,T[Z+q+7]=0),S===!0&&(r.fromBufferAttribute($,z),T[Z+q+8]=r.x,T[Z+q+9]=r.y,T[Z+q+10]=r.z,T[Z+q+11]=$.itemSize===4?r.w:1)}}h={count:m,texture:C,size:new ze(M,A)},n.set(o,h),o.addEventListener("dispose",b)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let _=0;for(let S=0;S<l.length;S++)_+=l[S];const g=o.morphTargetsRelative?1:1-_;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:s}}function vu(i,e,t,n,r){let s=new WeakMap;function a(l){const f=r.render.frame,m=l.geometry,h=e.get(l,m);if(s.get(h)!==f&&(e.update(h),s.set(h,f)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==f&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,f))),l.isSkinnedMesh){const _=l.skeleton;s.get(_)!==f&&(_.update(),s.set(_,f))}return h}function o(){s=new WeakMap}function c(l){const f=l.target;f.removeEventListener("dispose",c),n.releaseStatesOfObject(f),t.remove(f.instanceMatrix),f.instanceColor!==null&&t.remove(f.instanceColor)}return{update:a,dispose:o}}const Mu={1:"LINEAR_TONE_MAPPING",2:"REINHARD_TONE_MAPPING",3:"CINEON_TONE_MAPPING",4:"ACES_FILMIC_TONE_MAPPING",6:"AGX_TONE_MAPPING",7:"NEUTRAL_TONE_MAPPING",5:"CUSTOM_TONE_MAPPING"};function Su(i,e,t,n,r,s){const a=new Qt(e,t,{type:i,depthBuffer:r,stencilBuffer:s,samples:n?4:0,depthTexture:r?new li(e,t):void 0}),o=new Qt(e,t,{type:1016,depthBuffer:!1,stencilBuffer:!1}),c=new Kt;c.setAttribute("position",new Pt([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new Pt([0,2,0,0,2,0],2));const l=new Xl({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),f=new Zt(c,l),m=new cs(-1,1,1,-1,0,1);let h=null,_=null,g=!1,S,p=null,u=[],y=!1;this.setSize=function(R,M){a.setSize(R,M),o.setSize(R,M);for(let A=0;A<u.length;A++){const T=u[A];T.setSize&&T.setSize(R,M)}},this.setEffects=function(R){u=R,y=u.length>0&&u[0].isRenderPass===!0;const M=a.width,A=a.height;for(let T=0;T<u.length;T++){const C=u[T];C.setSize&&C.setSize(M,A)}},this.begin=function(R,M){if(g||R.toneMapping===0&&u.length===0)return!1;if(p=M,M!==null){const A=M.width,T=M.height;(a.width!==A||a.height!==T)&&this.setSize(A,T)}return y===!1&&R.setRenderTarget(a),S=R.toneMapping,R.toneMapping=0,!0},this.hasRenderPass=function(){return y},this.end=function(R,M){R.toneMapping=S,g=!0;let A=a,T=o;for(let C=0;C<u.length;C++){const x=u[C];if(x.enabled!==!1&&(x.render(R,T,A,M),x.needsSwap!==!1)){const b=A;A=T,T=b}}if(h!==R.outputColorSpace||_!==R.toneMapping){h=R.outputColorSpace,_=R.toneMapping,l.defines={},ke.getTransfer(h)===Je&&(l.defines.SRGB_TRANSFER="");const C=Mu[_];C&&(l.defines[C]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=A.texture,R.setRenderTarget(p),R.render(f,m),p=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),c.dispose(),l.dispose()}}const Ka=new bt,ps=new li(1,1),Za=new na,Ja=new vl,Qa=new Aa,ja=[],eo=[],to=new Float32Array(16),no=new Float32Array(9),io=new Float32Array(4);function di(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=ja[r];if(s===void 0&&(s=new Float32Array(r),ja[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function xt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function vt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function pr(i,e){let t=eo[e];t===void 0&&(t=new Int32Array(e),eo[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Eu(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Tu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;i.uniform2fv(this.addr,e),vt(t,e)}}function bu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(xt(t,e))return;i.uniform3fv(this.addr,e),vt(t,e)}}function yu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;i.uniform4fv(this.addr,e),vt(t,e)}}function Au(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),vt(t,e)}else{if(xt(t,n))return;io.set(n),i.uniformMatrix2fv(this.addr,!1,io),vt(t,n)}}function Ru(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),vt(t,e)}else{if(xt(t,n))return;no.set(n),i.uniformMatrix3fv(this.addr,!1,no),vt(t,n)}}function Cu(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),vt(t,e)}else{if(xt(t,n))return;to.set(n),i.uniformMatrix4fv(this.addr,!1,to),vt(t,n)}}function wu(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Pu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;i.uniform2iv(this.addr,e),vt(t,e)}}function Lu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;i.uniform3iv(this.addr,e),vt(t,e)}}function Du(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;i.uniform4iv(this.addr,e),vt(t,e)}}function Iu(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Uu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;i.uniform2uiv(this.addr,e),vt(t,e)}}function Fu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;i.uniform3uiv(this.addr,e),vt(t,e)}}function Nu(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;i.uniform4uiv(this.addr,e),vt(t,e)}}function Ou(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(ps.compareFunction=t.isReversedDepthBuffer()?518:515,s=ps):s=Ka,t.setTexture2D(e||s,r)}function Bu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Ja,r)}function Gu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Qa,r)}function zu(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Za,r)}function Vu(i){switch(i){case 5126:return Eu;case 35664:return Tu;case 35665:return bu;case 35666:return yu;case 35674:return Au;case 35675:return Ru;case 35676:return Cu;case 5124:case 35670:return wu;case 35667:case 35671:return Pu;case 35668:case 35672:return Lu;case 35669:case 35673:return Du;case 5125:return Iu;case 36294:return Uu;case 36295:return Fu;case 36296:return Nu;case 35678:case 36198:case 36298:case 36306:case 35682:return Ou;case 35679:case 36299:case 36307:return Bu;case 35680:case 36300:case 36308:case 36293:return Gu;case 36289:case 36303:case 36311:case 36292:return zu}}function ku(i,e){i.uniform1fv(this.addr,e)}function Hu(i,e){const t=di(e,this.size,2);i.uniform2fv(this.addr,t)}function Wu(i,e){const t=di(e,this.size,3);i.uniform3fv(this.addr,t)}function Xu(i,e){const t=di(e,this.size,4);i.uniform4fv(this.addr,t)}function qu(i,e){const t=di(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Yu(i,e){const t=di(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function $u(i,e){const t=di(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Ku(i,e){i.uniform1iv(this.addr,e)}function Zu(i,e){i.uniform2iv(this.addr,e)}function Ju(i,e){i.uniform3iv(this.addr,e)}function Qu(i,e){i.uniform4iv(this.addr,e)}function ju(i,e){i.uniform1uiv(this.addr,e)}function ef(i,e){i.uniform2uiv(this.addr,e)}function tf(i,e){i.uniform3uiv(this.addr,e)}function nf(i,e){i.uniform4uiv(this.addr,e)}function rf(i,e,t){const n=this.cache,r=e.length,s=pr(t,r);xt(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));let a;this.type===i.SAMPLER_2D_SHADOW?a=ps:a=Ka;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||a,s[o])}function sf(i,e,t){const n=this.cache,r=e.length,s=pr(t,r);xt(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Ja,s[a])}function af(i,e,t){const n=this.cache,r=e.length,s=pr(t,r);xt(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Qa,s[a])}function of(i,e,t){const n=this.cache,r=e.length,s=pr(t,r);xt(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Za,s[a])}function lf(i){switch(i){case 5126:return ku;case 35664:return Hu;case 35665:return Wu;case 35666:return Xu;case 35674:return qu;case 35675:return Yu;case 35676:return $u;case 5124:case 35670:return Ku;case 35667:case 35671:return Zu;case 35668:case 35672:return Ju;case 35669:case 35673:return Qu;case 5125:return ju;case 36294:return ef;case 36295:return tf;case 36296:return nf;case 35678:case 36198:case 36298:case 36306:case 35682:return rf;case 35679:case 36299:case 36307:return sf;case 35680:case 36300:case 36308:case 36293:return af;case 36289:case 36303:case 36311:case 36292:return of}}class cf{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Vu(t.type)}}class hf{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=lf(t.type)}}class uf{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const ms=/(\w+)(\])?(\[|\.)?/g;function ro(i,e){i.seq.push(e),i.map[e.id]=e}function ff(i,e,t){const n=i.name,r=n.length;for(ms.lastIndex=0;;){const s=ms.exec(n),a=ms.lastIndex;let o=s[1];const c=s[2]==="]",l=s[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===r){ro(t,l===void 0?new cf(o,i,e):new hf(o,i,e));break}else{let m=t.map[o];m===void 0&&(m=new uf(o),ro(t,m)),t=m}}}class mr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);ff(o,c,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function so(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const df=37297;let pf=0;function mf(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const ao=new De;function _f(i){ke._getMatrix(ao,ke.workingColorSpace,i);const e=`mat3( ${ao.elements.map(t=>t.toFixed(4))} )`;switch(ke.getTransfer(i)){case ki:return[e,"LinearTransferOETF"];case Je:return[e,"sRGBTransferOETF"];default:return Re("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function oo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}const xf={1:"Linear",2:"Reinhard",3:"Cineon",4:"ACESFilmic",6:"AgX",7:"Neutral",5:"Custom"};function vf(i,e){const t=xf[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const _r=new F;function Mf(){ke.getLuminanceCoefficients(_r);const i=_r.x.toFixed(4),e=_r.y.toFixed(4),t=_r.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Tf(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Ii(i){return i!==""}function lo(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function co(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const bf=/^[ \t]*#include +<([\w\d./]+)>/gm;function _s(i){return i.replace(bf,Af)}const yf=new Map;function Af(i,e){let t=Oe[e];if(t===void 0){const n=yf.get(e);if(n!==void 0)t=Oe[n],Re('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return _s(t)}const Rf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ho(i){return i.replace(Rf,Cf)}function Cf(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function uo(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const wf={1:"SHADOWMAP_TYPE_PCF",3:"SHADOWMAP_TYPE_VSM"};function Pf(i){return wf[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Lf={301:"ENVMAP_TYPE_CUBE",302:"ENVMAP_TYPE_CUBE",306:"ENVMAP_TYPE_CUBE_UV"};function Df(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Lf[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const If={302:"ENVMAP_MODE_REFRACTION"};function Uf(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":If[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Ff={0:"ENVMAP_BLENDING_MULTIPLY",1:"ENVMAP_BLENDING_MIX",2:"ENVMAP_BLENDING_ADD"};function Nf(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Ff[i.combine]||"ENVMAP_BLENDING_NONE"}function Of(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Bf(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Pf(t),l=Df(t),f=Uf(t),m=Nf(t),h=Of(t),_=Sf(t),g=Ef(s),S=r.createProgram();let p,u,y=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+u);const R=y+p+a,M=y+u+o,A=so(r,r.VERTEX_SHADER,R),T=so(r,r.FRAGMENT_SHADER,M);r.attachShader(S,A),r.attachShader(S,T),t.index0AttributeName!==void 0?r.bindAttribLocation(S,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function C(L){if(i.debug.checkShaderErrors){const B=r.getProgramInfoLog(S)||"",$=r.getShaderInfoLog(A)||"",Z=r.getShaderInfoLog(T)||"",z=B.trim(),q=$.trim(),H=Z.trim();let Q=!0,ee=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(Q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,S,A,T);else{const ue=oo(r,A,"vertex"),_e=oo(r,T,"fragment");He("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
...
void main() {
  ...
  ${vr}`,Gd=new F(2.6,10.5,3.4).normalize();function zd(i,e){const t=new Pa({color:i.skin,roughness:.74,metalness:0,vertexColors:!0,clearcoat:.1,clearcoatRoughness:.62,clearcoatRoughnessMap:e,sheen:.22,sheenColor:new Ne(16767426),sheenRoughness:.8,roughnessMap:e,bumpMap:e,bumpScale:.0032});return t.onBeforeCompile=n=>{if(n.uniforms.uSubsurface={value:new Ne(i.subsurface)},n.uniforms.uSubsurfaceStrength={value:.62},n.uniforms.uKeyDirection={value:Gd},n.fragmentShader=n.fragmentShader.replace("#include <common>",`#include <common>
      uniform vec3 uSubsurface;
      uniform float uSubsurfaceStrength;
      uniform vec3 uKeyDirection;`),!n.fragmentShader.includes(vr))throw new Error(`skin shader: three.js no longer emits ${vr}`);n.fragmentShader=n.fragmentShader.replace(vr,Bd)},t}function Vd(i){const e=new Kt;return e.setAttribute("position",new Pt(i.positions,3)),e.setAttribute("uv",new Pt(i.uvs,2)),e.setAttribute("skinIndex",new $r(i.skinIndices,4)),e.setAttribute("skinWeight",new Pt(i.skinWeights,4)),e.setIndex(i.indices),e.computeVertexNormals(),e}function kd(i,e){const t=i.getAttribute("position"),n=i.getAttribute("normal"),r=Cd(),s=new Float32Array(t.count*3);for(let a=0;a<t.count;a++){const o=[t.getX(a),t.getY(a),t.getZ(a)],c=[n.getX(a),n.getY(a),n.getZ(a)],l=Pd(o,c,r),[f,m,h]=e?Ld(o):[1,1,1];s[a*3]=l*f,s[a*3+1]=l*m,s[a*3+2]=l*h}i.setAttribute("color",new $t(s,3))}class Hd{constructor(e){vi(this,"root");vi(this,"bones",new Map);vi(this,"materials",[]);vi(this,"geometries",[]);vi(this,"meshes",[]);this.root=new Ti;for(const m of vs){const h=Gn[m],_=new Ta;_.position.set(h.offset[0],h.offset[1],h.offset[2]);const g=h.parent===null?this.root:this.bones.get(h.parent);if(!g)throw new Error(`joint ${m} has an unbuilt parent`);g.add(_),this.bones.set(m,_)}this.root.updateMatrixWorld(!0);const t=vs.map(m=>this.bones.get(m)),n=new is(t),r=Nd(),s=zd(e,r),a=new Li({vertexColors:!0,color:e.trunks,roughness:.9,metalness:0,roughnessMap:r}),o=new Pa({vertexColors:!0,color:e.gloves,roughness:.42,metalness:0,clearcoat:.55,clearcoatRoughness:.35,roughnessMap:r}),c=new Li({vertexColors:!0,color:e.hair,roughness:.82,metalness:0,roughnessMap:r}),l=new Li({color:1314572,roughness:.28,metalness:0});this.materials.push(s,a,o,c,l);const f=[[Dd(),s,!0],[Id(),a,!0],[Ud(),o,!0],[yd(e.hairStyle),c,!1],[Rd(),l,!1]];e.beard&&f.push([Ad(),c,!1]);for(const[m,h,_]of f){const g=Vd(m);h!==l&&kd(g,h===s),this.geometries.push(g);const S=new Ul(g,h);S.castShadow=_,S.receiveShadow=!0,S.frustumCulled=!1,this.root.add(S),S.bind(n),this.meshes.push(S)}}applyPose(e){for(const[n,r]of this.bones){const s=e.joints[n];r.rotation.set(s[0],s[1],s[2])}const t=this.bones.get("hips");if(t){const n=Gn.hips.offset;t.position.set(n[0]+e.offset[0],n[1]+e.offset[1],n[2]+e.offset[2])}}setPlacement(e,t){this.root.position.set(e[0],e[1],e[2]),this.root.rotation.y=t}headPosition(e){const t=this.bones.get("head");return t?t.getWorldPosition(e):e.set(0,1.6,0)}dispose(){for(const e of this.geometries)e.dispose();for(const e of this.materials)e.dispose();for(const e of this.meshes)e.skeleton.dispose();this.geometries.length=0,this.materials.length=0,this.meshes.length=0,this.bones.clear()}}function Wd(i){const e=new $l(7175321,461069,.12);i.add(e);const t=new Jl(16773856,1.5);t.position.set(2.6,10.5,3.4),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.near=2,t.shadow.camera.far=22,t.shadow.camera.left=-5.5,t.shadow.camera.right=5.5,t.shadow.camera.top=5.5,t.shadow.camera.bottom=-5.5,t.shadow.bias=-9e-4,t.shadow.normalBias=.02,t.shadow.radius=2,i.add(t);const n=[];for(const[s,a]of[[-3.2,-3.2],[3.2,-3.2],[-3.2,3.2],[3.2,3.2]]){const o=new Oa(16774374,11,16,Math.PI/4.6,.55,1.6);o.position.set(s,7.4,a),o.target.position.set(s*.25,1,a*.25),i.add(o,o.target),n.push(o)}const r=new Oa(10337535,14,20,Math.PI/5,.7,1.5);return r.position.set(-6.5,4.6,-5.2),r.target.position.set(0,1.1,0),i.add(r,r.target),()=>{i.remove(e,t,r,r.target);for(const s of n)i.remove(s,s.target);t.dispose(),r.dispose();for(const s of n)s.dispose()}}const No=[0,0,0];function Xd(i){const e={};for(const t of xs)e[t]=i.joints[t]??No;return{joints:e,offset:i.offset??No}}function Pe(i,e,t){return{joints:{...i.joints,...e},offset:t??i.offset}}function zt(i,e,t){const n={},r=new Set([...Object.keys(i.joints),...Object.keys(e.joints)]);for(const o of r){const c=i.joints[o]??[0,0,0],l=e.joints[o]??[0,0,0];n[o]=[c[0]+(l[0]-c[0])*t,c[1]+(l[1]-c[1])*t,c[2]+(l[2]-c[2])*t]}const s=i.offset??[0,0,0],a=e.offset??[0,0,0];return{joints:n,offset:[s[0]+(a[0]-s[0])*t,s[1]+(a[1]-s[1])*t,s[2]+(a[2]-s[2])*t]}}const pe={joints:{hips:[.04,-.34,0],spine:[.06,.12,0],chest:[.04,.1,0],neck:[-.06,0,0],head:[0,.16,0],shoulderL:[0,0,-.12],armL:[-.78,.1,-.16],forearmL:[-2.3,0,.2],handL:[0,0,0],shoulderR:[0,0,.12],armR:[-.62,-.1,.2],forearmR:[-2.42,0,-.24],handR:[0,0,0],thighL:[-.34,.06,.06],shinL:[.42,0,0],footL:[-.12,0,0],thighR:[.3,-.06,-.06],shinR:[.5,0,0],footR:[-.42,0,0]},offset:[0,-.075,0]},Ut=Pe(pe,{hips:[.06,-.42,0],spine:[.1,.16,0],thighR:[.44,-.06,-.06],shinR:[.62,0,0]},[0,-.11,-.05]),qd=Pe(pe,{hips:[.04,-.22,0],chest:[.04,-.16,0],shoulderL:[0,0,-.3],armL:[-1.42,.16,-.06],forearmL:[-.1,0,0],armR:[-.58,-.1,.24]},[0,-.075,.14]),Yd=Pe(Ut,{hips:[.05,.06,0],spine:[.1,-.2,0],chest:[.05,-.24,0],shoulderR:[0,0,.3],armR:[-1.48,-.18,.06],forearmR:[-.08,0,0],armL:[-.7,.1,-.34],forearmL:[-2.4,0,.24],thighR:[.12,-.06,-.06],footR:[-.62,0,0]},[0,-.085,.2]),$d=Pe(pe,{hips:[.04,-.02,0],spine:[.05,-.24,0],chest:[.02,-.2,0],shoulderL:[0,0,-.36],armL:[-1.62,.9,-.2],forearmL:[-1.5,0,0]},[0,-.075,.13]),Kd=Pe(Ut,{hips:[.04,.1,0],spine:[.06,-.26,0],chest:[.03,-.22,0],shoulderR:[0,0,.36],armR:[-1.6,-.95,.2],forearmR:[-1.52,0,0]},[0,-.09,.15]),Zd=Pe(Ut,{hips:[-.06,.04,0],spine:[-.14,-.18,0],chest:[-.1,-.18,0],armR:[-1.15,-.2,.24],forearmR:[-1.95,0,-.1],armL:[-.72,.1,-.3]},[0,-.09,.17]),Jd=Pe(Ut,{hips:[.14,.04,0],spine:[.24,-.22,0],chest:[.16,-.2,.14],armR:[-2.1,-.5,.2],forearmR:[-.9,0,0]},[0,-.08,.22]),Oo=Pe(pe,{hips:[.3,0,0],spine:[.2,-.18,0],armR:[-1.9,-.2,.06],forearmR:[-.1,0,0],thighL:[.9,.06,.06],shinL:[.9,0,0],thighR:[1,-.06,-.06],shinR:[.7,0,0]},[0,.16,.24]),Bo=Pe(pe,{hips:[.04,.6,0],spine:[.04,.4,0],chest:[.02,.3,0],armR:[-1.5,-1.2,.4],forearmR:[-.4,0,0]},[0,-.075,.12]),Qd=Pe(Ut,{hips:[.04,.08,0],spine:[.08,-.28,0],chest:[.04,-.24,0],shoulderR:[0,0,.44],armR:[-1.9,-.85,.3],forearmR:[-2.4,0,0]}),Go=Pe(pe,{hips:[-.16,-.2,0],spine:[-.18,.08,0],armL:[-1.1,.3,-.2],armR:[-1.05,-.3,.24],forearmL:[-1.9,0,0],forearmR:[-1.9,0,0],thighR:[-1.55,-.1,-.06],shinR:[1.9,0,0],thighL:[-.16,.06,.06],shinL:[.18,0,0]},[0,.02,.06]),zo=Pe(Go,{hips:[-.2,-.16,0],thighR:[-1.75,-.1,-.06],shinR:[1.6,0,0],thighL:[-.6,.06,.06],shinL:[1.5,0,0]},[0,.42,.18]);function ws(i,e,t){return Pe(pe,{hips:[.02,-.9,e*.4],spine:[-e*.5,.4,e*.6],chest:[-e*.3,.2,e*.4],armL:[-.4,.2,-.9],forearmL:[-1.2,0,0],armR:[-.2,-.2,1.1],forearmR:[-.6,0,0],thighR:[i,-.2,-1.05],shinR:[.34,0,0],footR:[-.3,0,0],thighL:[-.08,.06,.06],shinL:[.14,0,0],footL:[.5,0,0]},[0,t,.02])}const jd=ws(-.55,.2,-.04),ep=ws(-1.15,.5,.02),tp=ws(-1.75,.85,.08),np=Pe(pe,{hips:[-.18,-.28,0],spine:[-.24,.1,0],armL:[-.9,.2,-.5],armR:[-.5,-.2,.6],thighR:[-1.5,-.06,-.06],shinR:[.12,0,0],footR:[-.5,0,0]},[0,-.02,.04]),ip=Pe(pe,{hips:[0,-1.35,.14],spine:[-.2,.6,-.2],chest:[-.1,.4,-.1],armL:[-.8,.2,-.7],armR:[-.2,-.2,.9],thighR:[-1.35,-.1,-.5],shinR:[.1,0,0],footR:[-.2,0,0]},[0,.02,0]),_n=Pe(pe,{hips:[.02,2.4,0],spine:[.06,.5,0],chest:[.04,.3,0],armL:[-.5,.3,-.8],armR:[-.5,-.3,.8],thighR:[-.7,-.06,-.3],shinR:[1,0,0]},[0,-.04,0]);function Mr(i,e){const t=i.joints.hips??[0,0,0];return Pe(i,{hips:[t[0],e,t[2]]})}const Vo=Pe(_n,{hips:[.06,Math.PI,0],spine:[.1,.4,0],chest:[.06,.2,0],armL:[-.9,.3,-.5],forearmL:[-1.6,0,0],armR:[-.9,-.3,.5],forearmR:[-1.6,0,0],thighR:[2,0,-.06],shinR:[.1,0,0],footR:[.3,0,0],thighL:[-.1,.06,.06],shinL:[.16,0,0]},[0,-.02,.06]),ko=Pe(pe,{hips:[.04,Math.PI*2-.34,0]}),Ps=Math.PI*2+.93,Ls=Pe(_n,{hips:[.02,Ps,.08],spine:[-.1,.4,-.08],chest:[-.06,.2,-.06],thighR:[-1.7,-.2,-.95],shinR:[.2,0,0],thighL:[-.06,.06,.06],shinL:[.12,0,0]},[0,.06,.04]);Pe(pe,{spine:[.14,.06,0],neck:[.18,0,0],head:[.1,.1,0],armL:[-1.15,.35,-.42],forearmL:[-2.35,0,.5],armR:[-1.15,-.35,.42],forearmR:[-2.35,0,-.5]},[0,-.13,-.02]),Pe(pe,{hips:[.08,-.4,.22],spine:[.18,.16,.3],chest:[.1,.1,.22],neck:[.1,0,.16],thighL:[-.46,.06,.06],shinL:[.6,0,0]},[.12,-.17,-.03]);const rp=Pe(pe,{neck:[-.24,-.1,0],head:[-.16,.24,.1],spine:[-.06,.14,0]},[0,-.08,-.05]),kn=Pe(pe,{hips:[-.12,-.3,0],spine:[-.26,.2,.1],chest:[-.18,.16,.08],neck:[-.5,-.16,0],head:[-.3,.3,.16],armL:[-.4,.1,-.3],forearmL:[-1.6,0,0],armR:[-.3,-.1,.34],forearmR:[-1.5,0,0],thighL:[-.1,.06,.06],shinL:[.3,0,0]},[0,-.12,-.18]),Ds=Pe(kn,{hips:[-.2,-.1,.3],spine:[-.34,.1,.34],neck:[-.55,-.2,.12],armL:[-.2,.2,-.9],forearmL:[-.7,0,0],armR:[-.1,-.2,.8],forearmR:[-.5,0,0],thighL:[-.7,.1,.2],shinL:[.8,0,0],thighR:[.2,-.06,-.2],shinR:[.4,0,0]},[.18,-.22,-.3]),Is=Pe(pe,{hips:[.42,-.3,0],spine:[.44,.12,.06],chest:[.3,.1,.04],neck:[.36,0,0],head:[.16,.14,0],armL:[-.34,.4,-.5],forearmL:[-2.5,0,.5],armR:[-.28,-.4,.52],forearmR:[-2.5,0,-.5],thighL:[-.6,.06,.08],shinL:[.8,0,0],thighR:[-.2,-.06,-.08],shinR:[.7,0,0]},[0,-.22,-.08]),Us=Pe(pe,{hips:[.06,-.36,.26],spine:[.1,.12,-.14],chest:[.04,.1,-.08],neck:[-.02,0,-.08],armL:[-.66,.1,-.24],forearmL:[-2.2,0,.22],armR:[-.5,-.1,.3],forearmR:[-2.3,0,-.28],thighL:[-.16,.06,.3],shinL:[.96,0,0],footL:[-.3,0,0],thighR:[.22,-.06,-.18],shinR:[.72,0,0]},[.1,-.2,-.04]),Ho=Pe(pe,{hips:[.8,-.2,0],spine:[.5,.1,0],chest:[.3,.1,0],neck:[-.5,0,0],armL:[-2.5,.4,-.3],forearmL:[-.5,0,0],armR:[-2.5,-.4,.3],forearmR:[-.5,0,0],thighL:[.7,.06,.1],shinL:[.2,0,0],thighR:[.7,-.06,-.1],shinR:[.2,0,0]},[0,-.5,-.34]),Hn=Pe(pe,{hips:[.34,-.34,0],spine:[.28,.12,0],thighL:[-.9,.06,.1],shinL:[1.2,0,0],thighR:[-.6,-.06,-.1],shinR:[1.3,0,0]},[0,-.3,.04]),Dt=Pe(pe,{hips:[.12,-.16,0],spine:[.2,.06,0],chest:[.14,0,0],neck:[-.3,.3,0],armL:[-1.5,.5,-.5],forearmL:[-1.9,0,.6],armR:[-1.5,-.5,.5],forearmR:[-1.9,0,-.6],thighL:[-.3,.06,.1],shinL:[.4,0,0],thighR:[.1,-.06,-.1],shinR:[.5,0,0]},[0,-.11,.06]),Wo=Pe(pe,{hips:[-.1,-.3,0],armL:[-1.6,.3,-.7],forearmL:[-.9,0,0],armR:[-1.6,-.3,.7],forearmR:[-.9,0,0]},[0,-.08,-.2]),Sr={joints:{hips:[-1.5,0,0],spine:[-.1,0,0],chest:[-.06,0,0],neck:[.5,0,0],head:[.2,0,0],armL:[-.6,.2,-.7],forearmL:[-1.8,0,0],armR:[-.6,-.2,.7],forearmR:[-1.8,0,0],thighL:[-.7,.1,.3],shinL:[1.3,0,0],footL:[-.4,0,0],thighR:[-.7,-.1,-.3],shinR:[1.3,0,0],footR:[-.4,0,0]},offset:[0,-.66,-.18]},Et={joints:{hips:[.24,0,0],spine:[.16,0,0],chest:[.1,0,0],neck:[-.2,0,0],armL:[-1.2,.3,-.4],forearmL:[-1.5,0,0],armR:[-1.2,-.3,.4],forearmR:[-1.5,0,0],thighL:[-1.5,.1,.5],shinL:[2.2,0,0],thighR:[-1.5,-.1,-.5],shinR:[2.2,0,0]},offset:[0,-.44,0]},Xo=Pe(Sr,{neck:[.8,0,0],spine:[.2,0,0],thighL:[-1.5,.1,.4],shinL:[1.7,0,0],thighR:[-1.5,-.1,-.4],shinR:[1.7,0,0],armL:[-1.4,.3,-.4],forearmL:[-1.7,0,0],armR:[-1.4,-.3,.4],forearmR:[-1.7,0,0]},[0,-.6,-.16]),sp={joints:{hips:[1.2,0,0],spine:[.3,0,0],chest:[.2,0,0],neck:[-.8,0,0],armL:[-2.2,.3,-.3],forearmL:[-1.6,0,0],armR:[-2.2,-.3,.3],forearmR:[-1.6,0,0],thighL:[-.4,.1,.3],shinL:[2.3,0,0],thighR:[-.4,-.1,-.3],shinR:[2.3,0,0]},offset:[0,-.5,-.1]},qo=Pe(Et,{spine:[.3,-.16,0],armR:[-2.6,-.4,.3],forearmR:[-.4,0,0]}),Fs=Pe(Et,{spine:[.42,-.1,0],chest:[.24,-.1,0],armR:[-.5,-.2,.3],forearmR:[-.5,0,0]}),Er=Pe(Et,{spine:[.4,.1,0],chest:[.24,.1,0],neck:[-.4,.2,0],armL:[-1.9,.7,-.55],forearmL:[-2.5,0,.7],armR:[-1.9,-.7,.55],forearmR:[-2.5,0,-.7]},[0,-.46,-.1]),Tr=Pe(Sr,{hips:[-1.35,.4,0],spine:[-.3,.2,0],armL:[-1.9,.6,-.5],forearmL:[-2.2,0,.4],armR:[-1.9,-.6,.5],forearmR:[-2.2,0,-.4],thighL:[-1.4,.1,.4],shinL:[.9,0,0],thighR:[-1.3,-.1,-.4],shinR:[.6,0,0]},[0,-.6,.1]),Ns=Pe(Sr,{neck:[.9,.2,0],spine:[.24,.1,0],armL:[-1.5,.6,-.5],forearmL:[-2.4,0,.6],armR:[-1.5,-.6,.5],forearmR:[-2.4,0,-.6],thighL:[-1.1,.1,.4],shinL:[1.1,0,0]},[0,-.56,-.16]),br=Pe(Sr,{neck:[.3,.3,0],head:[.1,.3,0],armL:[-.3,.2,-1.1],forearmL:[-.6,0,0],armR:[-.3,-.2,1.1],forearmR:[-.5,0,0],thighL:[-.3,.1,.4],shinL:[.5,0,0],thighR:[-.4,-.1,-.3],shinR:[.7,0,0]},[0,-.68,-.3]),yr={joints:{hips:[.6,-.3,0],spine:[.4,.2,0],chest:[.2,.1,0],neck:[-.5,0,0],armL:[-2,.4,-.4],forearmL:[-.8,0,0],armR:[-1.2,-.3,.5],forearmR:[-1.4,0,0],thighL:[-1.5,.1,.3],shinL:[1.6,0,0],thighR:[-.2,-.1,-.3],shinR:[2.2,0,0]},offset:[0,-.44,-.06]},Ar=Pe(pe,{hips:[.62,-.3,0],spine:[.4,.14,0],chest:[.24,.1,0],neck:[-.5,0,0],armL:[-2.2,.5,-.3],forearmL:[-.7,0,0],armR:[-2.2,-.5,.3],forearmR:[-.7,0,0],thighL:[-1.3,.1,.2],shinL:[1.5,0,0],thighR:[-.1,-.1,-.2],shinR:[1.7,0,0]},[0,-.42,.36]),Os=Pe(Ar,{hips:[.9,-.24,0],spine:[.3,.1,0],thighL:[-.9,.1,.2],shinL:[1,0,0],thighR:[.4,-.1,-.2],shinR:[.9,0,0]},[0,-.5,.62]),Ni=Pe(pe,{hips:[-.2,-.2,0],spine:[-.24,.1,0],chest:[-.14,.1,0],armL:[-2.4,.5,-.4],forearmL:[-1.4,0,0],armR:[-2.4,-.5,.4],forearmR:[-1.4,0,0],thighL:[-.5,.1,.14],shinL:[.7,0,0],thighR:[-.3,-.1,-.14],shinR:[.6,0,0]},[0,-.02,.2]),Bs=Pe(pe,{hips:[.8,-.2,0],spine:[.5,.1,0],armL:[-2.6,.4,-.3],forearmL:[-.6,0,0],armR:[-2.6,-.4,.3],forearmR:[-.6,0,0],thighL:[-1.4,.1,.3],shinL:[2,0,0],thighR:[-1.4,-.1,-.3],shinR:[2,0,0]},[0,-.44,.34]),ap=Pe(Ni,{hips:[-.7,-.2,0],spine:[-.5,.1,0],chest:[-.3,.1,0],neck:[.4,0,0],armL:[-2.8,.5,-.4],armR:[-2.8,-.5,.4],thighL:[-.2,.1,.14],thighR:[0,-.1,-.14]},[0,.06,.08]),sn=Pe(pe,{hips:[.02,-.2,0],armL:[-.5,.1,-.24],forearmL:[-1.4,0,.1],armR:[-.5,-.1,.24],forearmR:[-1.4,0,-.1]},[0,-.04,0]),Yo=Pe(pe,{hips:[.2,-.1,0],spine:[.16,.06,0],armL:[-1.3,.3,-.2],forearmL:[-.5,0,0],armR:[-1.3,-.3,.2],forearmR:[-.5,0,0]},[0,-.1,.06]),Oi=Pe(pe,{hips:[-.06,-.1,0],spine:[-.12,0,0],neck:[.2,0,0],head:[.1,0,0],armL:[-2.9,.3,-.5],forearmL:[-.3,0,0],armR:[-2.9,-.3,.5],forearmR:[-.3,0,0],thighL:[-.1,.06,.06],shinL:[.12,0,0],thighR:[.1,-.06,-.06],shinR:[.12,0,0]},[0,-.01,0]),Gs={joints:{hips:[.16,0,0],spine:[.1,0,0],chest:[.06,0,0],neck:[-.3,0,0],armL:[-.9,.2,-.4],forearmL:[-1.5,0,0],armR:[-.9,-.2,.4],forearmR:[-1.5,0,0],thighL:[-1.5,.1,.2],shinL:[1.5,0,0],thighR:[-1.5,-.1,-.2],shinR:[1.5,0,0]},offset:[0,-.42,-.06]},Bi=Pe(pe,{hips:[-.1,-.3,.24],spine:[-.2,.1,.2],neck:[-.3,-.2,.14],head:[-.1,.2,.2],armL:[-.4,.2,-.5],forearmL:[-1,0,0],armR:[-.3,-.2,.5],forearmR:[-.9,0,0],thighL:[-.5,.1,.2],shinL:[.7,0,0],thighR:[.2,-.06,-.16],shinR:[.5,0,0]},[.08,-.2,-.06]),zs=Pe(pe,{neck:[-.16,0,0],armL:[-2.3,.3,-.24],forearmL:[-2.2,0,.4],armR:[-.6,-.1,.2],forearmR:[-2.3,0,-.24]},[0,-.09,-.06]);function qe(i,e,t){return{duration:i,impactAt:e,keys:t,variants:1}}function k(i,e,t){return t?{t:i,pose:e,ease:t}:{t:i,pose:e}}function Ct(i,e,t,n=pe){return qe(t,.45,[k(0,n),k(.2,i,"anticipate"),k(.45,e,"snap"),k(.53,zt(i,e,1.08),"linear"),k(.74,zt(n,e,.22),"settle"),k(1,n,"settle")])}function Wn(i,e,t=pe){const n=[k(0,t)],r=["anticipate","snap","settle"];return e.forEach((s,a)=>{n.push(k((a+1)/e.length,s,r[Math.min(a,r.length-1)]))}),qe(i,.72,n)}const op={strike_jab:Ct(pe,qd,.4),strike_cross:Ct(Ut,Yd,.5),strike_hook_left:Ct(pe,$d,.52),strike_hook_right:Ct(Ut,Kd,.54),strike_uppercut:Ct(Ut,Zd,.5),strike_overhand:Ct(Ut,Jd,.62),strike_elbow:Ct(Dt,Qd,.48,Dt),strike_knee:Ct(Dt,Go,.54,Dt),strike_superman:qe(.72,.52,[k(0,pe),k(.22,Hn,"anticipate"),k(.52,Oo,"snap"),k(.6,zt(Hn,Oo,1.06),"linear"),k(1,pe,"settle")]),strike_backfist:qe(.62,.58,[k(0,pe),k(.34,_n,"anticipate"),k(.58,Bo,"snap"),k(.66,zt(_n,Bo,1.07),"linear"),k(1,pe,"settle")]),strike_flying_knee:qe(.82,.48,[k(0,pe),k(.2,Hn,"anticipate"),k(.48,zo,"snap"),k(.58,zt(Hn,zo,1.05),"linear"),k(.86,Hn,"settle"),k(1,pe,"settle")]),kick_low:Ct(Ut,jd,.52),kick_body:Ct(Ut,ep,.62),kick_head:Ct(Ut,tp,.72),kick_front:Ct(pe,np,.52),kick_side:Ct(Ut,ip,.62),kick_spinning_back:qe(.88,.64,[k(0,pe),k(.24,Mr(_n,1.1),"anticipate"),k(.46,_n,"linear"),k(.64,Vo,"snap"),k(.72,zt(_n,Vo,1.06),"linear"),k(1,ko,"settle")]),kick_wheel:qe(.96,.68,[k(0,pe),k(.2,Mr(_n,1.1),"anticipate"),k(.38,_n,"linear"),k(.54,Mr(Ls,Ps-2.1),"linear"),k(.68,Ls,"snap"),k(.77,Mr(Ls,Ps+.22),"linear"),k(1,ko,"settle")]),ground_punch:Ct(Et,Fs,.4,Et),ground_elbow:Ct(qo,Fs,.46,Et),ground_hammerfist:Ct(qo,Fs,.42,Et)},lp={td_double_leg:Wn(1,[Ar,Os,Et]),td_single_leg:Wn(1.05,[Ar,Ni,Et]),td_body_lock:Wn(1,[Dt,Ni,Et],Dt),td_trip:Wn(.9,[Dt,Os,Et],Dt),td_throw:Wn(1.05,[Dt,Ni,Bs,Et],Dt),td_suplex:qe(1.35,.66,[k(0,Dt),k(.24,Ni),k(.46,ap),k(.66,Bs),k(.84,yr),k(1,Et)]),td_ankle_pick:Wn(.92,[Ar,Bs,Et]),td_cage_drag:Wn(1,[Dt,Os,Et],Dt)};function Cn(i=1.2){return qe(i,.75,[k(0,Et),k(.34,Er),k(.75,Er),k(1,Er)])}function $o(i=1.25){return qe(i,.72,[k(0,Et),k(.32,yr),k(.72,Tr),k(1,Tr)])}const cp={sub_rnc:Cn(1.3),sub_guillotine:Cn(1.15),sub_triangle:qe(1.25,.74,[k(0,Xo),k(.36,Ns),k(.74,Ns),k(1,Ns)]),sub_armbar:qe(1.3,.74,[k(0,Et),k(.34,Er),k(.74,Tr),k(1,Tr)]),sub_kimura:Cn(1.2),sub_americana:Cn(1.15),sub_darce:Cn(1.2),sub_anaconda:Cn(1.2),sub_arm_triangle:Cn(1.25),sub_neck_crank:Cn(1.1),sub_heel_hook:$o(1.25),sub_kneebar:$o(1.3)},hp={def_sprawl:qe(.7,.4,[k(0,pe),k(.24,Hn),k(.5,Ho),k(.72,Ho),k(1,pe)]),clinch_enter:qe(.7,.6,[k(0,pe),k(.4,Hn),k(1,Dt)]),clinch_break:qe(.6,.35,[k(0,Dt),k(.4,Wo),k(1,pe)]),scramble:qe(.9,.5,[k(0,Xo),k(.3,yr),k(.62,sp),k(1,yr)]),knockdown:qe(1.15,.28,[k(0,pe),k(.14,kn,"snap"),k(.42,Ds,"settle"),k(.72,br,"anticipate"),k(1,br,"settle")]),stun_wobble:qe(1,.36,[k(0,pe),k(.26,kn,"snap"),k(.62,Bi,"settle"),k(1,Bi,"smooth")]),reaction_cut:qe(.9,.35,[k(0,pe),k(.3,rp),k(.6,zs),k(1,pe)]),stance_idle:qe(2.2,.5,[k(0,pe),k(.25,Ut),k(.5,pe),k(.75,sn),k(1,pe)]),intro_touch_gloves:qe(1.3,.55,[k(0,sn),k(.5,Yo),k(.7,Yo),k(1,pe)]),round_end_return:qe(1.4,.5,[k(0,pe),k(.4,sn),k(1,sn)]),corner_seated:qe(2,.5,[k(0,Gs),k(.5,Gs),k(1,Gs)]),ref_intervene:qe(1,.4,[k(0,pe),k(.4,Wo),k(1,sn)]),doctor_check:qe(1.6,.5,[k(0,sn),k(.4,zs),k(.8,zs),k(1,sn)]),fight_end_celebrate:qe(2,.35,[k(0,pe),k(.3,Oi),k(.6,Oi),k(.8,sn),k(1,Oi)]),decision_announce:qe(2,.5,[k(0,sn),k(.35,sn),k(.6,Oi),k(1,Oi)])},up={...op,...lp,...cp,...hp};qe(.72,0,[k(0,pe),k(.18,zt(pe,kn,1.12),"snap"),k(.42,kn,"linear"),k(.68,Bi,"settle"),k(1,pe,"settle")]),qe(1.1,0,[k(0,pe),k(.15,zt(pe,kn,1.15),"snap"),k(.42,Ds,"settle"),k(.76,Bi,"smooth"),k(1,Bi,"settle")]),qe(1.25,0,[k(0,pe),k(.13,zt(pe,kn,1.18),"snap"),k(.4,Ds,"settle"),k(.72,br,"anticipate"),k(1,br,"settle")]),qe(.85,0,[k(0,pe),k(.16,zt(pe,Is,1.1),"snap"),k(.44,Is,"linear"),k(.78,zt(pe,Is,.4),"settle"),k(1,pe,"settle")]),qe(.72,0,[k(0,pe),k(.14,zt(pe,Us,1.12),"snap"),k(.4,Us,"linear"),k(.74,zt(pe,Us,.35),"settle"),k(1,pe,"settle")]);const Ko={front:{position:[0,1.63,.62],target:[0,1.6,0],fov:30},"three-quarter":{position:[.42,1.66,.48],target:[0,1.59,0],fov:30},profile:{position:[.66,1.62,.06],target:[0,1.59,0],fov:30},torso:{position:[.5,1.45,1.5],target:[0,1.25,0],fov:38}},gn=new _d({antialias:!0});gn.setPixelRatio(Math.min(window.devicePixelRatio,2)),gn.setSize(window.innerWidth,window.innerHeight),gn.shadowMap.enabled=!0,gn.shadowMap.type=2,gn.toneMapping=4,gn.toneMappingExposure=.72,gn.outputColorSpace=Nt,document.body.appendChild(gn.domElement);const Gi=new Rl;Gi.background=new Ne(790035),Wd(Gi);const Zo=new Zt(new as(3,48).rotateX(-Math.PI/2),new Li({color:2764600,roughness:.95}));Zo.receiveShadow=!0,Gi.add(Zo);const Jo=new Hd(Od);Jo.applyPose(Xd(up.stance_idle.keys[0].pose)),Gi.add(Jo.root);const zi=new Gt(30,window.innerWidth/window.innerHeight,.05,40);function Qo(i){const e=Ko[i]??Ko.front;zi.position.set(...e.position),zi.lookAt(...e.target),zi.fov=e.fov,zi.updateProjectionMatrix(),gn.render(Gi,zi)}window.__POSE__=Qo,Qo("front"),window.__READY__=!0})();
